...
次の文を使用して、このセクションで説明されているカテゴリ/パラメータ/設定項目を紹介します。

「このセクションでは...について説明します。」

### L3 見出し（オプション、パラメータまたは設定項目） {#l3-heading-optional-a-parameter-or-a-configuration-item}
...
次の表に、特定の設定項目/パラメータの説明、デフォルト値、および例を示します。
