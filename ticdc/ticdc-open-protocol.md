...
-   **鍵：**
    ...
    | スキーマ名      | 文字列   | 行が含まれているスキーマの名前。             |
    | Table Name | 文字列   | 行が含まれているテーブルの名前。             |
...
-   **鍵：**
    ...
    | スキーマ名 | 文字列   | DDL 変更のスキーマ名。空の文字列になる場合があります。 |
    | テーブル名 | 文字列   | DDL 変更のテーブル名。空の文字列になる場合があります。 |
...
-   **価値：**
    ...
    | DDLタイプ | 文字列    | DDLタイプ。詳細は[DDLタイプコード](#ddl-type-code)参照してください。 |
