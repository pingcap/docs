...
- `Failed`: The replication task fails. Due to some unrecoverable errors, the replication task cannot resume and cannot be recovered. TiCDC will retain the data associated with the failed changefeed for 24 hours, preventing it from being garbage collected.
