...
> 不正使用を防ぐために:
>
> -   プライマリ クラスターで**レプリケートできない DDL**を実行しようとすると、 [エラー8263](/error-codes.md)が返されます。
> -   セカンダリ クラスターで**レプリケート可能な DDL**または**レプリケート不可能な DDL**を実行しようとすると、 [エラー8263](/error-codes.md)が返されます。
