...
- MySQL sink
    ...
    - TiCDC does **not ensure** that the execution order of downstream transactions is exactly the same as that of upstream transactions.
    - TiCDC splits cross-table transactions in the unit of tables. TiCDC does **not ensure** the atomicity of cross-table transactions.
