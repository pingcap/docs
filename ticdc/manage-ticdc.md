...
| `kafka-version`      | The version of the downstream Kafka (optional, `2.4.0` by default. Currently, the latest supported Kafka version is `0.11.0.2` and the earliest one is `2.6.0`.)                      |
