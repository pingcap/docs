...
- `per-table-memory-quota`: Specifies the maximum amount of memory available for a single table. The default value is `10485760` bytes (10 MB). Starting from v7.1, this option is deprecated.
