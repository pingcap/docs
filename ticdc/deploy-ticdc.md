...
- `config`: The address of the configuration file that TiCDC uses. This option is supported since TiCDC v5.0.0. This option can be used in the TiCDC deployment since TiUP v1.4.0.
