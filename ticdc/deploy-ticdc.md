...
- `sort-dir`: Specifies the temporary file directory used by the sorting engine. **This option is not supported since TiDB v4.0.13. Do not use it any more**.
