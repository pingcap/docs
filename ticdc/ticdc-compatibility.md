...
-   TiCDC v6.2.0 から、 `cdc cli` Open API を介して TiCDCサーバーと直接対話できるようになりました。 `--server`パラメータを使用して、TiCDCサーバーのアドレスを指定できます。 `--pd`は非推奨です。
