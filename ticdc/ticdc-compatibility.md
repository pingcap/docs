...
Starting from v8.4.0, TiCDC supports replicating tables with [vector data types](/develop/vector-search/vector-search-data-types.md) to downstream (experimental).
