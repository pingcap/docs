...
> **Tip**
>
> Currently, the external storage services supported by TiCDC are the same as BR. For detailed parameter descriptions, see [URI Formats of External Storage Services](/external-storage-uri.md).
