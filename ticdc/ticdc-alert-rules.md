...
- 説明：
    ...
    レプリケーションタスクの解決された TS が 5 分以上遅延します。
...
- 説明：
    ...
    レプリケーションタスクで回復不可能なエラーが発生し、失敗状態になります。
...
- 説明：
    ...
    レプリケーションタスクがダウンストリームにデータを書き込むときにエラーが発生します。
