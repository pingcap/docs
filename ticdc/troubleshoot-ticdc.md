...
- For other situations, report the execution result of the above command to [Slack](https://slack.tidb.io/invite?team=tidb-community&channel=sig-migrate&ref=pingcap-community)
