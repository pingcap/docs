...
To handle this issue, you can try to scale out the cluster resources, reduce the value of `tikv-max-restore-concurrency` during restore, and enable the `ratelimit` option.
