...
It is recommeneded to deploy TiDB [using TiUP](/production-deployment-using-tiup.md) or [using TiDB Operator](https://docs.pingcap.com/tidb-in-kubernetes/stable) depending on your site conditions. TiDB has a unified management of the version number. You can view the version number using either of the following two methods:
