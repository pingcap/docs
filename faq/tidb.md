...
Generally, enabling `sync-log` reduces about 30% of the performance. For write performance when `sync-log` is set to `false`, see [Performance test result for TiDB using Sysbench](/benchmark/sysbench-v3.md).
...
- See [Performance test result for TiDB using Sysbench](/benchmark/sysbench-v3.md).
