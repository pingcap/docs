...
Deleting a large amount of data leaves a lot of useless keys, affecting the query efficiency. [Region Merge feature](/best-practices/massive-regions-best-practices.md#method-3-enable-region-merge) should solve this problem. For more details, see the [deleting data section in TiDB Best Practices](https://en.pingcap.com/blog/tidb-best-practice/#write).
