...
aliases: ['/docs/stable/faq/tidb-faq/','/docs/v4.0/faq/tidb-faq/','/docs/stable/faq/tidb/','/docs/stable/tiflash/tiflash-faq/','/docs/stable/reference/tiflash/faq/','/tidb/v4.0/tiflash-faq','/tidb/stable/tiflash-faq']
---
