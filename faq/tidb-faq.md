...
Generally, enabling `sync-log` reduces about 30% of the performance.
...
- See [Performance test result for TiDB using Sysbench](/benchmark/benchmark-sysbench-v4-vs-v3.md).
