...
aliases: ['/docs/v2.1/faq/tidb-faq/','/docs/v2.1/faq/tidb/']
---
...
See [Ansible Deployment](/online-deployment-using-ansible.md).
...
Generally, enabling `sync-log` reduces about 30% of the performance. For write performance when `sync-log` is set to `false`, see [Performance test result for TiDB using Sysbench](/benchmark/v2.1-performance-benchmarking-with-sysbench.md).
...
- See [Performance test result for TiDB using Sysbench](/benchmark/v2.1-performance-benchmarking-with-sysbench.md).
...
See [Mydumper Instructions](/mydumper-overview.md).

#### Loader

See [Loader Instructions](/loader-overview.md).
