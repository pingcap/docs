...
> **Note:**
>
> `{version}` in the above download link indicates the version number of TiDB. For example, the download link for `v5.2.4` is `https://download.pingcap.org/tidb-v5.2.4-linux-amd64.tar.gz`.
...
> **Note:**
>
> `{version}` in the above download link indicates the version number of TiDB Lightning. For example, the download link for `v5.2.4` is `https://download.pingcap.org/tidb-toolkit-v5.2.4-linux-amd64.tar.gz`.
...
> **Note:**
>
> `{version}` in the above download link indicates the version number of BR. For example, the download link for `v5.2.4` is `https://download.pingcap.org/tidb-toolkit-v5.2.4-linux-amd64.tar.gz`.
...
> **Note:**
>
> The `{version}` in the download link is the version number of Dumpling. For example, the link for downloading the `v5.2.4` version of Dumpling is `https://download.pingcap.org/tidb-toolkit-v5.2.4-linux-amd64.tar.gz`. You can view the currently released versions in [Dumpling Releases](https://github.com/pingcap/dumpling/releases).
>
