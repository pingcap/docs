...
By specifying the [sql-tls](/tiproxy/tiproxy-configuration.md#sql-tls) in the [TiProxy](/tiproxy/tiproxy-overview.md) configuration TiProxy is able to accept TLS connections. For more details on this and how to enable TLS on backend connections see [TiProxy Security](/tiproxy/tiproxy-overview.md#security).
