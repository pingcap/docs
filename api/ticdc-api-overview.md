...
TiCDC は、TiCDC クラスターのクエリと操作用に次の 2つのバージョンの API を提供します。
...
リクエストパラメータ、レスポンス例、使用方法など、各 API の詳細については、 [TiCDC OpenAPI v1](/ticdc/ticdc-open-api.md)および[TiCDC OpenAPI v2](/ticdc/ticdc-open-api-v2.md)を参照してください。
