...
- [Metrics interface](/tidb-monitoring-api.md#use-the-metrics-interface): get the detailed information of the various operations in components and view these metrics using Grafana.
