...
| API                                      | 説明                                                                           |
| ---------------------------------------- | ---------------------------------------------------------------------------- |
| [v1ベータ1](/api/tidb-cloud-api-v1beta1.md) | TiDB Cloud Starter、 Essential、 Dedicatedクラスターのほか、課金、データ サービス、 IAMリソースも管理します。 |
...
| [TiDB OperatorAPI](https://github.com/pingcap/tidb-operator/blob/%7B%7B%7B.tidb-operator-version%7D%7D%7D/docs/api-references/docs.md) | デプロイメント、アップグレード、スケーリング、バックアップ、フェイルオーバーなど、Kubernetes 上の TiDB クラスターを管理します。 |
