...
* <span class="version-mark">New in v9.0.0</span> `tidb_restore_registry`: the registry for restore tasks with a unique restore ID assigned to each task to prevent conflicts between different restore operations
