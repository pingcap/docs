...
Before the data import, you need to deploy a TiDB cluster. In this tutorial, TiDB v5.3.0 is used as an example. For the deployment method, refer to [Deploy a TiDB Cluster Using TiUP](/production-deployment-using-tiup.md).
