...
aliases: ['/docs/stable/identify-expensive-queries/','/docs/v4.0/identify-expensive-queries/','/docs/stable/how-to/maintain/identify-abnormal-queries/identify-expensive-queries/']
---
