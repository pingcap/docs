...
aliases: ['/docs/v2.1/troubleshoot-tidb-cluster/','/docs/v2.1/how-to/troubleshoot/cluster-setup/']
---
...
+ Error in the startup parameters: See the [TiKV configuration and options](/tikv-configuration-file.md).
