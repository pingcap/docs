...
TiDB supports changing the priority on a [per-session](sql/tidb-specific.md#tidb-force-priority), [global](sql/server-command-option.md#force-priority) or [individual statement basis](sql/dml.md).  Priority has the following meaning:
