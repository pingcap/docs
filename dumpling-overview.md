...
| `--csv-output-dialect`          | Dumpling will represent binary data types with UTF-8 format in CSV files by default. To export binary data in another format like HEX, set the parameter to 'redshift', but the '0x' prefix will be omitted, such as '0x61' being represented as '61'.                                                                                                                                                                                                                                                                  | ""                                      |
