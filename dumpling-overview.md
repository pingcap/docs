...
- `-F` option is used to specify the maximum size of a single file (the unit here is `MiB`; inputs like `5GiB` or `8KB` are also acceptable). It is advised to keep this 256 MB or less if you plan to use lightning to load this into a TiDB instance.
