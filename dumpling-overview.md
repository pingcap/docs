...
| `--csv-line-terminator`      | The terminator at the end of a line. When exporting data to a CSV file, you can pass in the desired terminator with this parameter. This parameter supports "\r\n" and "\n". The default value is "\r\n", which is consistent with the earlier versions. Because quotes in bash have different escaping rules, if you want to specify LF as a terminator, you can use a syntax similar to the following: `--csv-line-terminator $'\n'`. | "\r\n" |
