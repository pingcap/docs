...
Parameters for exporting data to Amazon S3 using Dumpling are the same as those for BR. For more parameter descriptions, see [External storages - URL format](/br/backup-and-restore-storages.md#url-format).
