...
Dumpling also supports reading credential files from `~/.aws/credentials` and using AWS profiles. For more information about URI parameter descriptions, see [URI Formats of External Storage Services](/external-storage-uri.md).
