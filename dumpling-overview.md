...
| `--csv-separator`            | Separator for each value in CSV files. If your data contains commas, it is recommended to use an uncommon character as the separator. Invisible characters are also supported, for example: `--csv-separator $'\001'`. | ','                                        |
