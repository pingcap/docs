...
In the following example, a two-layer topology of `zone/host` is defined. The TiDB node, TiKV nodes, and TiFlash nodes of the cluster are distributed among three zones, z1, z2, and z3.
