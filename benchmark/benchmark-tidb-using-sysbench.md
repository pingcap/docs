...
Sysbench 1.0.14 does not provide data warming, so it must be done manually. If you are using Sysbench in the Master version, you can use the data warming feature included in the tool itself.
