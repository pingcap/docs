...
Compared with v4.0, the Point Select performance of TiDB v5.0 has decreased by 12%.
...
Compared with v4.0, the Update Index performance of TiDB v5.0 has decreased by 20%.
