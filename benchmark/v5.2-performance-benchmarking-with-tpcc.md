...
summary: TiDB v5.2.0とv5.1.1のTPC-Cパフォーマンステスト結果は、v5.1.1と比較して4.22%低下しました。テストはAWS EC2で実施され、TiDB、TiKV、PDのハードウェア構成はそれぞれ異なります。テスト計画ではTiUPを使用し、BenchmarkSQLを実行しました。
---
...
v5.1.1 と比較すると、v5.2.0 の TPC-C パフォーマンスは**4.22% 低下します**。
