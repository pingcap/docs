...
summary: TiDB v6.1.0 の TPC-C パフォーマンスは v6.0.0 より 2.85% 向上しています。TiDB と TiKV のパラメータ構成は両方のバージョンで同じです。負荷分散には HAProxy が使用されます。結果は、さまざまなスレッド数でパフォーマンスが向上していることを示しています。
---
