...
# TiDB TPC-C パフォーマンス テスト レポート -- v5.3.0 対 v5.2.2 {#tidb-tpc-c-performance-test-report-v5-3-0-vs-v5-2-2}

## テストの概要 {#test-overview}

このテストは、オンライン トランザクション処理 (OLTP) シナリオで TiDB v5.3.0 と TiDB v5.2.2 の TPC-C パフォーマンスを比較することを目的としています。結果は、v5.2.2 と比較して、v5.3.0 の TPC-C パフォーマンスが 2.99% 低下したことを示しています。
...
1.  TiUP を使用してTiUP v5.3.0 および v5.2.2 をデプロイします。
...
v5.2.2 と比較すると、v5.3.0 の TPC-C パフォーマンスは**わずかに 2.99% 低下してい**ます。
