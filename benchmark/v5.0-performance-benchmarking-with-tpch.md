...
This test aims to compare the TPC-H 100 performance of TiDB v5.0 in the MPP mode with that of two mainstream analytics engines, Greenplum and Apache Spark, in their latest version. The test result shows that the performance of TiDB v5.0 in the MPP mode is two to three times better than other two solutions.
...
+ TiDB v5.0 column-based storage in the MPP mode
+ Greenplum 6.15.0
...
All TPC-H test tables replicated to TiDB are stored in column-based TiFlash, with no additional partitions or indexes.
...
> **Note:**
>
> The following test results are the average of three tests. All numbers are in seconds.
