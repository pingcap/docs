...
# TiDB TPC-C パフォーマンス テスト レポート -- v5.0 対 v4.0 {#tidb-tpc-c-performance-test-report-v5-0-vs-v4-0}
...
テスト統計によると、TiDB v5.0 の TPC-C パフォーマンスは、TiDB v4.0 と比較して**36% 向上して**います。
