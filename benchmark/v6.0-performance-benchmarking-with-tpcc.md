...
summary: TiDB v6.0.0 と v5.4.0 の TPC-C パフォーマンステストの結果は、v5.4.0 と比較して、v6.0.0 の TPC-C パフォーマンスが24.20%向上しています。スレッド50では22.61%、100では26.97%、200では25.76%、400では21.44%の改善が見られました。
---
