...
# TiDB TPC-C パフォーマンス テスト レポート -- v6.2.0 対 v6.1.0 {#tidb-tpc-c-performance-test-report-v6-2-0-vs-v6-1-0}

## テストの概要 {#test-overview}

このテストは、オンライン トランザクション処理 (OLTP) シナリオで TiDB v6.2.0 と v6.1.0 の TPC-C パフォーマンスを比較することを目的としています。結果は、v6.1.0 と比較して、v6.2.0 の TPC-C パフォーマンスが 2.00% 低下したことを示しています。
...
v6.1.0 と比較すると、v6.2.0 の TPC-C パフォーマンスは**2.00% 低下してい**ます。
