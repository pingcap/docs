...
- Select the mounted Filesystem and make a token with the required permissions available to `ti`. For available access options, see [Access an Existing TiDB Cloud Filesystem](/tidb-cloud-filesystem/access-filesystem.md).
