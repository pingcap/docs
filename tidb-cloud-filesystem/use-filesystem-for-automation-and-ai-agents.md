...
summary: Find TiDB for AI examples for sharing Filesystem workspaces, handing off CI artifacts, and supporting agents with data, Git, journals, and secrets.
---
...
| Record and verify an agent workflow | [Record an Agent Workflow in a TiDB Cloud Filesystem Journal](/ai/ti/guides/ti-journal-agent-workflow-example.md) |
| Give an agent limited access to a Vault secret | [Delegate TiDB Cloud Filesystem Vault Secrets to an Agent](/ai/ti/guides/ti-vault-agent-secrets-example.md) |
