...
- __MySQL compatibility__
    ...
    Easily replace MySQL with TiDB to power your applications without changing a single line of code [in most cases](sql/mysql-compatibility.md) and still benefit from the MySQL ecosystem.
