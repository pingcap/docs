...
The `USE` statement is used to switch the default database. If the table in this SQL statement does not have an explicitly specified database, then the default database is used.