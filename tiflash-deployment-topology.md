...
TiFlashは列指向型ストレージエンジンであり、徐々に標準的なクラスタートポロジーになりつつあります。リアルタイムHTAPアプリケーションに適しています。
...
-   TiFlashパラメータの詳細な説明については、 [TiFlash設定](/tiflash/tiflash-configuration.md)参照してください。
