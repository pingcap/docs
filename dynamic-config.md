...
| cdc.incremental-scan-speed-limit | The upper speed limit of incremental scanning for historical data |
| cdc.incremental-scan-concurrency | The maximum number of concurrent incremental scanning tasks for history data |
