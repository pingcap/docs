...
| `{db-name}.{cf-name}.titan.min-blob-size` | The threshold at which data is stored in Titan. When the value of the data reaches this threshold, it will be stored in a Titan blob file. |
