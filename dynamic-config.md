...
> **Note:**
>
> This feature is only applicable to TiDB Self-Managed and not available on [TiDB Cloud](https://docs.tidb.io/tidbcloud/). For TiDB Cloud, you need to contact [TiDB Cloud Support](https://docs.tidb.io/tidbcloud/tidb-cloud-support) to modify the configurations.
