...
| `instance.tidb_force_priority` | `tidb_force_priority` | Specifies the priority of statements for a TiDB instance |
| `instance.max_connections` | `max_connections` | Specifies the maximum number of concurrent connections permitted for a TiDB instance. |
| `instance.tidb_enable_ddl` | `tidb_enable_ddl` | Controls whether a TiDB instance can become a DDL owner |
