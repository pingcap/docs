...
| `raftstore.store-io-pool-size` | The allowable number of threads that process Raft I/O tasks, which is the size of the StoreWriter thread pool (**NOT** modify this value from `> 0` to `== 0` or `== 0` to `> 0`). |
