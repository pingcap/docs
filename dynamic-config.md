...
| `pessimistic-txn.in-memory-peer-size-limit`               | Control the memory size limit of pessimistic locks for one region                                                                                                                                                                                  |
| `pessimistic-txn.in-memory-instance-size-limit`           | Control the memory size limit of pessimistic locks for one TiKV instance                                                                                                                                                                           |
