...
2. Use Ansible to [stop the entire DM cluster](/v3.0/how-to/deploy/data-migration-with-ansible.md#step-10-stop-the-dm-cluster).
...
5. Use Ansible to [start the entire DM cluster](/v3.0/how-to/deploy/data-migration-with-ansible.md#step-9-deploy-the-dm-cluster).
