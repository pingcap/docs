...
* [Incremental backup](#incremental-backup): use [`TiDB-Binlog`](/reference/tools/tidb-binlog/overview.md) to replicate data in the TiDB cluster to another database or take a real-time backup of the data.
