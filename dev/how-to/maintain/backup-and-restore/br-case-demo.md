...
It is recommended that you deploy the TiDB cluster using [TiDB Ansible](/dev/how-to/deploy/orchestrated/ansible.md) and get BR by downloading [TiDB Toolkit](/dev/reference/tools/download.md#br-backup-and-restore).
