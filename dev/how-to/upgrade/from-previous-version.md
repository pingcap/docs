...
- Parallel DDL is enabled in TiDB 2.1 and later versions, so the clusters with a TiDB version earlier than 2.0.1 cannot upgrade to 2.1 using rolling update. You can choose either of the following two options:
