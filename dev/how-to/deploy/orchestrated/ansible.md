...
# Note: To use labels in TiKV, you must also configure location-labels for PD at the same time.
[tikv_servers]
...
# Note: For labels in TiKV to work, you must also configure location-labels for PD when deploying the cluster.
[pd_servers:vars]
