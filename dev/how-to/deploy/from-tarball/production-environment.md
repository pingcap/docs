...
See also [local deployment](/op-guide/binary-local-deployment.md) and [testing environment](/dev/how-to/deploy/from-tarball/testing-environment.md) deployment.
