...
server-id = 101
# In v1.0.2 and later versions, the `server_id` is automatically generated by DM
...
#  In v1.0.2 and later versions, DM automatically detects and fills in the release type
flavor = "mysql"
