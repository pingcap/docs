...
| SQL Query Time | Records the time it takes to execute the SQL statement in the downstream |
| Drainer Event | Shows the number of various types of events, including "ddl", "insert", "delete", "update", "flush", and "savepoint" |
| Execute Time | Records the time it takes to write binlog into the downstream |
