...
- Changed behaviors
    ...
    - Add the `tidb_txn_mode` system variable of global scope in TiDB and by default allow using the pessimistic lock; note that TiDB still adopts the optimistic lock by default
