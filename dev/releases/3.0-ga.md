...
- Performance. Compared with TiDB 2.1, TiDB 3.0 has shown significant performance improvement, with TPC-C benchmark risen by 350% and the Sysbench benchmark by over 50%. Thanks to the support of Views, TPC-H 50G Q15 can now run normally.
