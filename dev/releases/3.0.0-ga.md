...
On June 28, 2019, TiDB 3.0.0 GA is released. The corresponding TiDB Ansible version is 3.0.0. Compared with TiDB 2.1, this release has greatly improved in the following aspects:

- Stability. TiDB 3.0 has demonstrated long-term stability for large-scale clusters with up to 200+ nodes and 400+TB of storage.
...
- Performance. TiDB 3.0 has 4.5 times of performance improvements with TPC-C, 1.8 times with Sysbench, and 5%~120% with TPC-H 50G.
...
+ New Features
    ...
    - upport the SQL Plan Management function to create SQL execution plan binding to    - nsure query stability (**Experimental**)
+ SQL Optimizer
