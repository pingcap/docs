...
> **Note:**
>
> This is a user guide for TiSpark version later than 2.0. If you are using version earlier than 2.0, refer to [Document for Spark 2.1](/dev/reference/tispark/userguide-spark2.1.md)
...
See [here](/dev/reference/sql/statements/analyze-table.md) for more details on how to analyze tables.
