...
The `CHARACTER_SETS` table provides information about [character sets](/dev/reference/configuration/tidb-server/character-set.md). The default character set in TiDB is `utf8mb4`. Additional character sets in this table are included for compatibility with MySQL:
