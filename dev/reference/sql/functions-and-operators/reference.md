...
You can write expressions using literals, column names, NULL, built-in functions, operators and so on. For operators that TiDB supports for pushdown to TiKV, see [List of Operators for Pushdown](/dev/reference/sql/functions-and-operators/expressions-pushed-down.md).
