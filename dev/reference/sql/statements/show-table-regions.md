...
* In Region `102`, `START_KEY` and `END_KEY` mean that record data in the range of `[-inf, 20000)` is stored. In this way, the ranges of data storage in Regions (`103`, `109`, `113`, `2`) can also be calculated.
