...
The following list shows the keywords and reserved words in TiDB. The reserved words are labelled with `R`. [Window function](/dev/reference/sql/functions-and-operators/window-functions.md) is labelled with `R-Window`
