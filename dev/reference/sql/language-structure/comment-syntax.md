...
For details about the optimizer hints that TiDB supports, see [Optimizer hint](/dev/reference/configuration/tidb-server/tidb-specific-variables.md#optimizer-hint).
