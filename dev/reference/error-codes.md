...
| 8004 | A single transaction is too large. | See [here](/faq/tidb.md#the-error-message-transaction-too-large-is-displayed) for the cause and solution.  |
| 8005 | Transactions in TiDB encounters write conflicts. | See [here](/faq/tidb.md#troubleshoot) for the cause and solution. |
...
| 9007 | Transactions in TiKV encounters write conflicts. | See [here](/faq/tidb.md#troubleshoot) for the cause and solution. |
