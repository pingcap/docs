...
In v3.0.x and since v2.1.13, TiDB supports a new feature called [Split Region](/dev/reference/sql/statements/split-region.md). This new feature provides the following new syntaxes:
...
In this case, the table is simple. In other cases, you might also need to consider the hotspot problem of index. For more details about how to pre-split the index Region, refer to [Split Region](/dev/reference/sql/statements/split-region.md).
