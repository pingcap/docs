...
> **Note:**
>
> The column mapping is not recommended due to its usage restrictions. Refer [Handling conflicts of uto-increment primary key](/dev/reference/tools/data-migration/usage-scenarios/best-practice-dm-shard.md#handling-conflicts-of-auto-increment-primary-key) to see recommended solutions.
