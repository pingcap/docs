...
1. Before the full data migration, create a table in the downstream database for merging and replicating data. Modify the `PRIMARY KEY` attribute of the `auto_pk_c1` column to normal index.
