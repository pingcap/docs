...
+ Hardware configuration
    - For general purposes, please refer to the TiDB and TiKV hardware configuration [recommendations](/dev/how-to/deploy/hardware-recommendations.md#deployment-recommendations).
