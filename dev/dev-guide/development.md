...
Before you begin, check the [supported platforms](/dev/dev-guide/requirements.md#supported-platforms) and [prerequisites](/dev/dev-guide/requirements.md#prerequisites) first.
