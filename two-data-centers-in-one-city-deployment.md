...
- The cluster has six replicas: three Voter replicas in AZ1, two Voter replicas, and one Learner replica in AZ2. For the TiKV component, each rack has a proper label.
