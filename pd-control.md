...
- `halt-scheduling` is used to halt scheduling. When you set it to `true`, PD will halt scheduling and ignore other scheduling configurations. Introduced as of v6.5.3.
