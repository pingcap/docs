...
- `hot-region-cache-hits-threshold` is used to set the number of minutes required to identify the hot Region. Only when a Region is in the hot state for more than this number of minutes, it can participate in the hot scheduling.
