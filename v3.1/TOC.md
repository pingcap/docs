...
+ How-to
  ...
  + Deploy
    ...
    + Orchestrated Deployment
      ...
      - [Docker Deployment](/v3.1/how-to/deploy/orchestrated/docker.md)
  ...
  + Upgrade
    ...
    - [Upgrade TiDB Data Migration](/v3.1/reference/tools/data-migration/upgrade.md)
  - Troubleshoot
    - [Troubleshoot Cluster Setup](/v3.1/how-to/troubleshoot/cluster-setup.md)
    - [Troubleshoot TiDB Data Migration](/v3.1/how-to/troubleshoot/data-migration.md)
...
+ Reference
  + Tools
    ...
    + TiDB Data Migration
      ...
      + Migrate from MySQL compatible database
        - [Migrate from Aurora](/v3.1/how-to/migrate/from-aurora.md)
      + Troubleshoot
        - [Troubleshooting](/v3.1/how-to/troubleshoot/data-migration.md)
        - [Error Description](/v3.1/reference/tools/data-migration/error-system.md)
      - [FAQ](/v3.1/faq/data-migration.md)
    + TiDB Lightning
  ...
  + SQL
    ...
    + Data Types
      ...
      + Date and Time Types
        - [`DATE`](/v3.1/reference/sql/data-types/date-and-time.md#date-type)
  ...
  + TiDB Binlog
    - [Overview](/v3.1/reference/tools/tidb-binlog/overview.md)
    - [Deploy](/v3.1/reference/tools/tidb-binlog/deploy.md)
    - [Maintain](/v3.1/reference/tools/tidb-binlog/maintain.md)
    - [Monitor](/v3.1/reference/tools/tidb-binlog/monitor.md)
    - [Upgrade](/v3.1/reference/tools/tidb-binlog/upgrade.md)
    - [Reparo](/v3.1/reference/tools/tidb-binlog/reparo.md)
    - [Binlog Slave Client](/v3.1/reference/tools/tidb-binlog/binlog-slave-client.md)
    - [FAQ](/v3.1/reference/tools/tidb-binlog/faq.md)
...
+ FAQs
  ...
  - [Data Migration FAQ](/v3.1/faq/data-migration.md)
