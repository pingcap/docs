...
Before you begin, see [Deploy TiDB Using Ansible (Recommended)](/v3.1/how-to/deploy/orchestrated/ansible.md) and [Deploy TiDB Using Docker](/v3.1/how-to/deploy/orchestrated/docker.md).
