...
To learn more, see [TiDB architecture](/v3.1/architecture.md) and [Software and Hardware Recommendations](/v3.1/how-to/deploy/hardware-recommendations.md).

> **Warning:**
>
> This is for testing only. DO NOT USE in production! Please deploy TiDB with [our Ansible solution](/v3.1/how-to/deploy/orchestrated/ansible.md) or [TiDB Operator in Kubernetes](/v3.1/tidb-in-kubernetes/deploy/tidb-operator.md) in production.
