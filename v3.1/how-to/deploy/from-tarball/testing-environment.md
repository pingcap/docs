...
See also [local deployment](/v3.1/how-to/get-started/deploy-tidb-from-binary.md) and [production environment](/v3.1/how-to/deploy/from-tarball/production-environment.md) deployment.
