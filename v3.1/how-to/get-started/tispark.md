...
category: how-to
aliases: ['/docs/tispark/tispark-quick-start-guide/','/docs/v3.1/how-to/deploy/tispark/']
---

# TiSpark Quick Start Guide

To make it easy to [try TiSpark](/v3.1/reference/tispark.md), the TiDB cluster installed using TiDB Ansible integrates Spark, TiSpark jar package and TiSpark sample data by default.
