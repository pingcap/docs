...
category: how-to
aliases: ['/docs/op-guide/binary-local-deployment/','/docs/v3.1/how-to/get-started/local-cluster/install-from-binary/']
---
...
See also [testing environment](/v3.1/how-to/deploy/from-tarball/testing-environment.md) and [production environment](/v3.1/how-to/deploy/from-tarball/production-environment.md) deployment.
...
See the [production deployment](/v3.1/how-to/deploy/from-tarball/production-environment.md) optional kernel tuning parameters.
