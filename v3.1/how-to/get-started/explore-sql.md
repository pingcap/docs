...
TiDB is compatible with MySQL, you can use MySQL statements directly in most of the cases. For unsupported features, see [Compatibility with MySQL](/v3.1/reference/mysql-compatibility.md#unsupported-features).
