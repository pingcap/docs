...
+ SQL Optimizer
    ...
    - Fix the issue that the result is incorrect when the `UPDATE` statement contains both a sub-query and a generated column; 
    
        fix the `UPDATE` statement execution error when this statement contains two same-named tables from different source databases
        
        [#13350](https://github.com/pingcap/tidb/pull/13350)
...
+ Server
    ...
    - Add the following virtual tables: 
        ...
        [#13009](https://github.com/pingcap/tidb/pull/13009)
...
+ DDL
    ...
    - Add more transaction-related fields for the `slow_query` table:
        - `Prewrite_time` 
        - `Commit_time`
        - `Get_commit_ts_time`
        - `Commit_backoff_time`
        ...
        [#13072](https://github.com/pingcap/tidb/pull/13072)
    ...
    - Limit the length of the index name when creating a table创建表时限制索引名字的长度 [#13310](https://github.com/pingcap/tidb/pull/13310)
