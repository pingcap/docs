...
![CreateIndexStmt](/media/sqlgram-v3.0/CreateIndexStmt.png)

**CreateIndexStmtUnique:**

![CreateIndexStmtUnique](/media/sqlgram-v3.0/CreateIndexStmtUnique.png)
...
![IndexTypeOpt](/media/sqlgram-v3.0/IndexTypeOpt.png)
...
![IndexColNameList](/media/sqlgram-v3.0/IndexColNameList.png)

**IndexOptionList:**

![IndexOptionList](/media/sqlgram-v3.0/IndexOptionList.png)
...
The global variables associated with the `CREATE INDEX` statement are `tidb_ddl_reorg_worker_cnt`, `tidb_ddl_reorg_batch_size` and `tidb_ddl_reorg_priority`. Refer to [TiDB-specific system variables](/v3.1/reference/configuration/tidb-server/tidb-specific-variables.md#tidb_ddl_reorg_worker_cnt) for details.
