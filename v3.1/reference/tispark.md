...
+ Hardware configuration
    - For general purposes, refer to the TiDB and TiKV hardware configuration [recommendations](/v3.1/how-to/deploy/hardware-recommendations.md#development-and-test-environments).
...
If you would like TiSpark to use statistic information, first you need to make sure that concerning tables have already been analyzed. Read more about [how to analyze tables](/v3.1/reference/performance/statistics.md).
