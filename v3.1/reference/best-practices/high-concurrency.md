...
In v3.0.x and since v2.1.13, TiDB supports a new feature called [Split Region](/v3.1/reference/sql/statements/split-region.md). This new feature provides the following new syntaxes:
