...
In v3.0.x and from v2.1.13 on, TiDB supports a new feature called [Split Region](/v3.1/reference/sql/statements/split-region.md). This new feature provides the following new syntaxes:
...
To avoid the hotspot problem in this situation, you can use `SHARD_ROW_ID_BITS` and `PRE_SPLIT_REGIONS` when creating a table. For more details about `PRE_SPLIT_REGIONS`, refer to [here](/v3.1/reference/sql/statements/split-region.md#pre_split_regions).
