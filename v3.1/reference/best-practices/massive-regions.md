...
Refer to [Region Merge](https://github.com/tikv/tikv/blob/master/docs/how-to/configure/region-merge.md) and the following three configuration parameters in the [PD configuration file](/v3.1/reference/configuration/pd-server/configuration-file.md#schedule) for more details:

- [`max-merge-region-size`](/v3.1/reference/configuration/pd-server/configuration-file.md#max-merge-region-size)
- [`max-merge-region-keys`](/v3.1/reference/configuration/pd-server/configuration-file.md#max-merge-region-keys)
