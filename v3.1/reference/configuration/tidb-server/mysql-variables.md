...
You can use the [`SET`](/v3.1/reference/sql/statements/set-variable.md) statement to change the value of the system variables. Before you change, consider the scope of the variable. For more information, see [MySQL Dynamic System Variables](https://dev.mysql.com/doc/refman/5.7/en/dynamic-system-variables.html).
...
See [TiDB Specific System Variables](/v3.1/reference/configuration/tidb-server/tidb-specific-variables.md).
