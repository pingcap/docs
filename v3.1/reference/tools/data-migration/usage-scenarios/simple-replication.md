...
- To satisfy the replication Requirement #1-iv, configure the [binlog filtering rules](/v3.1/reference/tools/data-migration/features/overview.md#binlog-event-filter) as follows:
