...
category: tools
aliases: ['/docs/v3.1/reference/tools/sync-diff-inspector/']
---
...
* Support [data check for tables with different schema or table names](/v3.1/reference/tools/sync-diff-inspector/route-diff.md)
* Support [data check in the sharding scenario](/v3.1/reference/tools/sync-diff-inspector/shard-diff.md)
* Support [data check for TiDB upstream-downstream clusters](/v3.1/reference/tools/sync-diff-inspector/tidb-diff.md)
