...
6. Check the Character Set.
    ...
    TiDB differs from MySQL in [Character Set](/v3.1/reference/sql/character-set.md).

7. Check whether the tale to be replicated has a primary key or a unique key.
