...
[Backup & Restore](/v3.1/reference/tools/br/br.md) (BR) is a command-line tool for distributed backup and restoration of the TiDB cluster data. This document describes the processes of operating BR in four scenarios that aims to help you achieve the following goals:
