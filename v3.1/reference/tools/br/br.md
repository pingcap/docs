...
In the above command, `--db` specifies the name of the database to be backed up. For descriptions of other options, see [Back up all the cluster data](/v3.1/reference/tools/br/br.md#back-up-all-the-cluster-data).
...
For more recommended practices of using BR, refer to [BR Case Demonstrations](/v3.1/reference/tools/br/br-case-demo.md).
