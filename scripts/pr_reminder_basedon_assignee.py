...
if __name__ == "__main__":
    ...
    data = {
        ...
        'shichun-0415-zh-assignee-open': str(get_pr_no(docs_cn_url + open_url + shichun_0415_assignee + v54)),
        'shichun-0415-zh-assignee-close': str(get_pr_no(docs_cn_url + close_url + shichun_0415_assignee + v54)),
        'shichun-0415-zh-author-open': str(get_pr_no(docs_cn_url + open_url + shichun_0415_author + v54)),
        'shichun-0415-en-assignee-open': str(get_pr_no(docs_url + open_url + shichun_0415_assignee + v54)),
        'shichun-0415-en-assignee-close': str(get_pr_no(docs_url + close_url + shichun_0415_assignee + v54)),
        'shichun-0415-en-author-open': str(get_pr_no(docs_url + open_url + shichun_0415_author + v54)),
        'en-jin19-zh-assignee-open': str(get_pr_no(docs_cn_url + open_url + en_jin19_assignee + v54)),
        'en-jin19-zh-assignee-close': str(get_pr_no(docs_cn_url + close_url + en_jin19_assignee + v54)),
        'en-jin19-zh-author-open': str(get_pr_no(docs_cn_url + open_url + en_jin19_author + v54)),
        'en-jin19-en-assignee-open': str(get_pr_no(docs_url + open_url + en_jin19_assignee + v54)),
        'en-jin19-en-assignee-close': str(get_pr_no(docs_url + close_url + en_jin19_assignee + v54)),
        'en-jin19-en-author-open': str(get_pr_no(docs_url + open_url + en_jin19_author + v54)),
        'hfxsd-zh-assignee-open': str(get_pr_no(docs_cn_url + open_url + hfxsd_assignee + v54)),
        'hfxsd-zh-assignee-close': str(get_pr_no(docs_cn_url + close_url + hfxsd_assignee + v54)),
        'hfxsd-zh-author-open': str(get_pr_no(docs_cn_url + open_url + hfxsd_author + v54)),
        'hfxsd-en-assignee-open': str(get_pr_no(docs_url + open_url + hfxsd_assignee + v54)),
        'hfxsd-en-assignee-close': str(get_pr_no(docs_url + close_url + hfxsd_assignee + v54)),
        'hfxsd-en-author-open': str(get_pr_no(docs_url + open_url + hfxsd_author + v54)),
        'ran-huang-zh-assignee-open': str(get_pr_no(docs_cn_url + open_url + ran_huang_assignee + v54)),
        'ran-huang-zh-assignee-close': str(get_pr_no(docs_cn_url + close_url + ran_huang_assignee + v54)),
        'ran-huang-zh-author-open': str(get_pr_no(docs_cn_url + open_url + ran_huang_author + v54)),
        'ran-huang-en-assignee-open': str(get_pr_no(docs_url + open_url + ran_huang_assignee + v54)),
        'ran-huang-en-assignee-close': str(get_pr_no(docs_url + close_url + ran_huang_assignee + v54)),
        'ran-huang-en-author-open': str(get_pr_no(docs_url + open_url + ran_huang_author + v54)),
        'qiancai-zh-assignee-open': str(get_pr_no(docs_cn_url + open_url + qiancai_assignee + v54)),
        'qiancai-zh-assignee-close': str(get_pr_no(docs_cn_url + close_url + qiancai_assignee + v54)),
        'qiancai-zh-author-open': str(get_pr_no(docs_cn_url + open_url + qiancai_author +v54)),
        'qiancai-en-assignee-open': str(get_pr_no(docs_url + open_url + qiancai_assignee + v54)),
        'qiancai-en-assignee-close': str(get_pr_no(docs_url + close_url + qiancai_assignee + v54)),
        'qiancai-en-author-open': str(get_pr_no(docs_url + open_url + qiancai_author +v54)),
        'TomShawn-zh-assignee-open': str(get_pr_no(docs_cn_url + open_url + TomShawn_assignee + v54)),
        'TomShawn-zh-assignee-close': str(get_pr_no(docs_cn_url + close_url + TomShawn_assignee + v54)),
        'TomShawn-zh-author-open': str(get_pr_no(docs_cn_url + open_url + TomShawn_author + v54)),
        'TomShawn-en-assignee-open': str(get_pr_no(docs_url + open_url + TomShawn_assignee + v54)),
        'TomShawn-en-assignee-close': str(get_pr_no(docs_url + close_url + TomShawn_assignee + v54)),
        'TomShawn-en-author-open': str(get_pr_no(docs_url + open_url + TomShawn_author + v54)),
