...
ext_path = r'/Users/grcai/Documents/GitHub/docs/releases'  # Specify the directory of the English release notes folder
main_path = r'/Users/grcai/Documents/GitHub/docs/releases/release-8.2.0.md'  # Specify the directory of the English release note file that you are preparing
