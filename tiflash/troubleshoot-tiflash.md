...
1. Check whether your system is CentOS Stream 8.

     CentOS Stream 8 does not have the `libnsl.so` system library. You can manually install it via the following command:
