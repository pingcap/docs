...
[storage]
    ...
    ## * format_version = 4, the default format for v6.2.0 and later versions, which provides lower write amplification and lower background task resource consumption
    # format_version = 4
