...
- クラスターを複数のノードにデプロイする場合は、他のノードが`advertise-addr`を介してアクセスできることを保証することをお勧めします。
...
- クラスターを複数のノードにデプロイする場合は、他のノードが`advertise-status-addr`を介してアクセスできることを保証することをお勧めします。
