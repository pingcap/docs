...
- クラスターを複数のノードにデプロイする場合は、他のノードが`advertise-addr`を介してアクセスできることを保証することが推奨されます。
...
- クラスターを複数のノードにデプロイする場合は、他のノードが`advertise-status-addr`を介してアクセスできることを保証することが推奨されます。
