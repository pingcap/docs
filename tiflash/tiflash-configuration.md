...
[profiles.default]
    ...
    ## New in v5.4.0. This item specifies the minimum valid rate for triggering a hardlink by a PageFile (log type). The value range is [0.1,1.0]. The smaller the value, the more frequent the hardlink operations. The greater the value, the more strict the condition to trigger a hardlink.
