...
[profiles.default]
    ...
    ## New in v5.4.0. This item enables or disables the elastic thread pool function that significantly improves CPU utilization in high concurrency scenarios of TiFlash. The default value is false. The elastic thread pool function is experimental and cannot be enabled in production environments.
