...
- To deploy a new cluster with TiFlash node, see [Deploy a TiDB cluster using TiUP](/production-deployment-using-tiup.md).
...
- To use TiFlash after the deployment, see [Use TiFlash](/tiflash/use-tiflash.md).
- To maintain a TiFlash cluster, see [Maintain a TiFlash cluster](/tiflash/maintain-tiflash.md).
- To tune TiFlash performance, see [Tune TiFlash performance](/tiflash/tune-tiflash-performance.md).
- To configure TiFlash, see [Configure TiFlash](/tiflash/tiflash-configuration.md).
- To monitor the TiFlash cluster, see [Monitor the TiFlash cluster](/tiflash/monitor-tiflash.md).
- To learn TiFlash alert rules, see [TiFlash alert rules](/tiflash/tiflash-alert-rules.md).
- To troubleshoot a TiFlash cluster, see [Troubleshoot a TiFlash cluster](/tiflash/troubleshoot-tiflash.md).
