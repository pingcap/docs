...
> - In versions between v6.3.0 and v7.0.0, if the TiFlash replica is enabled, you can use the variable [tidb_enable_tiflash_read_for_write_stmt](/system-variables.md#tidb_enable_tiflash_read_for_write_stmt-new-in-v630) to decide whether to use the TiFlash replica for a non-read-only SQL statement.
