...
# TiDBストレージ {#tidb-ストレージ}

このドキュメントでは、 [TiKV](https://github.com/tikv/tikv)の設計アイデアと主要な概念をいくつか紹介します。

![ストレージ-architecture](/media/tidb-ストレージ-architecture-1.png)
...
## ローカルストレージ（RocksDB） {#local-ストレージ-rocksdb}
...
![Raft in TiDB](/media/tidb-ストレージ-1.png)
...
![Region in TiDB](/media/tidb-ストレージ-2.png)
...
![TiDB Storage](/media/tidb-ストレージ-3.png)
