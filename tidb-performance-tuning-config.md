...
| [`tidb_analyze_column_options`](/system-variables.md#tidb_analyze_column_options-new-in-v830)| Collect statistics for all the columns to avoid bad execution plan causing by missing statistics. | This can cause more resource usage for the analyze job compared to the default value |
