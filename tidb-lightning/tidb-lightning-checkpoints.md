...
* With `driver = "mysql"`, checkpoints can be saved in any databases compatible with MySQL, including MariaDB and TiDB. By default, the checkpoints are saved in the target database.
