...
```toml
[mydumper.csv]
# Separator between fields. Must not be empty. Must be ASCII characters. It is not recommended to use the default ",". It is recommended to use "|+|" or other uncommon character combinations.
separator = ','
