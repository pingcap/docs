...
aliases: ['/docs/v2.1/tidb-lightning/tidb-lightning-overview/','/docs/v2.1/reference/tools/tidb-lightning/overview/']
---
...
![Architecture of TiDB Lightning tool set](/media/tidb-lightning-architecture-v2.1.png)
