...
[TiDB Lightning](https://github.com/pingcap/tidb/tree/release-8.1/lightning) is a tool used for importing data at TB scale to TiDB clusters. It is often used for initial data import to TiDB clusters.
