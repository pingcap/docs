...
aliases: ['/docs/stable/tidb-lightning/tidb-lightning-tidb-backend/','/docs/stable/reference/tools/tidb-lightning/tidb-backend/','/tidb/stable/tidb-lightning-tidb-backend','/docs/v4.0/tidb-lightning/tidb-lightning-tidb-backend/','/tidb/v4.0/tidb-lightning-tidb-backend']
---
...
If you need to import data into a TiDB cluster, TiDB Lightning using the TiDB-backend can completely replace the functionalities of [Loader](/loader-overview.md). The following list shows how to translate Loader configurations into [TiDB Lightning configurations](/tidb-lightning/tidb-lightning-configuration.md).
...
# log output directory. If this location directory is not specified, the file path where the command is executed is the default directory.
