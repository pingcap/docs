...
- Deploy each TiDB Lightning instance on a dedicated machine. TiDB Lightning consumes all CPU resources by default. Deploying multiple instances on a single machine can not improve performance.
