...
aliases: ['/docs/stable/tidb-lightning/deploy-tidb-lightning/','/docs/v4.0/tidb-lightning/deploy-tidb-lightning/','/docs/stable/reference/tools/tidb-lightning/deployment/']
---
