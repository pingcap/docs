...
- `tikv-importer.duplicate-resolution` (deprecated in v8.0.0, will be removed in v8.5): the conflict handling configuration that can only be used in the physical import mode
