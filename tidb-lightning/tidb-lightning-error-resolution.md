...
- `tikv-importer.duplicate-resolution` (deprecated in v8.0.0 and will be removed in v8.5.0): the conflict handling configuration that can only be used in the physical import mode
