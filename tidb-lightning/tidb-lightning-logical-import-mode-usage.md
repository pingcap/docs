...
| `"ignore"` | Keeping existing data and ignoring new data. | If `conflict.threshold` is greater than 0, use `INSERT INTO`. If `conflict.threshold` is `0`, use `INSERT IGNORE INTO ...` |
