...
summary: TiDB Lightningの論理インポートモードは、設定ファイルを使用してデータをインポートします。競合するデータの処理方法を設定し、パフォーマンス調整も重要です。書き込みパフォーマンスに依存し、`region-concurrency`の値を調整することで速度を向上させることができます。競合データの処理方法を設定し、パフォーマンスを向上させるためには、設定ファイルを使用してデータをインポートします。
---
