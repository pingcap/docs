...
An operation to rebuild the [statistics](/statistics.md) information of a TiDB table, which is running the [`ANALYZE TABLE`](/common/sql-statements/sql-statement-analyze-table.md) statement.
