...
TiDB Lightning using the TiDB-backend can completely replace functions of [Loader](/reference/tools/loader.md). The following list shows how to translate Loader configurations into [TiDB Lightning configurations](/reference/tools/tidb-lightning/deployment.md#step-4-start-tidb-lightning).
