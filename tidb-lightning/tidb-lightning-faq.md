...
- Importing files exported by [Dumpling](/dumpling-overview.md), CSV files, and [Apache Parquet files generated by Amazon Aurora](/tidb-lightning/migrate-from-csv-using-tidb-lightning.md).
