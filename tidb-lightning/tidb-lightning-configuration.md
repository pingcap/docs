...
# Meanwhile, if you want to adjust concurrency when this value is "true", you need to set the `tidb_checksum_table_concurrency` (https://docs.pingcap.com/tidb/stable/system-variables#tidb_checksum_table_concurrency) parameter in TiDB.
