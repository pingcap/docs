...
# send-kv-pairs = 32768
# Whether to enable compression when sending KV pairs to TiKV in the physical import mode. Currently only the Gzip compression algorithm is supported. To use this algorithm, you can fill in either "gzip" or "gz". By default, the compression is not enabled.
# compress-kv-pairs = ""
