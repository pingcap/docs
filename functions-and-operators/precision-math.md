...
For more information about the internal format of the DECIMAL values, see [`mydecimal.go`](https://github.com/pingcap/tidb/blob/release-7.1/types/mydecimal.go) in TiDB souce code.
