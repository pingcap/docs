...
[`IFNULL(expr1,expr2)`](https://dev.mysql.com/doc/refman/8.0/en/flow-control-functions.html#function_ifnull)関数は、クエリ内の NULL 値を処理するために使用されます。`expr1` `NULL`でない場合は`expr1`返し、そうでない場合は`expr2`返します。
