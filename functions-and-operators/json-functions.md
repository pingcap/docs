...
aliases: ['/docs/stable/functions-and-operators/json-functions/','/docs/v4.0/functions-and-operators/json-functions/','/docs/stable/reference/sql/functions-and-operators/json-functions/']
---
