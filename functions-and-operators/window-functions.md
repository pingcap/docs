...
aliases: ['/docs/stable/functions-and-operators/window-functions/','/docs/v4.0/functions-and-operators/window-functions/','/docs/stable/reference/sql/functions-and-operators/window-functions/']
---
