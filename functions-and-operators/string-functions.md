...
- The difference between TiDB and MySQL support in the keyword of capture group. The keywords of capture group in MySQL and TiDB are `$` and `\\` respectively, and TiDB only supports capture group numberd 0-9. 
