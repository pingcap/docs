...
| `VITESS_HASH(str)` | The `VITESS_HASH(str)` function returns the hash of a string that is compatible with Vitess' `HASH` function. This is intended to help the data migration from Vitess. |
