...
パーティション プルーニングの使用シナリオは、範囲パーティション テーブルとハッシュ パーティション テーブルという 2種類のパーティション テーブルで異なります。
...
このセクションでは、ハッシュ パーティション テーブルでのパーティション プルーニングの適用されない 2つの使用シナリオについて説明します。
...
このセクションでは、範囲パーティション化されたテーブルでのパーティション プルーニングの適用可能な 3つの使用シナリオについて説明します。
