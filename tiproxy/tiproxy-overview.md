...
- Sensitive to performance: The performance of TiProxy is lower than that of HAProxy and other load balancers, so using TiProxy requires reserving more CPU resources. For details, refer to [TiProxy Performance Test Report](/tiproxy/tiproxy-performance-test.md).
