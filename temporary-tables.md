...
- TiDB local temporary tables ignore the `ENGINE` table option, and always store temporary table data in TiDB memory with a [memory limit](/temporary-tables.md#limit-the-memory-usage-of-temporary-tables).
