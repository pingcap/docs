...
TiDB は、MariaDB 11.6 以降のバージョンのデフォルトの照合順序である`utf8mb4_uca1400_ai_ci`をサポートしていません。代わりに`utf8mb4_0900_ai_ci`を使用してください。これら 2つの照合順序は[Unicode照合アルゴリズム（UCA）](http://www.unicode.org/reports/tr10/) : `utf8mb4_0900_ai_ci`は UCA 9.0.0 を使用し、 `utf8mb4_uca1400_ai_ci`は UCA 14.0.0 を使用します。
