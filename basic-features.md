...
| インデックス作成と制約                                                               | 6.1 | 6.0 | 5.4 | 5.3 | 5.2 | 5.1 | 5.0 | 4.0 |
| ------------------------------------------------------------------------- | :-: | :-: | --- | :-: | :-: | :-: | :-: | :-: |
| [式インデックス](/sql-statements/sql-statement-create-index.md#expression-index) | 実験的 | 実験的 | 実験的 | 実験的 | 実験的 | 実験的 | 実験的 | 実験的 |
| [列指向ストレージ（TiFlash）](/tiflash/tiflash-overview.md)                         |  Y  |  Y  | Y   |  Y  |  Y  |  Y  |  Y  |  Y  |
...
| [目に見えないインデックス](/sql-statements/sql-statement-add-index.md)                |  Y  |  Y  | Y   |  Y  |  Y  |  Y  |  Y  |  N  |
...
| SQLステートメント[^2]                                                                     | 6.1 | 6.0 | 5.4 | 5.3 | 5.2 | 5.1 | 5.0 | 4.0 |
| ---------------------------------------------------------------------------------- | :-: | :-: | --- | :-: | :-: | :-: | :-: | :-: |
...
| 高度なSQL機能                                              | 6.1 | 6.0 | 5.4 | 5.3 | 5.2 | 5.1 | 5.0 | 4.0 |
| ----------------------------------------------------- | :-: | :-: | --- | :-: | :-: | :-: | :-: | :-: |
...
| [フォロワーは読む](/follower-read.md)                         |  Y  |  Y  | Y   |  Y  |  Y  |  Y  |  Y  |  Y  |
...
| [SQLでの配置ルール](/placement-rules-in-sql.md)              |  Y  |  Y  | 実験的 | 実験的 |  N  |  N  |  N  |  N  |
...
| [繰り返し読み取りの分離（スナップショット分離）](/transaction-isolation-levels.md)           |  Y  | Y   | Y   |  Y  |  Y  |  Y  |  Y  |  Y  |
...
| [メトリックスキーマ](/metrics-schema.md)                                               |  Y  |  Y  | Y   |  Y  |  Y  |  Y  |  Y  |  Y  |
