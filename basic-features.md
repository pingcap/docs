...
| [Acceleration of `ADD INDEX` and `CREATE INDEX`](/system-variables.md#tidb_ddl_enable_fast_reorg-new-in-v630) | Experimental | Experimental | Experimental | N | N | N | N | N | N | N | N | N |
| [Metadata lock](/metadata-lock.md) | Experimental | Experimental | Experimental | N | N | N | N | N | N | N | N | N |
| [`FLASHBACK CLUSTER TO TIMESTAMP`](/sql-statements/sql-statement-flashback-to-timestamp.md) | Experimental | Experimental | N | N | N | N | N | N | N | N | N | N |
