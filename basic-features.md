...
[^5]: Starting from [TiDB v7.0.0](/releases/release-7.0.0.md), the new parameters `FORMAT`, `FIELDS DEFINED NULL BY`, `With batch_size=<number>,detached`, and support for importing data from S3 and GCS, are experimental features.
