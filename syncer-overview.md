...
aliases: ['/docs/stable/syncer-overview/','/docs/v4.0/syncer-overview/','/docs/stable/reference/tools/syncer/','/tidb/stable/syncer-overview','/tidb/v4.0/syncer-overview']
---
