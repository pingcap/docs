...
From the output of [`SHOW TABLE REGIONS`](/common/sql-statements/sql-statement-show-table-regions.md), you can see that this table is split into multiple Regions:
