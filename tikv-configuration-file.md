...
+ Value options:
    ...
    + `2`: Uses API V2:
        ...
        + Since v6.2.0, Change Data Capture (CDC) for RawKV is supported. Please refer to [RawKV CDC](https://tikv.org/docs/latest/concepts/explore-tikv-features/cdc/cdc).
+ Default value: `1`
