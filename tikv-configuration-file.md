...
> **Note:**
>
> This configuration item was introduced to address backup failures caused by S3 rate limiting. Starting from TiDB v6.1.1, configure this value with caution. Setting it too large might cause larger upload parts to fail or time out when the network is unstable.
