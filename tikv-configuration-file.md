...
+ The minimum SST file size when the compaction guard is enabled. This config prevents SST files from being too small when the compaction guard is enabled.
+ Default value: `"8MB"`
+ Unit: KB|MB|GB
