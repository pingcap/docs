...
> **Note:**
> 
> - When you enable Raft Engine first time, you need to wait tens of seconds, because TiKV switches to the data format of Raft Engine from the one of RocksDB.
