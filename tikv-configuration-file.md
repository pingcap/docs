...
> **Note:**
>
> This configuration was introduced to address backup failures caused by S3 rate limiting. From v6.1.1 onwards, configure this setting with caution. Setting it too large may cause large parts to fail or time out during network jitter.
