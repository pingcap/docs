...
> **Note:**
>
> This configuration item was introduced to address backup failures caused by S3 rate limiting. For TiDB v6.1.1 and later, configure this value with caution. Setting it too large might cause larger upload parts to fail or time out when the network is unstable.
