...
### `bg-cpu-throttle-threshold` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#bg-cpu-throttle-threshold}
...
### `fg-cpu-throttle-threshold` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#fg-cpu-throttle-threshold}
...
### `bg-compaction-pressure-threshold` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#bg-compaction-pressure-threshold}
...
### `bg-write-io-ceiling` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#bg-write-io-ceiling}
...
### `bg-write-io-floor` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#bg-write-io-floor}
...
### `enable-fair-scheduling` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#enable-fair-scheduling}
...
### `enable-read-admission-control` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#enable-read-admission-control}
...
### `enable-write-admission-control` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#enable-write-admission-control}
...
### `historical-usage-window-mins` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#historical-usage-window-mins}
...
### `baseline-burst-pct` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#baseline-burst-pct}
...
### `admission-max-delayed-count` <span class="version-mark">New in v8.5.7 and v9.0.0</span> {#admission-max-delayed-count}
