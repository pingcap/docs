...
### <code>max-size</code> <span class="version-mark">v5.4.0の新</span>機能 {#max-size-new-in-v540}
...
### <code>capacity</code> <span class="version-mark">（v8.5.0の新</span>機能） {#capacity-new-in-v850}
