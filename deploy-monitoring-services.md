...
| 名前   | ホストIP           | サービス                              |
| :--- | :-------------- | :-------------------------------- |
| ノード1 | 192.168.199.113 | PD1、TiDB、node_exporter、Prometheus、Grafana |
| ノード2 | 192.168.199.114 | PD2、Node Exporter                     |
| ノード3 | 192.168.199.115 | PD3、Node Exporter                     |
| ノード4 | 192.168.199.116 | TiKV1、Node Exporter                   |
| ノード5 | 192.168.199.117 | TiKV2、Node Exporter                   |
| ノード6 | 192.168.199.118 | TiKV3、Node Exporter                   |
...
### ステップ2: Node1、Node2、Node3、Node4で`node_exporter`起動する {#step-2-start-node-exporter-on-node1-node2-node3-and-node4}
...
3.  **「.json ファイルのアップロード」**をクリックして JSON ファイルをアップロードします ( [pingcap/tidb](https://github.com/pingcap/tidb/tree/release-8.5/pkg/metrics/grafana) [ティックブ/ティックブ](https://github.com/tikv/tikv/tree/release-8.5/metrics/grafana)および[ティックブ/PD](https://github.com/tikv/pd/tree/release-8.5/metrics/grafana)から TiDB Grafana 構成ファイルをダウンロードします)。
