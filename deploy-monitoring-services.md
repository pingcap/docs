...
### ステップ2: Node1、Node2、Node3、Node4で`node_exporter`を起動する {#step-2-start-node-exporter-on-node1-node2-node3-and-node4}
...
2. Grafana サイドバー メニューで、**Configuration**内の**データソース**をクリックします。
