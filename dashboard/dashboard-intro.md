...
## TiDBクラスターの全体的な実行ステータスを表示します {#show-the-overall-running-status-of-the-tidb-cluster}
...
詳細は[TiDBダッシュボードのクラスター情報ページ](/dashboard/dashboard-cluster-info.md)参照。
...
詳細は[TiDBダッシュボードのクラスター診​​断ページ](/dashboard/dashboard-diagnostics-access.md)参照。
