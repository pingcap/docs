...
- To use the [Quick Bind Executions Plan](dashboard-statement-details.md) feature on the interface after signing in to TiDB Dashboard, the SQL user must also have the following privilege:
