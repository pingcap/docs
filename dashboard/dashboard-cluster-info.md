...
summary: TiDBダッシュボードのクラスター情報ページでは、クラスター全体のTiDB、TiKV、PD、 TiFlashコンポーネントの稼働状況、およびこれらのコンポーネントが配置されているホストの稼働状況を確認できます。このページにアクセスするには、TiDBダッシュボードにログインし、左側のナビゲーションメニューで「クラスター情報」をクリックするか、ブラウザで特定のURLにアクセスしてください。このページには、インスタンス、ホスト、ディスクのリストが表示され、各コンポーネントの詳細情報と稼働状況が表示されます。
---

# TiDBダッシュボードのクラスター情報ページ {#tidb-dashboard-cluster-information-page}
...
-   TiDB ダッシュボードにログインしたら、左側のナビゲーション メニューで**[クラスター情報]**をクリックします。
