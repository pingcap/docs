...
> - For prepared statements arguments are listed at the end of the query like this: `[arguments: "foo", 123]`. Non-printable arguments are printed as hex-literal, for example `0x01`.
