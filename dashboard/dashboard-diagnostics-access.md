...
上記の手順により、 `2022-05-21 14:40:00`から`2022-05-21 14:50:00`の時間範囲の診断レポートが生成されます。 **Start**をクリックすると、以下のインターフェースが表示されます。 **進行状況**は診断レポートの進行状況バーです。レポートが生成されたら、 **「完全なレポートを表示する」を**クリックしてください。
