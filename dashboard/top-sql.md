...
* Show information such as CPU usage, requests per second, average latency, and query plan of a particular query, which can be used as a potential performance optimization point to improve your business.
