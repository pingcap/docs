...
aliases: ['/docs/v2.1/tidb-specific-system-variables/','/docs/v2.1/reference/configuration/tidb-server/tidb-specific-variables/']
---
...
- Default value (in 2.1.17 or later): 4
...
- Default value (in 2.1.17 or later): 256
