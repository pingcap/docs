...
- This variable is used to set the transaction mode. TiDB v3.0 supports the pessimistic transactions. Since TiDB v3.0.8, the [pessimistic transaction mode](/pessimistic-transaction.md) is enabled by default.
