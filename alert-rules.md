...
-   解決：
    ...
    1.  TiDB ログからスロークエリ ログを確認し、クエリでインデックスまたは完全なテーブル スキャンが使用されているかどうか、または分析に必要かどうかを確認します。
...
-   解決：
    ...
    -   Grafana Blackbox Exporter ページで 2 つのノード間の pingレイテンシーを確認し、遅延が高すぎないかどうかを確認します。
