...
See also [local deployment](/v3.0/how-to/get-started/local-cluster/install-from-binary.md) and [testing environment](/v3.0/how-to/deploy/from-tarball/testing-environment.md) deployment.

## Prepare

Before you start, see [TiDB architecture](/architecture.md) and [Software and Hardware Recommendations](/v3.0/how-to/deploy/hardware-recommendations.md). Make sure the following requirements are satisfied:
