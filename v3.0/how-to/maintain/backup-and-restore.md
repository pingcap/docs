...
You can use [`mydumper`](/v3.0/reference/tools/mydumper.md) to export data from MySQL and [`loader`](/v3.0/reference/tools/loader.md) to import the data into TiDB.
