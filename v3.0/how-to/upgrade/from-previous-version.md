...
This document is targeted for users who want to upgrade from TiDB 2.0 (2.0.1 or later versions) or TiDB 2.1 (2.1 RC1 or later versions) to TiDB 3.0 or the master version. Currently, TiDB 3.0 and the master version are compatible with [TiDB Binlog of Cluster Version](/v3.0/reference/tidb-binlog/overview.md).
