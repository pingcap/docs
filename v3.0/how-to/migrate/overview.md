...
- [`mydumper`](/v3.0/reference/tools/mydumper.md) exports data from MySQL. It is recommended over using mysqldump.
- [`loader`](/v3.0/reference/tools/loader.md) imports data in mydumper format into TiDB.
- [`syncer`](/v3.0/reference/tools/syncer.md) acts like a MySQL replication slave and pushes data from MySQL into TiDB.
...
- [TiDB-Lightning](/v3.0/reference/tools/tidb-lightning/overview.md) imports data to TiDB in an optimized way. For example, a 1TiB backup could take 24+ hours to import with loader, while it will typically complete at least 3 times faster in TiDB-Lightning.
...
For detailed operations, follow the steps in [Migrate Data from MySQL to TiDB](/v3.0/how-to/migrate/from-mysql.md).
...
For detailed operations, follow the steps in [Incremental Migration](/v3.0/how-to/migrate/incrementally-from-mysql.md).
...
For more information, refer to [CSV support for TiDB-Lightning](/v3.0/reference/tools/tidb-lightning/csv.md).
