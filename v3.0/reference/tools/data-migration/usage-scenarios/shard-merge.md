...
- To satisfy the replication Requirement #6, configure the [binlog event filter rule](/reference/tools/data-migration/data-synchronization-features.md#binlog-event-filter) as follows:
