...
| `code=20010` |   Occurs when TiDB processes the task configuration and decrypts the database password.                   |  Check whether the downstream database password provided in the configuration task is [correctly encrypted using dmctl](/v3.0/how-to/deploy/data-migration-with-ansible.md#encrypt-the-upstream-mysql-user-password-using-dmctl). |
