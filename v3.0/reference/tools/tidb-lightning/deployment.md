...
As of v3.0, TiDB Lightning can be upgraded by replacing the binaries alone. No reconfiguration should be needed. See [the FAQ](/v3.0/faq/tidb-lightning.md#how-to-properly-restart-tidb-lightning) for the precise steps of restarting TiDB Lightning.
