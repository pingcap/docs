...
If you want to download the latest version of [TiDB Binlog](/v3.0/reference/tidb-binlog-overview.md) or [Lightning](/reference/tools/tidb-lightning/overview.md), directly download the TiDB package, because both TiDB-Binlog and Lightning are included in the TiDB package.
