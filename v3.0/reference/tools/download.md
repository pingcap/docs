...
If you want to download the latest version of [TiDB-Binlog](/v3.0/reference/tools/tidb-binlog/overview.md) or [Lightning](/dev/reference/tools/tidb-lightning/overview.md), directly download the TiDB package, because both TiDB-Binlog and Lightning are included in the TiDB package.
...
If you want to download the latest version of [Syncer](/v3.0/reference/tools/syncer.md), [Loader](/dev/reference/tools/loader.md), or [mydumper](/dev/reference/tools/mydumper.md), directly download the tidb-enterprise-tools package, because all these tools are included in this package.
