...
In v3.0.x and from v2.1.13 on, TiDB supports a new feature called [Split Region](/v3.0/reference/sql/statements/split-region.md). This new feature provides the following new syntaxes:
