...
category: how-to
aliases: ['/docs/v3.0/how-to/deploy/tidb-in-kubernetes/aws-eks/','/docs/v3.0/how-to/deploy/orchestrated/aws-eks/']
---
...
> **Note:**
>
>It's not recommended to include the following default configurations (default configurations of `tidb-cluster` module) in the customized `values.yaml`:
>
> ```
> pd:
