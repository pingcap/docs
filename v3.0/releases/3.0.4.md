...
- Server
    ...
    - Add the `tidb_txn_mode` system variable of global scope in TiDB and allow using pessimistic lock by default. Note that TiDB still adopts optimistic lock by default. [#12049](https://github.com/pingcap/tidb/pull/12049)
