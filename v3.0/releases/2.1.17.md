...
- Add the checking feature for component configuration files to check whether the configuration file is valid before deploying or upgrading TiDB Ansible [#935](https://github.com/pingcap/tidb-ansible/pull/935)
