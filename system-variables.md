...
- Scope: SESSION
- Default value: `OFF`. If you need to change this default value, you can modify the [`performance.enforce-mpp`](/tidb-configuration-file.md#enforce-mpp) configuration item.
