...
- This variable is disabled by default for clusters that upgrade from versions earlier than v7.0.0 to v7.0.0 or later versions.
...
> - This feature is introduced in v6.6.0 by the variable [`tidb_pessimistic_txn_aggressive_locking`](https://docs.pingcap.com/tidb/v6.6/system-variables#tidb_pessimistic_txn_aggressive_locking-new-in-v660), which is disabled by default.
