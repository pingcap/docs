...
- Default value: `OFF`
- Type: Boolean
- This variable controls whether to perform password complexity check. When this variable is set to `ON`, TiDB performs password complexity check on the account password.
