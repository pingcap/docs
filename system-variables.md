...
- This variable is used to control whether to enable the [TiCDC data integrity validation](https://docs.pingcap.com/tidb/stable/ticdc-integrity-check) feature.
