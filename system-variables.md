...
- Note that if `SHARD_ROW_ID_BITS` and `PRE_SPLIT_REGIONS` has been set when a table is created, the specified number of Regions are evenly split after the table creation.
