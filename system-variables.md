...
> - Starting from v8.3.0 to v8.5.4, for a newly deployed TiDB cluster, this variable is set to `PREDICATE` by default.
> - Starting from v8.5.5, for a newly deployed TiDB cluster, this variable is set to `ALL` by default.
