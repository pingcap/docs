...
> **Warning:**
>
> Prior to v5.3.1, there was a serious bug with this variable. Please use this variable in and after v5.3.1.
...
- Users with `SUPER` or `SYSTEM_VARIABLES_ADMIN` privileges can modify this variable. However, if the [security enhanced mode](#tidb_enable_enhanced_security) is enabled, the additional privilege `RESTRICTED_VARIABLES_ADMIN` is required to read or modify this variable.
