...
- Type: Integer
- Default value: `4`
- Range: `[0, 4294967295]`. In versions prior to v8.2.0, the minimum value is `1`. When you set it to `0`, it adapts the concurrency based on the cluster size.
...
- Type: Integer
- Default value: `1`
- Range: `[0, 4294967295]`. The maximum value for v7.5.0 and earlier versions is `256`. In versions prior to v8.2.0, the minimum value is `1`. When you set it to `0`, it adapts the concurrency based on the cluster size.
