...
category: reference
aliases: ['/docs/dev/reference/configuration/tidb-server/mysql-variables/']
---
...
| sql\_select\_limit | GLOBAL \| SESSION | The maximum number of rows to return from SELECT statements. The default value is 2^64 - 1. |
