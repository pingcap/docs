...
> **Warning:**
>
> This feature is still in the experimental stage. It is not recommended to enable this feature in production environments. When TiDB distribution framework is enabled, if you plan to upgrade TiDB from v7.1.x to v7.5.0 or higher, please ensure that there are no running `ADD INDEX` tasks before the upgrade.
