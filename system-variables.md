...
- Starting from v8.3.0, this variable also controls the number of concurrent threads during the [Delete Range](/garbage-collection-overview.md#delete-ranges) step of the GC process.
