...
- Starting from v7.1.0, the index acceleration operation supports checkpoints. Even if TiDB owner is restarted or changed due to failure, TiDB can recover progress from checkpoints that are automatically updated on a regular basis.
