...
- Range:
    ...
    - You can also set the value in memory size. The value range is `0` and `[536870912, 9223372036854775807]` in bytes. The memory format without spaces, with the units "KB|MB|GB|TB", is supported. For example, you can set this variable to `90GB`. `0` means no memory limit.
