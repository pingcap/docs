...
- Range: `[0, 1]`
- Default value: `0.8`
- This variable specifies the pseudo selectivity for the TiDB optimizer. In some cases where the optimizer cannot deduce the selectivity of a predicate from statistical information, this pseudo selectivity value is used. It is **NOT** recommended that you modify this value.
