...
- To see all records of this feature in the log, you need to set [`log.level`](/tidb-configuration-file.md#level) to `"info"` and then query the `"GENERAL_LOG"` string. The following information is recorded:
