...
> **Note:**
>
> This variable is not supported on [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless).
...
> **Note:**
>
> This variable is read-only for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless).
...
- Applies to hint [SET_VAR](/optimizer-hints.md#set_varvar_namevar_value): No
- Type: Boolean
- Default value: `OFF` for TiDB Self-Managed and `ON` for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless)
...
> **Note:**
>
> For [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless) clusters, this variable is read-only.
...
> **Note:**
>
> - This TiDB variable is not applicable to [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless).
...
- Type: Duration
- Default value: `10m0s`
- Range: `[10m0s, 8760h0m0s]` for TiDB Self-Managed and `[10m0s, 168h0m0s]` for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless)
...
- Default value: `2`
- Range: `[1, 2]`
- Controls the format version of the newly saved data in the table. In TiDB v4.0, the [new storage row format](https://github.com/pingcap/tidb/blob/release-8.1/docs/design/2018-07-19-row-format.md) version `2` is used by default to save new data.
...
> **Note:**
>
> This variable is always enabled for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless).
...
- Type: Integer
- Default value: `8`
- Range: `[0, 2147483647]` for TiDB Self-Managed and `[8, 2147483647]` for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless)
...
- Type: Integer
- Default value: `1`
- Range: `[0, 2147483647]` for TiDB Self-Managed and `[1, 2147483647]` for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless)
...
- Type: Enumeration
- Default value: `1`
- Value options: `0`, `1`, and `2` for TiDB Self-Managed; `1` and `2` for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless)
...
- Type: Integer
- Default value: `1`
- Range: `[0, 2147483647]` for TiDB Self-Managed, `[1, 2147483647]` for [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-serverless)
