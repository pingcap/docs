...
- Scope: NONE
- Default value: OFF
- This variable indicates whether the TiDB server you are connected to has the Security Enhanced Mode (SEM) enabled. To change its value, you need to restart the TiDB server for your change to be effective.
