...
- The following statements and features use this variable:
    - [`PLAN REPLAYER DUMP`](/sql-plan-replayer.md#use-plan-replayer-to-export-cluster-information)
    - [`PLAN REPLAYER CAPTURE`](/sql-plan-replayer.md#use-plan-replayer-capture-to-capture-target-plans)
    - [`PLAN REPLAYER CONTINUOUS CAPTURE`](/sql-plan-replayer.md#use-plan-replayer-continuous-capture)
