...
- Range: `[0, 1]`
- Default value: `0.8`
- Indicates the pseudo selectivity for TiDB optimizer. In some cases, the optimizer cannot intuitively deduce the selectivity of the predicate through statistical information. In this case, this pseudo selectivity value is used. It is **NOT** recommended to modify its value.
