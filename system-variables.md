...
- この変数と [`pd_enable_follower_handle_region`](#pd_enable_follower_handle_region-new-in-v760) は、相補的な方向からパフォーマンスを最適化します。前者はバッチ化によって PD に送信するリクエスト数を削減し、後者は PD followers が Region クエリリクエストを処理できるようにすることで PD leader の負荷を軽減します。両方の変数を同時に有効にできます。
