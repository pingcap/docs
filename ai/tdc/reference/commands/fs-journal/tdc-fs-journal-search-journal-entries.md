...
- Search by entry type:
    ...
    tdc fs-journal search-journal-entries --file-system-id <file-system-id> --entry-type task.started --include-entries
    ```
...
- Search by label and time:
    ...
    tdc fs-journal search-journal-entries --file-system-id <file-system-id> --label env=dev --since 2026-07-01T00:00:00Z --limit 100
    ```
...
- Search by actor and subject:
    ...
    tdc fs-journal search-journal-entries --file-system-id <file-system-id> --actor agent:tdc --subject issue-42 --include-entries
    ```
