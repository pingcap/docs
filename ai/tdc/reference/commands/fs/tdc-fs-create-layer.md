...
### Preview a restore-safe layer

```bash
tdc fs create-layer --file-system-name workspace --base-root-path /workspace --durability-mode restore-safe --tag task=review --dry-run
```
