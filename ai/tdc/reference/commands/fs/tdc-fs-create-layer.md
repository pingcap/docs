...
- Create a layer:
    ...
    tdc fs create-layer --file-system-id <file-system-id> --base-root-path /workspace --layer-name agent-task
    ```
...
- Create a restore-safe tagged layer:
    ...
    tdc fs create-layer --file-system-id <file-system-id> --base-root-path /workspace --durability-mode restore-safe --tag task=review
    ```
