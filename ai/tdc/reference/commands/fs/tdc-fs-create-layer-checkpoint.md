...
- Create a named checkpoint:
    ...
    tdc fs create-layer-checkpoint --file-system-id <file-system-id> --layer-id "<layer-id>" --checkpoint-id before-review
    ```
...
- Create an automatically identified checkpoint:
    ...
    tdc fs create-layer-checkpoint --file-system-id <file-system-id> --layer-id "<layer-id>" --label "before review"
    ```
