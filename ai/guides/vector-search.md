...
> **Note:**
>
> For a complete example of vector search, see [Vector Search Example](/ai/guides/vector-search-with-pytidb.md).
...
> **Note:**
>
> In real-world applications, embeddings are usually generated by an [embedding model](/ai/guides/vector-search-overview.md#embedding-model).
