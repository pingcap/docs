...
| [Vector Search](/ai/guides/vector-search.md) | 使用 `pytidb` 执行语义相似度搜索。 |
...
| [Image Search](/ai/guides/image-search.md) | 利用多模态嵌入进行图片搜索。 |
...
| [Conversational Memory](/ai/examples/memory-with-pytidb.md) | 为 AI 智能体和聊天机器人提供持久化内存。 |
| [Text-to-SQL](/ai/examples/text2sql-with-pytidb.md) | 将自然语言转换为 SQL 查询。 |

## 集成

将 TiDB 集成到主流 AI 框架、嵌入提供商和开发工具中。
...
| [MCP Server](/ai/integrations/tidb-mcp-server.md) | 连接 TiDB 到 Claude Code、Cursor 及其他 AI 驱动的 IDE。 |
