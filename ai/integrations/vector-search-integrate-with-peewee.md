...
このチュートリアルでは、 [ピーウィー](https://docs.peewee-orm.com/)使用して[TiDBベクトル検索](/ai/concepts/vector-search-overview.md)と対話し、埋め込みを保存し、ベクトル検索クエリを実行する方法について説明します。
...
以下の手順に従って、TiDB Vector Search を peewee と統合する方法を簡単に習得できます。
