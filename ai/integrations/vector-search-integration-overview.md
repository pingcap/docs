...
TiDB provides official support for the following AI framework, enabling you to easily integrate AI applications developed with these frameworks into TiDB Vector Search.
