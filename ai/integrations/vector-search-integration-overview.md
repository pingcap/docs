...
| AIフレームワーク | チュートリアル                                                                               |
| --------- | ------------------------------------------------------------------------------------- |
| LangChain    | [LangChainとベクトル検索を統合する](/ai/integrations/vector-search-integrate-with-langchain.md)   |
| LlamaIndex  | [LlamaIndexとベクトル検索を統合する](/ai/integrations/vector-search-integrate-with-llamaindex.md) |
...
| -------------- | ------------------------------------------------------------------------------------------------------- |
| Jina AI          | [Jina AI Embeddings APIとベクトル検索を統合する](/ai/integrations/vector-search-integrate-with-jinaai-embedding.md) |
...
| ---- | --------------- | --------------------------------- | ----------------------------------------------------------------------------------------- |
| Python | TiDB ベクトルクライアント | `pip install tidb-vector[client]` | [Pythonを使ったベクトル検索を始めよう](/ai/quickstart-via-python.md)                                     |
