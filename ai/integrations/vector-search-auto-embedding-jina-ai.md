...
このドキュメントでは、TiDB Cloudで[Jina AI埋め込みモデル](https://jina.ai/embeddings/)を[自動埋め込み](/ai/integrations/vector-search-auto-embedding-overview.md)と組み合わせて使用して、テキストクエリによるセマンティック検索を実行する方法について説明します。
