...
-   TiDB Vector Search (ベータ版) が、すべてのリージョンのすべてのユーザー向けにTiDB Cloud Starter クラスターで利用できるようになりました。

## 2024年4月1日 {#april-1-2024}

-   TiDB Vector Search (ベータ版) が、招待されたユーザー向けに EU リージョンのTiDB Cloud Starter クラスターで利用できるようになりました。
