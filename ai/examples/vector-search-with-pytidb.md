...
このアプリケーションは、ローカル エンベディング生成に[Ollama](https://ollama.com/download)、Web UI に[ストリームリット](https://streamlit.io/)、および RAG パイプラインを構築するために[`pytidb`](https://github.com/pingcap/pytidb) (TiDB 用の公式 Python SDK) を使用します。
