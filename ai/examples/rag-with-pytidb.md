...
このアプリケーションは、ローカル埋め込み生成に[Ollama](https://ollama.com/download)、Web UI に[Streamlit](https://streamlit.io/)リット、RAG パイプラインの構築に`pytidb`を使用します。
...
-   **ソースコード**： [GitHubで見る](https://github.com/pingcap/pytidb/tree/main/examples/rag)
