...
[TiDB Cloud CLI (`ti`)](https://github.com/tidbcloud/ti-cli) is a CLI for managing [TiDB Cloud Starter](/tidb-cloud/select-cluster-tierr) instances and [TiDB Cloud Filesystems](#tidb-cloud-filesystem). It is designed for both interactive use and automation, with structured JSON output by default.
