...
- Replace a secret from a directory:
    ...
    ti fs-vault replace-secret --file-system-name workspace --secret-path /n/vault/db-prod --from-directory ./secret-fields
    ```
...
- Preview secret replacement:
    ...
    ti fs-vault replace-secret --file-system-name workspace --secret-path /n/vault/db-prod --from-directory ./secret-fields --dry-run
    ```
