...
- Read journal entries:
    ...
    ti fs-journal read-journal-entries --file-system-name workspace --journal-id jrn-demo
    ```
...
- Continue after a sequence number:
    ...
    ti fs-journal read-journal-entries --file-system-name workspace --journal-id jrn-demo --after-seq 100 --limit 50
    ```
