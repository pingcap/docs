...
- Search base Filesystem content:
    ...
    ti fs search-file-content --file-system-name workspace --path /workspace --pattern "TODO" --limit 50
    ```
...
- Search content in a layer:
    ...
    ti fs search-file-content --file-system-name workspace --path /workspace --pattern "deprecated" --layer-id "<layer-id>"
    ```
