...
Use `ti db` to manage TiDB Cloud Starter instances, branches, and SQL access. The CLI rejects instance-scoped operations when the target is not a Starter instance or its service plan cannot be verified.

## Commands

| Command | Description |
|---|---|
| [`create-db-cluster`](/ai/ti/reference/commands/db/ti-db-create-db-cluster.md) | Creates a Starter instance. |
| [`list-db-clusters`](/ai/ti/reference/commands/db/ti-db-list-db-clusters.md) | Lists Starter instances in the effective region. |
| [`describe-db-cluster`](/ai/ti/reference/commands/db/ti-db-describe-db-cluster.md) | Describes a Starter instance. |
| [`update-db-cluster`](/ai/ti/reference/commands/db/ti-db-update-db-cluster.md) | Updates a Starter instance. |
| [`delete-db-cluster`](/ai/ti/reference/commands/db/ti-db-delete-db-cluster.md) | Deletes a Starter instance. |
