...
> ```
>
> For a Vault mount, use `ti fs-vault unmount-vault --mount-path <mount-path>`. For details, see [Mount a File System](/tidb-cloud-filesystem/filesystem-mount.md) and [Manage File System Vault Secrets](/tidb-cloud-filesystem/manage-filesystem-vault-secrets.md).
...
For details, see [Mount a File System](/tidb-cloud-filesystem/filesystem-mount.md) and [Manage File System Vault Secrets](/tidb-cloud-filesystem/manage-filesystem-vault-secrets.md).
