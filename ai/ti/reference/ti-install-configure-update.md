...
> ```
>
> For a Vault mount, use `ti fs-vault unmount-vault --mount-path <mount-path>`. For details, see [Mount a TiDB Cloud Filesystem](/tidb-cloud-filesystem/mount-filesystem.md) and [Manage Filesystem Vault Secrets](/tidb-cloud-filesystem/manage-filesystem-vault-secrets.md).
...
For details, see [Mount a TiDB Cloud Filesystem](/tidb-cloud-filesystem/mount-filesystem.md) and [Manage Filesystem Vault Secrets](/tidb-cloud-filesystem/manage-filesystem-vault-secrets.md).
