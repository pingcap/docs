...
summary: Create a layer in a file system.
---

# ti fs create-layer

Creates a layer for recording isolated changes over a file system base path. If `--layer-id` is omitted, the service generates one.
