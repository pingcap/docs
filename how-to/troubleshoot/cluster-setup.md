...
First, check the [slow query log](/how-to/maintain/identify-abnormal-queries/identify-slow-queries.md) and see if it is because of some inappropriate SQL statement.
