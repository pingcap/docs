...
This document is targeted for users who want to upgrade from TiDB 2.0, 2.1, or 3.0 to TiDB 3.1. TiDB 3.1 is compatible with [TiDB Binlog of the cluster Version](/reference/tidb-binlog/overview.md).
...
3. Download the tidb-ansible with the tag corresponding to TiDB 3.1. For more details, See [Download TiDB Ansible to the Control Machine](/how-to/deploy/orchestrated/ansible.md#step-3-download-tidb-ansible-to-the-control-machine). The default folder name is `tidb-ansible`.
