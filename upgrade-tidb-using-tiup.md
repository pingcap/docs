...
> **Warning:**
>
> - You cannot upgrade TiFlash online from versions earlier than v5.3 to v5.3 or later. Instead, you must first stop all the TiFlash instances of the early version, and then upgrade the cluster by following the upgrade process of the target version. For details, see warnings in [Online upgrade](#online-upgrade).
