...
> - If your cluster to be upgraded is earlier than v6.2, you might encounter the issue that the upgrade gets stuck when upgrading to v6.2 or later versions. You can refer to [How to fix the issue](#how-to-fix-the-issue-that-the-upgrade-gets-stuck-when-upgrading-to-v620-or-later-versions).
...
- Stuck caused by plugin loading
...
- Stuck caused by using the `kill -9` command for offline upgrade
...
- Stuck caused by DDL Owner change
