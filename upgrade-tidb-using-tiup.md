...
Review [the compatibility changes](/releases/release-6.6.0.md#compatibility-changes) and [deprecated features](/releases/release-6.6.0.md#deprecated-feature) in TiDB v6.6.0 release notes. If any changes affect your upgrade, take actions accordingly.
