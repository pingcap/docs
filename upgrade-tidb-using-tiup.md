...
> **Note:**
>
> + Currently, TiUP only supports the supervision method of process `systemd`. If you previously selected `supervise` when deploying with TiDB Ansible, you need to click [Deploy TiDB Cluster with TiDB Ansible](/online-deployment-using-ansible.md#how-to-modify-the-supervision-method-of-a-process-from-supervise-to-systemd) to `systemd`.
