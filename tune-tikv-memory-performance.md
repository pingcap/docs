...
[coprocessor]
## If the size of a Region with the range of [a,e) is larger than the value of `region_max_size`, TiKV trys to split the Region to several Regions, for example, with the ranges of [a,b), [b,c), [c,d), and [d,e).
