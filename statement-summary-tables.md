...
From the result above, you can see that a maximum of 59 SQL categories are evicted. In this case, it is recommended that you increase the size of the `statement_summary` table by 59 records, which means increasing the size to at least 3059 records.
