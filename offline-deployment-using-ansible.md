...
category: how-to
aliases: ['/docs/v2.1/offline-deployment-using-ansible/','/docs/v2.1/how-to/deploy/orchestrated/offline-ansible/']
---
...
3. See [Deploy the TiDB cluster](/online-deployment-using-ansible.md#step-11-deploy-the-tidb-cluster).
