...
In the command above, `nightly` is the version number of the cluster. Similarly, you can replace `nightly` with `v5.1.4`, and the command is `tiup playground v5.1.4`.
