...
summary: TiUPを使用して、クラスターをデプロイする前に、トポロジーファイルを準備する必要があります。 `tiup dm template`コマンドを使用して、組み込みテンプレートのコンテンツを出力できます。オプションを指定することで、詳細なトポロジテンプレートを出力することも可能です。必要に応じて、展開用のトポロジファイルにリダイレクトできます。
---
