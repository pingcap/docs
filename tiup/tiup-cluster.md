...
TiUP cluster opens the configuration file in the vi editor. If you want to use other editors, use the `EDITOR` environment variable to to customize the editor, such as `export EDITOR=nano`.
