...
summary: TiUP DMのimportコマンドは、DM v1.0クラスターをv2.0以降にアップグレードするために使用されます。このコマンドは、v2.0.0-rc.2以降のバージョンにのみ対応しています。また、クラスターをインポートする前にTiUP DMコンポーネントを最新バージョンにアップグレードする必要があります。インポートされたクラスターには、DMマスターノードが1つだけ存在します。
---
