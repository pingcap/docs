...
- ローカル クラスターの単純なトポロジテンプレートを出力します。これは直接使用でき、 `global`パラメータは必要に応じて調整できます。
...
- このオプションを指定しない場合は、デフォルトで単一のデータセンターのトポロジテンプレートが出力されます。
...
指定されたオプションに従ってトポロジテンプレートを出力します。これは、デプロイメントのためにトポロジファイルにリダイレクトできます。
