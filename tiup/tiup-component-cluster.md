---
title: TiUP Cluster
summary: TiUPクラスタは、Golangで書かれたTiUPのクラスター管理コンポーネントです。展開、起動、シャットダウン、破棄、エラスティックスケーリング、TiDBクラスターのアップグレード、パラメーターの管理などの操作とメンテナンスを実行できます。コマンドリストには、輸入、テンプレート、チェック、展開する、リスト、画面、始める、停止、再起動、スケールイン、規格外、アップグレード、プルーン、編集構成、リロード、パッチ、名前を変更する、クリーン、破壊する、監査、リプレイ、有効にする、無効にする、メタバックアップ、メタ復元、ヘルプが含まれています。
---
