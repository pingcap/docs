...
- Determines whether to clone a specific version of a package
    ...
    - Execute the `tiup mirror clone <target-dir> --tidb v5.1.2` command to clone the v5.1.2 version of the TiDB component.
    - Execute the `tiup mirror clone <target-dir> --tidb v5.1.2 --tikv all` command to clone the v5.1.2 version of the TiDB component and all versions of the TiKV component.
    - Execute the `tiup mirror clone <target-dir> v5.1.2` command to clone the v5.1.2 version of all components in a cluster.
