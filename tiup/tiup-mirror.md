...
-   パッケージの特定のバージョンのクローンを作成するかどうかを決定します
    ...
    -   `tiup mirror clone <target-dir> --tidb v7.1.3`コマンドを実行して、TiDBコンポーネントの v7.1.3 バージョンのクローンを作成します。
    -   `tiup mirror clone <target-dir> --tidb v7.1.3 --tikv all`コマンドを実行して、v7.1.3 バージョンの TiDBコンポーネントとすべてのバージョンの TiKVコンポーネントのクローンを作成します。
    -   `tiup mirror clone <target-dir> v7.1.3`コマンドを実行して、クラスター内のすべてのコンポーネントの v7.1.3 バージョンのクローンを作成します。
