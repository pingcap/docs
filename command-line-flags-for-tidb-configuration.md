...
- Bootstraps tidb-server in secure mode. This option creates a `root` account using the `auth_socket` authentication method. To connect for the first time, you must use a socket connection.
- Default: `false`
