...
A planned switchover is a scheduled switch between the primary and secondary Regions based on the maintenance needs. It can be used to verify whether the DR system works properly. This section describes how to perform a planned switchover.
