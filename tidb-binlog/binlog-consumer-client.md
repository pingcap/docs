...
aliases: ['/tidb/stable/binlog-slave-client','/tidb/v4.0/binlog-slave-client','/docs/stable/tidb-binlog/binlog-slave-client/','/docs/v4.0/tidb-binlog/binlog-slave-client/','/docs/stable/reference/tidb-binlog/binlog-slave-client/','/docs/stable/reference/tools/tidb-binlog/binlog-slave-client/']
---
