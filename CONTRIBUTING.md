...
-   変更のほとんどが複数のドキュメント バージョンに適用され、バージョン間にいくつかの違いがある場合でも、cherry-pick ラベルを使用して、ti-chi-bot が他のバージョンへの PR を作成できるようにすることができます。別のバージョンへの PR が ti-chi-bot によって正常に送信された後、その PR を変更できます。
