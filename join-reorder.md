...
- The Join Reorder algorithm's support for Outer Join is controlled by the [`tidb_enable_outer_join_reorder`](/system-variables.md#tidb_enable_outer_join_reorder-new-in-v610) system variable. Currently, the dynamic programming algorithm cannot perform Join Reorder for outer join.
