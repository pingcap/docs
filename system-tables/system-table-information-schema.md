...
aliases: ['/docs/v2.1/system-tables/system-table-information-schema/','/docs/v2.1/reference/system-databases/information-schema/']
---
...
The `CHARACTER_SETS` table provides information about [character sets](/character-set-and-collation.md). The default character set in TiDB is `utf8mb4`. Additional character sets in this table are included for compatibility with MySQL:
