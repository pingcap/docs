...
summary: Fuse Engine is {{{ .lake }}}'s core storage engine, optimized for managing petabyte-scale data efficiently on cloud object storage. By default, tables created in {{{ .lake }}} automatically use this engine (ENGINE=FUSE). Inspired by Git, its snapshot-based design enables powerful data versioning (like Time Travel) and provides high query performance through advanced pruning and indexing.
---
...
Fuse Engine is {{{ .lake }}}'s core storage engine, optimized for managing **petabyte-scale** data efficiently on **cloud object storage**. By default, tables created in {{{ .lake }}} automatically use this engine (`ENGINE=FUSE`). Inspired by Git, its snapshot-based design enables powerful data versioning (like Time Travel) and provides **high query performance** through advanced pruning and indexing.
...
## Comparison: {{{ .lake }}} Fuse Engine vs. Apache Iceberg

_**Note:** This comparison focuses specifically on **table format features**. As {{{ .lake }}}'s native table format, Fuse evolves, aiming to improve **usability and performance**. Features shown are current; expect changes._

| Feature                 | Apache Iceberg                     | {{{ .lake }}} Fuse Engine                 |
| :---------------------- | :--------------------------------- | :----------------------------------- |
