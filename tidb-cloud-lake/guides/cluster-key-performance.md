---
title: Cluster Key
summary: Cluster keys provide automatic data organization to dramatically improve query performance on large tables. {{{ .lake }}} seamlessly and continually manages all clustering operations in the background - you simply define the cluster key and {{{ .lake }}} handles the rest.
---

# Cluster Key

Cluster keys provide automatic data organization to dramatically improve query performance on large tables. {{{ .lake }}} seamlessly and continually manages all clustering operations in the background - you simply define the cluster key and {{{ .lake }}} handles the rest.
...
**How it Works**: After you define a cluster key, {{{ .lake }}} automatically:
...
All you need to do is define a clustering key for each table (if appropriate) and {{{ .lake }}} manages all future maintenance automatically.
