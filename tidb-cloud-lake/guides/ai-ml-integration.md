...
summary: "{{{ .lake }}} enables powerful AI and ML capabilities through two complementary approaches build custom AI functions with your own infrastructure, or create conversational data experiences using natural language."
---

# AI & ML Integration

{{{ .lake }}} enables powerful AI and ML capabilities through two complementary approaches: build custom AI functions with your own infrastructure, or create conversational data experiences using natural language.
...
The Model Context Protocol (MCP) server enables AI assistants to interact with your {{{ .lake }}} database using natural language, perfect for building conversational BI tools.
