...
1. **Data Ingestion** → {{{ .lake-short }}} analyzes JSON structure in VARIANT columns
...
*Virtual columns work automatically in the background—{{{ .lake-short }}} optimizes your JSON queries with zero configuration.*
