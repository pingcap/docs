...
1. **Data Ingestion** → {{{ .lake }}} analyzes JSON structure in VARIANT columns
...
*Virtual columns work automatically in the background—{{{ .lake }}} optimizes your JSON queries with zero configuration.*
