...
- `DISABLED` allows you to enable or disable a user. Disabled users cannot log in to {{{ .lake }}} until they are enabled. See the [syntax](/tidb-cloud-lake/sql/create-user.md#syntax).
