...
summary: This section provides reference information for the interval functions in {{{ .lake-short }}}. Interval functions allow you to create interval values of various time units for use in date and time calculations.
---

# Interval Functions

This section provides reference information for the interval functions in {{{ .lake-short }}}. Interval functions allow you to create interval values of various time units for use in date and time calculations.
