...
summary: 使用正则表达式模式切分字符串，并将各个片段作为数组返回。
---
...
- [SPLIT](/tidb-cloud-lake/sql/split.md)：用于简单的字符串切分
- [REGEXP_SPLIT_TO_TABLE](/tidb-cloud-lake/sql/regexp-split-table.md)：将字符串切分为表