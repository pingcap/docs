...
|   Default  |   Settings with this level are service defaults for individual query instances. Changes at this level only affect the query instance where the default is applied.  |
