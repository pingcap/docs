...
|----------|-------------|
| [ASSUME_NOT_NULL](/tidb-cloud-lake/sql/assume-not-null.md) | Hint that values in a nullable column are never NULL |
| [EXISTS](/tidb-cloud-lake/sql/exists.md) | Return TRUE if a subquery produces any rows |
