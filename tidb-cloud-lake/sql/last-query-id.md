...
> **Note:**
>
> This function is currently supported only through the MySQL protocol, meaning you must connect to {{{ .lake }}} using a MySQL protocol-compatible client for it to work.
