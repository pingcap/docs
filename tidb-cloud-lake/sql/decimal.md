...
If an operation would overflow the integer part, {{{ .lake }}} raises an error; extra fractional digits are truncated rather than rounded. Adjust `P`/`S` or cast the result to control both behaviors.
