...
| ACCESS_KEY_ID               | Your access key ID for connecting the AWS S3 compatible object storage. If not provided, {{{ .lake-short }}} will access the bucket anonymously.                                                                                    | Optional   |
