---
title: Geospatial
summary: "{{{ .lake }}} stores spatial data through two data types."
---

# Geospatial

{{{ .lake }}} stores spatial data through two data types:
...
{{{ .lake }}} persists spatial values as EWKB but exposes several output formats. Set the `geometry_output_format` session setting (default: `WKT`) or call explicit conversion functions:
