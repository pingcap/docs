---
title: User & Role
summary: This page provides a comprehensive overview of user and role operations in {{{ .lake }}}, organized by functionality for easy reference.
---

# User & Role

This page provides a comprehensive overview of user and role operations in {{{ .lake }}}, organized by functionality for easy reference.
