...
- OWNERSHIP provides full control over the masking policy; {{{ .lake }}} automatically grants OWNERSHIP on a new policy to the creator role and revokes it when the policy is dropped.
