---
title: AS_ARRAY
summary: Strict casting VARIANT values to ARRAY data type. If the input data type is not VARIANT, the output is NULL. If the type of value in the VARIANT does not match the output value, the output is NULL.
---
