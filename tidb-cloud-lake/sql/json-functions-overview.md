...
summary: This section provides reference information for JSON functions in {{{ .lake-short }}}. JSON functions enable parsing, validation, querying, and manipulation of JSON data structures.
---

# JSON Functions

This section provides reference information for JSON functions in {{{ .lake-short }}}. JSON functions enable parsing, validation, querying, and manipulation of JSON data structures.
