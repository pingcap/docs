---
title: SHOW USERS
summary: Lists all SQL users in the system. If you're using {{{ .lake }}}, this command also shows the user accounts (email addresses) within your organization that are used to log in to {{{ .lake }}}.
---
...
Lists all SQL users in the system. If you're using {{{ .lake }}}, this command also shows the user accounts (email addresses) within your organization that are used to log in to {{{ .lake }}}.
