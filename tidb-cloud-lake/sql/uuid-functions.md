...
summary: This page provides reference information for the UUID-related functions in {{{ .lake }}}. These functions generate and work with Universally Unique Identifiers (UUIDs).
---

# UUID Functions

This page provides reference information for the UUID-related functions in {{{ .lake }}}. These functions generate and work with Universally Unique Identifiers (UUIDs).
...
{{{ .lake }}}'s UUID implementation has evolved:
