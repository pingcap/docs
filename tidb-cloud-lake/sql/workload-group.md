...
summary: Workload groups enable resource management and query concurrency control in {{{ .lake }}} by allocating CPU, memory quotas and limiting concurrent queries for different user groups.
---

# Workload Group

Workload groups enable resource management and query concurrency control in {{{ .lake }}} by allocating CPU, memory quotas and limiting concurrent queries for different user groups.
