...
Functions such as [TO_DATE](/tidb-cloud-lake/sql/date.md) and [TO_TIMESTAMP](/tidb-cloud-lake/sql/timestamp.md) accept explicit format strings. Control how they parse or render values by adjusting `date_format_style` and `week_start`.
