...
summary: This section provides reference information for type predicate functions in {{{ .lake }}}. These functions enable type checking, validation, and conversion of JSON values.
---

# Type Predicate Functions

This section provides reference information for type predicate functions in {{{ .lake }}}. These functions enable type checking, validation, and conversion of JSON values.
