---
title: Stage
summary: This page provides a comprehensive overview of stage operations in {{{ .lake }}}, organized by functionality for easy reference.
---

# Stage

This page provides a comprehensive overview of stage operations in {{{ .lake }}}, organized by functionality for easy reference.
...
> **Note:**
>
> Stages in {{{ .lake }}} are used as temporary storage locations for data files that you want to load into tables or unload from tables.
