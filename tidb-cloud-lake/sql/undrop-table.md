---
title: UNDROP TABLE
summary: Restores the recent version of a dropped table. This leverages the {{{ .lake }}} Time Travel feature; a dropped object can be restored only within a retention period (defaults to 24 hours).
---

# UNDROP TABLE

Restores the recent version of a dropped table. This leverages the {{{ .lake }}} Time Travel feature; a dropped object can be restored only within a retention period (defaults to 24 hours).
