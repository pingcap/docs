---
title: FUSE_SEGMENT
summary: Returns the segment information of a specified table snapshot. For more information about what is segment in {{{ .lake }}}, see What are Snapshot, Segment, and Block?.
---

# FUSE_SEGMENT

Returns the segment information of a specified table snapshot. For more information about what is segment in {{{ .lake }}}, see [What are Snapshot, Segment, and Block?](/tidb-cloud-lake/sql/optimize-table.md#-lake--data-storage-snapshot-segment-and-block).
