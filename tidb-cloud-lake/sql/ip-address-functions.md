...
summary: This page provides reference information for the IP address-related functions in {{{ .lake }}}. These functions help convert between string and numeric representations of IP addresses.
---

# IP Address Functions

This page provides reference information for the IP address-related functions in {{{ .lake }}}. These functions help convert between string and numeric representations of IP addresses.
