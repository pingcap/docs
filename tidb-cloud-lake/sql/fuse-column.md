---
title: FUSE_COLUMN
summary: Returns the column information of the latest or specified snapshot of a table. For more information about what is block in {{{ .lake }}}, see What are Snapshot, Segment, and Block?.
---

# FUSE_COLUMN

Returns the column information of the latest or specified snapshot of a table. For more information about what is block in {{{ .lake }}}, see [What are Snapshot, Segment, and Block?](/tidb-cloud-lake/sql/optimize-table.md#-lake--data-storage-snapshot-segment-and-block).
