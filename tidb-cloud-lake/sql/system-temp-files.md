...
summary: Contains information about temporary files created by {{{ .lake }}}, such as spill files. To remove the temporary files, use the VACUUM TEMPORARY FILES command.
---
