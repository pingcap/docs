---
title: JOIN
summary: Joins combine columns from two or more tables into one result set. {{{ .lake }}} implements both ANSI SQL joins and Databend-specific extensions, allowing you to work with dimensional data, slowly changing facts, and time-series streams using the same syntax.
---
...
Joins combine columns from two or more tables into one result set. {{{ .lake }}} implements both ANSI SQL joins and Databend-specific extensions, allowing you to work with dimensional data, slowly changing facts, and time-series streams using the same syntax.
