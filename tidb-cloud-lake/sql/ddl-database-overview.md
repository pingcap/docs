---
title: Database
summary: This page provides a comprehensive overview of database operations in {{{ .lake }}}, organized by functionality for easy reference.
---

# Database

This page provides a comprehensive overview of database operations in {{{ .lake }}}, organized by functionality for easy reference.
...
| [ALTER DATABASE](/tidb-cloud-lake/sql/rename-database.md) | Modifies a database |
...
> **Note:**
>
> Database operations are foundational for organizing your data in {{{ .lake }}}. Make sure you have appropriate privileges before executing these commands.
