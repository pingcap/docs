...
summary: Displays detailed information about a specific password policy in {{{ .lake }}}. For detailed descriptions of the password policy attributes, see Password Policy Attributes.
---
