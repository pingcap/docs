...
summary: 显示 {{{ .lake }}} 中特定密码策略的详细信息。有关密码策略属性的详细说明，请参见 Password Policy Attributes。
---

# DESC PASSWORD POLICY

显示 {{{ .lake }}} 中特定密码策略的详细信息。有关密码策略属性的详细说明，请参见 [密码策略属性](/tidb-cloud-lake/sql/create-password-policy.md#password-policy-attributes)。
