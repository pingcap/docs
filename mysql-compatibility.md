...
For differences on pessimistic transaction (lock) with MySQL InnoDB, see [Differences from MySQL InnoDB](/pessimistic-transaction.md#difference-from-mysql-innodb).
