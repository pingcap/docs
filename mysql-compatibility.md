...
-   側方派生テーブル（TiDB は [the `LATERAL` derived table syntax](/lateral-derived-tables.md) の構文解析をサポートしていますが、この構文を使用するクエリの実行はサポートしていません） [#40328](https://github.com/pingcap/tidb/issues/40328)
