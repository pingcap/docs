...
* It is not supported to modify multiple TiDB-specific schema objects using a single `ALTER TABLE` statement, including `TIFLASH REPLICA`, `SHARD_ROW_ID_BITS`, and `AUTO_ID_CACHE`.
