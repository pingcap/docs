...
+ Lateral derived tables (TiDB supports parsing [the `LATERAL` derived table syntax](/lateral-derived-tables.md) but does not support executing it) [#40328](https://github.com/pingcap/tidb/issues/40328)
