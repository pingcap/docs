...
From the [bikeshare example database](/tidb-cloud/import-sample-data-serverless.md), you can see that the following two queries are executed in a similar manner:
