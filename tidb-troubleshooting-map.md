...
- 7.1.2 `txn takes too much time`.
    ...
    If your application requires long-running transactions, you can increase [`tidb_gc_life_time`](/system-variables.md#tidb_gc_life_time-new-in-v50) to avoid this error. Before changing this setting, check whether your application truly needs such long transactions.
