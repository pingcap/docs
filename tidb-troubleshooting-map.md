...
- 6.2.2 Import speed is too slow.
    ...
    - The version of TiDB Lightning is old. A newer version might improve the import speed. When upgrading, it is recommended to keep TiDB Lightning and the target TiDB cluster at the same version.
