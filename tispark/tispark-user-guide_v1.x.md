...
+ Hardware configuration
    - For general purposes, please refer to the TiDB and TiKV hardware configuration [recommendations](/how-to/deploy/hardware-recommendations.md#development-and-test-environments).
