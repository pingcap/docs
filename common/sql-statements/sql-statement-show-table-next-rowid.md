...
* [`SEQUENCE`](/common/sql-statements/sql-statement-create-sequence.md) created by users.
...
* [CREATE_SEQUENCE](/common/sql-statements/sql-statement-create-sequence.md)
