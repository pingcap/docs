...
This statement shows various statistics about tables in TiDB. If the statistics appear out of date, it is recommended to run [`ANALYZE TABLE`](/common/sql-statements/sql-statement-analyze-table.md).
...
* [SHOW TABLES](/common/sql-statements/sql-statement-show-tables.md)
