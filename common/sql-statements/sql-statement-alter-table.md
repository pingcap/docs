...
* [`ADD`](/common/sql-statements/sql-statement-add-index.md), [`DROP`](/common/sql-statements/sql-statement-drop-index.md), or [`RENAME`](/common/sql-statements/sql-statement-rename-index.md) indexes
* [`ADD`](/common/sql-statements/sql-statement-add-column.md), [`DROP`](/common/sql-statements/sql-statement-drop-column.md), [`MODIFY`](/common/sql-statements/sql-statement-modify-column.md) or [`CHANGE`](/common/sql-statements/sql-statement-change-column.md) columns
...
The statement [`ALTER TABLE .. ADD INDEX`](/common/sql-statements/sql-statement-add-index.md) can be used to add an index on the table t1. `EXPLAIN` confirms that the original query now uses an index range scan, which is more efficient:
...
* Changes of the [Reorg-Data](/common/sql-statements/sql-statement-modify-column.md#reorg-data-change) types on primary key columns are not supported.
