...
次の組み込み関数と演算子は、 [ベクトルデータ型](/vector-search-data-types.md)の演算をサポートするために拡張されています。
...
ベクトルの比較方法の詳細については、 [ベクトル データ型 | 比較](/vector-search-data-types.md#comparison)参照してください。
