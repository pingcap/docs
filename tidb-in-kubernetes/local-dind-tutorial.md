...
Once the k8s cluster is up and running, we can add helm repo and install TiDB Operator into it using `helm`:
...
Wait a few minutes for all TiDB components to get created and ready:
...
1. Get the values.yaml of current tidb-cluster chart:
