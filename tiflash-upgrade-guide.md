...
## From v6.x or v7.x to v7.3 or above
...
Starting from v7.4, DTFile version V3 is officially GA and becomes the default version of TiFlash DTFile.

After TiFlash is upgraded to v7.3 and using the V3 version of DTFile or upgraded to v7.4, if you need to revert TiFlash to an earlier version, you can use the DTTool offline to rewrite V3 DTFiles back to V2 DTFiles. For more information, see [DTTool Migration Tool](/tiflash/tiflash-command-line-flags.md#dttool-migrate).