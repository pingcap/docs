...
1. Create the `tidb-lightning.toml` configuration file:
    ...
    # "tidb": The "tidb" backend is recommended to import data less than 1 TiB. During the import, the target TiDB cluster can provide service normally. For more information on the backends, refer to https://docs.pingcap.com/tidb/v5.4/tidb-lightning-backends.
    backend = "local"
