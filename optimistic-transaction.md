...
> **Note:**
>
> - Starting from TiDB v3.0, the automatic retry of transactions is disabled by default, because it can **break the transaction isolation level**. 
> - Starting from TiDB v8.0.0, this feature is deprecated and no longer supported.
