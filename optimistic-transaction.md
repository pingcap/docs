...
3. The client issues a write request.
    ...
    TiDB checks whether the written data satisfies constraints (e.g. data types are correct, nullity constraints are met). **Valid data is stored in the private memory of this transaction in TiDB**.
