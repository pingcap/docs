...
詳細については、 [<a href="https://dev.mysql.com/doc/refman/5.7/en/user-variables.html">MySQL のユーザー定義変数</a>](https://dev.mysql.com/doc/refman/5.7/en/user-variables.html)を参照してください。
