...
- If your delete statements do not need to be transactional, you can use [Non-Transactional Bulk-delete](#non-transactional-bulk-delete) to improve performance.
