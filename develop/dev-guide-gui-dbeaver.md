...
To connect to a {{{ .starter }}} or {{{ .essential }}} public endpoint from DBeaver on Windows, you must configure an additional SSL certificate (ISRG Root X1). Otherwise, the connection will fail.
