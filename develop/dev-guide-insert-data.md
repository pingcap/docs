...
- Data import: [Create Import](/tidb-cloud/import-sample-data-serverless.md) page in the [TiDB Cloud console](https://tidbcloud.com/). You can import **Dumpling** exported data, import a local **CSV** file, or [Import CSV Files from Amazon S3, GCS, or Azure Blob Storage into TiDB Cloud Starter](/tidb-cloud/import-csv-files-serverless.md). It also supports reading data from a local disk, Amazon S3 cloud disk, or GCS cloud disk.
