...
- Data import: [Create Import](/tidb-cloud/import-sample-data.md) page in the [TiDB Cloud console](https://tidbcloud.com/). You can upload local CSV files (Serverless) and import **Dumpling** logical dumps (schema + data), **CSV**, or **Parquet** files stored in Cloud Storage. For details, see the [Import CSV Files into TiDB Cloud Serverless](/tidb-cloud/import-csv-files-serverless.md) or [Import CSV Files into TiDB Cloud Dedicated](/tidb-cloud/import-csv-files.md).
