...
5. Launch Navicat Premium, click **Connection** in the upper-left corner, check the **PingCAP** in **Venfor Filter** list, and double click **TiDB** from the right panel.
...
1. Launch Navicat Premium, click **Connection** in the upper-left corner, check the **PingCAP** in **Venfor Filter** list, and double click **TiDB** from the right panel.
