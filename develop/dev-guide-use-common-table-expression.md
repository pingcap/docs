...
aliases: ['/ja/tidb/stable/dev-guide-use-common-table-expression/','/ja/tidb/dev/dev-guide-use-common-table-expression/','/ja/tidbcloud/dev-guide-use-common-table-expression/']
---
