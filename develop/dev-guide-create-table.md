...
To learn more about TiDB HTAP capabilities, refer to the following documents: [Quick start with HTAP](/quick-start-with-htap.md) and [Explore HTAP](/explore-htap.md).
