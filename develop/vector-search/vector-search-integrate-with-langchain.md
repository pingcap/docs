...
This tutorial demonstrates how to integrate the [vector search](/develop/vector-search/vector-search-overview.md) feature of TiDB with [LangChain](https://python.langchain.com/).
