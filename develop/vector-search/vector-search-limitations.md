...
- Each [vector](/develop/vector-search/vector-search-data-types.md) supports up to 16383 dimensions.
...
See [Vector search restrictions](/develop/vector-search/vector-search-index.md#restrictions).
