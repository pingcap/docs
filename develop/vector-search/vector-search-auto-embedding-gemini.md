...
This document describes how to use Gemini embedding models with [Auto Embedding](/develop/vector-search-auto-embedding-overview.md) in TiDB Cloud to perform semantic searches from text queries.
