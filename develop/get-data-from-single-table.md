...
- After [getting the database connection](/develop/connect-to-tidb.md#jdbc), you can create a `Statement` instance object using the `conn.createStatus()` statement.
