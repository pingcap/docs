...
> **Tip:**
>
> Since there is an [unresolved bug](https://bugs.mysql.com/bug.php?id=106252) in the current version 8.0.30, which might cause threads to hang when using TiDB versions before v6.3.0. It is recommended that, if you are not yet using TiDB v6.3.0 or later versions, you do not upgrade to version 8.0 until MySQL Connector/J 8.0 merges this fix, or use the TiDB version of MySQL Connector/J as that includes a fix (see the *TiDB-JDBC* tab).
