...
You can follow the [MySQL documentation](https://dev.mysql.com/doc/connector-j/5.1/en/) to download and configure a Java JDBC driver. It is strongly recommended to use MySQL Connector/J 8.0.29 or later version.

> **Tip:**
>
> Since there is an [unresolved bug](https://bugs.mysql.com/bug.php?id=106252) in the current version 8.0.29, which might cause threads to hang when using TiDB. It is recommended that you do not upgrade to version 8.0 until MySQL JDBC 8.0 merges this fix, or use the TiDB version of MySQL Connector/J as that includes a fix (see the *TiDB-JDBC* tab).
