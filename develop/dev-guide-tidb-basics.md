...
**楽観的トランザクション**が何なのかわからない場合は、まだ使用***しないで***ください。**楽観的トランザクション**では、アプリケーションが`COMMIT`文によって返される[すべてのエラー](https://docs.pingcap.com/tidb/v8.5/error-codes/)正しく処理できる必要があります。アプリケーションがどのように処理するかわからない場合は、代わりに**悲観的トランザクション**を使用してください。
