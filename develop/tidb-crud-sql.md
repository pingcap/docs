...
Please make sure you are connected to a TiDB cluster. If not, refer to [Build a TiDB Cluster in TiDB Cloud (DevTier)](/develop/build-cluster-in-cloud.md#step-1-create-a-free-cluster) to create a free cluster.
