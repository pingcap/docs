...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-golang-sql-driver">Build a Simple CRUD App with TiDB and Go-MySQL-Driver</a></td>
      </tr>
      <tr>
         <td>Java</td>
         ...
         <td>
            <ul>
               <li><a href="/tidb/v7.3/dev-guide-choose-driver-or-orm#java-drivers" data-href="/tidb/v7.3/dev-guide-choose-driver-or-orm#java-drivers">pingcap/mysql-connector-j</a></li>
               <li><a href="/tidb/v7.3/dev-guide-choose-driver-or-orm#tidb-loadbalance" data-href="/tidb/v7.3/dev-guide-choose-driver-or-orm#tidb-loadbalance">pingcap/tidb-loadbalance</a></li>
            </ul>
         </td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-java-jdbc">Build a Simple CRUD App with TiDB and JDBC</a></td>
      </tr>
      <tr>
         <td>JavaScript</td>
      ...
      <tr>
         ...
         <td>Compatible</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-python-mysql-connector">Build a Simple CRUD App with TiDB and MySQL Connector/Python</a></td>
      </tr>
      <tr>
         ...
         <td>Compatible</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-python-mysqlclient">Build a Simple CRUD App with TiDB and mysqlclient</a></td>
      </tr>
      <tr>
         ...
         <td>Compatible</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-python-pymysql">Build a Simple CRUD App with TiDB and PyMySQL</a></td>
      </tr>
   </tbody>
</table>
...
<table>
   ...
   <tbody>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-golang-gorm">Build a Simple CRUD App with TiDB and GORM</a></td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-java-hibernate">Build a Simple CRUD App with TiDB and Hibernate</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-java-mybatis">Build a Simple CRUD App with TiDB and MyBatis</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-java-spring-boot">Build a Simple CRUD App with TiDB and Spring Boot</a></td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-python-sqlalchemy">Build a Simple CRUD App with TiDB and SQLAlchemy</a></td>
      </tr>
      <tr>
         ...
         <td>Compatible</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.3/dev-guide-sample-application-python-peewee">Build a Simple CRUD App with TiDB and peewee</a></td>
      </tr>
   </tbody>
</table>
