...
<table>
   ...
   <tbody>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.1/dev-guide-sample-application-golang-sql-driver">Connect to TiDB with Go-MySQL-Driver</a></td>
      </tr>
      <tr>
         <td>Java</td>
         ...
         <td><a href="/tidb/v7.1/dev-guide-sample-application-java-jdbc">Connect to TiDB with JDBC</a></td>
      </tr>
   </tbody>
</table>
...
<table>
   ...
   <tbody>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.1/dev-guide-sample-application-golang-gorm">Connect to TiDB with GORM</a></td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.1/dev-guide-sample-application-java-hibernate">Connect to TiDB with Hibernate</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.1/dev-guide-sample-application-java-mybatis">Connect to TiDB with MyBatis</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.1/dev-guide-sample-application-java-spring-boot">Connect to TiDB with Spring Boot</a></td>
      </tr>
      <tr>
...
<<<<<<< HEAD
         <td><a href="/tidb/v7.1/dev-guide-sample-application-django">Connect to TiDB with Django</a></td>
=======
...
>>>>>>> ab6d71034f (develop: update the third party support table (#15187))
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.1/dev-guide-sample-application-python-sqlalchemy">Connect to TiDB with SQLAlchemy</a></td>
      </tr>
   </tbody>
</table>
