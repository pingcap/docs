...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v6.5/dev-guide-sample-application-golang">Build a Simple CRUD App with TiDB and Golang</a></td>
      </tr>
      <tr>
         <td>Java</td>
         ...
         <td><a href="/tidb/v6.5/dev-guide-sample-application-java-jdbc">Build a Simple CRUD App with TiDB and Java</a></td>
      </tr>
      <tr>
         <td>JavaScript</td>
      ...
      <tr>
         ...
         <td>Compatible</td>
         <td>N/A</td>
         <td><a href="/tidb/v6.5/dev-guide-sample-application-python">Build a Simple CRUD App with TiDB and Python</a></td>
      </tr>
      <tr>
...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v6.5/dev-guide-sample-application-java-hibernate">Build a Simple CRUD App with TiDB and Java</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v6.5/dev-guide-sample-application-java-mybatis">Build a Simple CRUD App with TiDB and Java</a></td>
      </tr>
      <tr>
