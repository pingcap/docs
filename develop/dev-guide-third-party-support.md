...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.0/dev-guide-sample-application-golang">Build a Simple CRUD App with TiDB and Golang</a></td>
      </tr>
      <tr>
         <td>Java</td>
         ...
         <td>
            <ul>
               <li><a href="/tidb/v7.0/dev-guide-choose-driver-or-orm#java-drivers" data-href="/tidb/v7.0/dev-guide-choose-driver-or-orm#java-drivers">pingcap/mysql-connector-j</a></li>
               <li><a href="/tidb/v7.0/dev-guide-choose-driver-or-orm#tidb-loadbalance" data-href="/tidb/v7.0/dev-guide-choose-driver-or-orm#tidb-loadbalance">pingcap/tidb-loadbalance</a></li>
            </ul>
         </td>
         <td><a href="/tidb/v7.0/dev-guide-sample-application-java">Build a Simple CRUD App with TiDB and Java</a></td>
      </tr>
      <tr>
         <td>JavaScript</td>
      ...
      <tr>
         ...
         <td>Compatible</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.0/dev-guide-sample-application-python">Build a Simple CRUD App with TiDB and Python</a></td>
      </tr>
      <tr>
...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.0/dev-guide-sample-application-java-mybatis">Build a Simple CRUD App with TiDB and MyBatis</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="/tidb/v7.0/dev-guide-sample-application-spring-boot">Build a Simple CRUD App with TiDB and Spring Boot</a></td>
      </tr>
      <tr>
