...
| JavaScript / タイプスクリプト | [Sequelize](https://sequelize.org/)                                          | バージョン6.20.1       | 完全      | 該当なし                                                  | [Sequelize で TiDB に接続する](/develop/dev-guide-sample-application-nodejs-sequelize.md)                |
| JavaScript / タイプスクリプト | [Prisma](https://www.prisma.io/)                                        | 4.16.2            | 完全      | 該当なし                                                  | [PrismaでTiDBに接続する](/develop/dev-guide-sample-application-nodejs-prisma.md)                         |
| JavaScript / タイプスクリプト | [TypeORM](https://typeorm.io/)                                         | v0.3.17           | 完全      | 該当なし                                                  | [TypeORMでTiDBに接続する](/develop/dev-guide-sample-application-nodejs-typeorm.md)                       |
