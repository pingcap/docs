...
| Python                  | [ジャンゴ](https://www.djangoproject.com/)                                | バージョン4.2          | 満杯      | [django-tidb](https://github.com/pingcap/django-tidb) | [DjangoでTiDBに接続する](/develop/dev-guide-sample-application-python-django.md)                         |
| Python                  | [SQLアルケミー](https://www.sqlalchemy.org/)                               | バージョン1.4.37       | 満杯      | 該当なし                                                  | [SQLAlchemy で TiDB に接続する](/develop/dev-guide-sample-application-python-sqlalchemy.md)              |
