...
| Ruby                   | [Active Record](https://guides.rubyonrails.org/active_record_basics.html) | バージョン7.0          | 満杯      | 該当なし                                                  | [RailsフレームワークとActiveRecord ORMを使用してTiDBに接続する](/develop/dev-guide-sample-application-ruby-rails.md) |
