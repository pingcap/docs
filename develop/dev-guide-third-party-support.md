...
| ---- | ------------------------------------------------------------- | ------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| Go   | [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) | バージョン1.6.0    | 完全      | 該当なし                                                                                                                                                                                     | [Go-MySQL-Driver で TiDB に接続する](/develop/dev-guide-sample-application-golang-sql-driver.md) |
...
| --------------------- | --------------------------------------------------------------------- | ----------------- | ------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| Go                    | [ゴーム](https://github.com/go-gorm/gorm)                                | バージョン1.23.5       | 完全      | 該当なし                                                  | [GORMでTiDBに接続する](/develop/dev-guide-sample-application-golang-gorm.md)                             |
| Go                    | [ビーゴ](https://github.com/beego/beego)                                 | バージョン2.0.3        | 完全      | 該当なし                                                  | 該当なし                                                                                               |
| Go                    | [上段/db](https://github.com/upper/db)                                  | バージョン4.5.2        | 完全      | 該当なし                                                  | 該当なし                                                                                               |
...
| Ruby                   | [Active Record](https://guides.rubyonrails.org/active_record_basics.html) | バージョン7.0          | 完全      | 該当なし                                                  | [RailsフレームワークとActiveRecord ORMを使用してTiDBに接続する](/develop/dev-guide-sample-application-ruby-rails.md) |
...
| Python                  | [Django](https://www.djangoproject.com/)                                | バージョン4.2          | 完全      | [django-tidb](https://github.com/pingcap/django-tidb) | [DjangoでTiDBに接続する](/develop/dev-guide-sample-application-python-django.md)                         |
| Python                  | [SQLAlchemy](https://www.sqlalchemy.org/)                               | バージョン1.4.37       | 完全      | 該当なし                                                  | [SQLAlchemy で TiDB に接続する](/develop/dev-guide-sample-application-python-sqlalchemy.md)              |
