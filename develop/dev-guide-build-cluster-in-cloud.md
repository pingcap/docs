...
> **Note:**
>
> - When you connect to a TiDB Cloud Serverless cluster, you must [use the TLS connection](https://docs.tidb.io/tidbcloud/secure-connections-to-serverless-clusters).
> - If you encounter problems when connecting to a TiDB Cloud Serverless cluster, you can read [Secure Connections to TiDB Cloud Serverless Clusters](https://docs.tidb.io/tidbcloud/secure-connections-to-serverless-clusters) for more information.
