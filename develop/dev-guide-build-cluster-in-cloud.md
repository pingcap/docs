...
1. If you do not have a TiDB Cloud account, click [here](https://console.tidb.io/free-trial) to sign up for an account.

2. [Log in](https://console.tidb.io/) to your TiDB Cloud account.

3. On the [**Clusters**](https://console.tidb.io/clusters) page, click **Create Cluster**.
...
> **Note:**
>
> For [TiDB Cloud Starter](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-starter) clusters, when you connect to your cluster, you must include the prefix for your cluster in the user name and wrap the name with quotation marks. For more information, see [User name prefix](https://docs.tidb.io/tidbcloud/select-cluster-tier/#user-name-prefix).
...
2. Run the connection string obtained in [Step 1](#step-1-create-a-tidb-cloud-starter-cluster).
...
> **Note:**
>
> - When you connect to a TiDB Cloud Starter cluster, you must [use the TLS connection](https://docs.tidb.io/tidbcloud/secure-connections-to-serverless-clusters).
> - If you encounter problems when connecting to a TiDB Cloud Starter cluster, you can read [Secure Connections to TiDB Cloud Starter Clusters](https://docs.tidb.io/tidbcloud/secure-connections-to-serverless-clusters) for more information.
