...
This document walks you through the quickest way to get started with TiDB. You will use [TiDB Cloud](/tidb-cloud/tidb-cloud-intro.md) to create a TiDB Serverless cluster, connect to it, and run a sample application on it.
