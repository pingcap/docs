...
3. To create a Developer Tier cluster for one year free, you can either select the **Developer Tier** plan on the [plan page](https://tidbcloud.com/console/plans) or click [Create Now](https://tidbcloud.com/console/create-cluster?tier=dev) and select **Developer Tier** on the **Create a Cluster** page.
4. On the **Create a Cluster** page, set up your cluster name, cloud provider (for now, only AWS is available for Developer Tier), and region (a nearby region is recommended). Then click **Create** to create your cluster.
