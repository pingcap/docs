...
aliases: ['/ja/tidb/stable/dev-guide-sample-application-java-spring-boot/','/ja/tidb/dev/dev-guide-sample-application-java-spring-boot/','/ja/tidbcloud/dev-guide-sample-application-java-spring-boot/']
---
...
3.  [期待出力.txt](https://github.com/tidb-samples/tidb-java-springboot-jpa-quickstart/blob/main/Expected-Output.txt)をチェックして、出力が一致するかどうかを確認します。
