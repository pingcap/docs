...
If you do not have a TiDB cluster, you can create a [{{{ .starter }}}](/tidb-cloud/tidb-cloud-quickstart.md) cluster, which is free and can be created in approximately 30 seconds.
