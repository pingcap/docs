...
If you do not have a TiDB cluster, you can [create a TiDB Cloud Starter cluster](https://docs.tidb.io/tidbcloud/create-tidb-cluster-serverless), which is free and can be created in approximately 30 seconds.
