...
If you do not have a TiDB cluster, you can [create a TiDB Cloud Serverless cluster](/tidb-cloud/create-tidb-cluster-serverless.md), which is free and can be created in approximately 30 seconds.
