...
Please make sure you are connected to a TiDB cluster. If not, refer to [Build a TiDB Cluster in TiDB Serverless](/develop/dev-guide-build-cluster-in-cloud.md#step-1-create-a-serverless-tier-cluster) to create a Serverless Tier cluster.
