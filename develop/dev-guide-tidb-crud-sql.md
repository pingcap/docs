...
This page walks you through the basic TiDB SQL statements such as DDL, DML, and CRUD operations. For a complete list of TiDB statements, see [TiDB SQL Statement Overview](/sql-statements/sql-statement-overview.md).
...
The following mainly introduces DML and DQL. For more information about DDL and DCL, see [Explore SQL with TiDB](/basic-sql-operations.md) or [TiDB SQL Statement Overview](/sql-statements/sql-statement-overview.md).
