...
summary: 了解如何使用 GORM 连接 TiDB。本教程提供适用于 TiDB 的 Golang 示例代码片段，演示如何使用 GORM。
---
...
2. 查看 [Expected-Output.txt](https://github.com/tidb-samples/tidb-golang-gorm-quickstart/blob/main/Expected-Output.txt)，确认输出是否匹配。
