...
6. Edit the `.env` file, set up the environment variables as follows, directly copy the connection string from the connection dialog, and set it to `DATABASE_URL`:
