...
- To complete this tutorial, you need access to a TiDB instance. You can use [a TiDB Cloud Starter cluster](/develop/dev-guide-build-cluster-in-cloud.md), or a TiDB Self-Managed cluster, such as [one started using `tiup playground`](https://docs.pingcap.com/tidb/stable/quick-start-with-tidb#deploy-a-local-test-cluster).
