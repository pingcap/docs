...
| Issue link missing | Include at least one `[#NNNNN](https://github.com/pingcap/tidb/issues/NNNNN)` |
| Contributor missing | Include `@[contributor](https://github.com/contributor)` |
