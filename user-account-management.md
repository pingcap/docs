...
TiDB can limit the resources consumed by users using resource groups. For more information, see [Use Resource Control to Achieve Resource Group Limitation](/tidb-resource-control-ru-groups.md).
