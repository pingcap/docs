...
-   エラー番号: 8154
    ...
    現在、 `LOAD DATA` TiDBサーバーからのローカルデータのインポートをサポートしていません。3 `LOCAL`を指定してクライアントからインポートするか、S3 または GCS にデータをアップロードしてからインポートすることができます。5 [`LOAD DATA`](/sql-statements/sql-statement-load-data.md)参照してください。
