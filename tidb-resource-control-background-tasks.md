...
- `lightning`: perform import tasks using [TiDB Lightning](/tidb-lightning/tidb-lightning-overview.md) or [IMPORT INTO](/tidb/sql-statements/sql-statement-import-into.md). Both physical and logical import modes of TiDB Lightning are supported.
