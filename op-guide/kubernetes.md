...
<main class="tabs">
  ...
  <label for="tabGoogle">
      <span class="label__logo" width="20"><img src="https://cloud.google.com/_static/images/cloud/icons/favicons/onecloud/apple-icon.png"></img></span>
      <span class="label__title">GCP</span>
  </label>
  <input id="tabLocal" type="radio" name="tabs" value="LocalContent">
  <label for="tabLocal">
      <span class="label__logo" width="20"><img src="https://avatars1.githubusercontent.com/u/13629408?s=400&v=4" width="20"></img></span>
