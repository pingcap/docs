...
# If you use the master branch of tidb-ansible to deploy the TiDB cluster, you must also configure the TiKV status ports in the topology of multiple TiKV instances, as shown in the following example.
