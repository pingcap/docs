...
- Connect to TiDB Cloud
  ...
  - Serverless Driver ![BETA](?color=#F6F6F4)
...
- Manage Cluster
  ...
  - Monitor and Alert
    ...
    - [Third-Party Metrics Integrations](/tidb-cloud/third-party-monitoring-integrations.md) ![BETA](?color=#F6F6F4)
  - Tune Performance
    - [Overview](/tidb-cloud/tidb-cloud-tune-performance-overview.md)
    - Analyze Performance
      - [Use the Diagnosis Tab](/tidb-cloud/tune-performance.md)
      - [Use Index Insight](/tidb-cloud/index-insight.md) ![BETA](?color=#F6F6F4)
...
- Explore Data
  - [Chat2Query in SQL Editor](/tidb-cloud/explore-data-with-chat2query.md) ![BETA](?color=#F6F6F4)
  - [SQL Proxy Account](/tidb-cloud/sql-proxy-account.md)
- Vector Search ![BETA](?color=#F6F6F4)
...
- Data Service ![BETA](?color=#F6F6F4)
