...
- Migrate Data
  ...
  - Migrate Data into TiDB
    ...
    - [Migrate from MySQL-Compatible Databases Using Data Migration](/tidb-cloud/migration-job.md)
    - Migrate from MySQL-Compatible On-Premises Databases Using Import Tasks
