...
- Integrations
  ...
  - Terraform
    ...
    - [Use Dedicated VPC Peering](/tidb-cloud/terraform-use-dedicated-vpc-peering-resource.md)
    - [Use Dedicated Private Endpoint Connection](/tidb-cloud/terraform-use-dedicated-private-endpoint-connection-resource.md)
    - [Use Dedicated Network Container](/tidb-cloud/terraform-use-dedicated-network-container-resource.md)
