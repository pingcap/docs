...
You can use the system variable [`tidb_enable_window_function`](/system-variables.md#tidb_enable_window_function) to control whether the keywords in R-Window take effect in the syntax tree. If you set `tidb_enable_window_function` to `OFF`, the words in R-Window will no longer be treated as keywords.
