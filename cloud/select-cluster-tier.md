...
To create a Dedicated Tier cluster, you need to [add a payment method](/cloud/tidb-cloud-billing.md#payment-method) or [apply for a Proof of Concept (PoC) trial](/cloud/tidb-cloud-poc.md).
