...
To submit an upgrade request, perform the steps in [TiDB Cloud Support](/cloud/tidb-cloud-support.md) to contact our support team. Note to provide the following information in the **Description** box:
