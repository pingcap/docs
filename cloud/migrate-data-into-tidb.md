...
- If your source data is located in Amazon S3 cloud storage, take the following steps:
    ...
    1. Configure Amazon S3 access to allow TiDB cloud to access the source data in your Amazon S3 bucket. For more information, see [configure Amazon S3 access](/cloud/migrate-from-amazon-s3-or-gcs.md#step-2-configure-amazon-s3-access). 
...
- If your source data is in local files, do one of the following:
    ...
    - If the data is larger than 1 TB, it is recommended that you use Amazon S3 or GCS as a staging area to import or migrate data into TiDB Cloud. For more information, see [Import or migrate from Amazon S3 or GCS to TiDB Cloud](/cloud/migrate-from-amazon-s3-or-gcs.md). 
