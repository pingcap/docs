...
+ PingCAP/TiDB
    ...
    - Please add a release note, or a 'None' if it is not needed. [#27841](https://github.com/pingcap/tidb/pull/27841)
    - fix wrong selection push down when having above agg [#27742](https://github.com/pingcap/tidb/pull/27742)
    - ```release-note [#27584](https://github.com/pingcap/tidb/pull/27584)
    ...
    - Non release note [#24945](https://github.com/pingcap/tidb/pull/24945)
...
- Fix newer TiKV can't rollback to 5.0.x [#10843](https://github.com/tikv/tikv/pull/10843)
    - None. [#10821](https://github.com/tikv/tikv/pull/10821)
...
- `tikv-ctl unsafe-recover drop-unapplied-raftlog -r 1,2,3`: regress the commit index to the apply index for the region [#10794](https://github.com/tikv/tikv/pull/10794)
...
+ PD
    ...
    - None. [#3975](https://github.com/tikv/pd/pull/3975)
...
If you don't think this PR needs a release note then fill it with `None`. [#2682](https://github.com/pingcap/ticdc/pull/2682)
        ...
        - `None`. [#2520](https://github.com/pingcap/ticdc/pull/2520)
...
- Cleanup processor metrics when processor exits. [#2177](https://github.com/pingcap/ticdc/pull/2177)
        - ```release-note [#2143](https://github.com/pingcap/ticdc/pull/2143)
...
+ PingCAP/TiDB
    ...
    - ```release-note [#26963](https://github.com/pingcap/tidb/pull/26963)
