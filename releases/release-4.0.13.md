...
-   TiDB
    ...
    -   サブクエリを含む`UPDATE`ステートメントが生成された列[＃24658](https://github.com/pingcap/tidb/pull/24658)を更新するときに発生するパニックの問題を修正します
    ...
    -   監査プラグインがTiDBパニックを引き起こす問題を修正します[＃23819](https://github.com/pingcap/tidb/pull/23819)
    ...
    -   `UPDATE`ステートメントに`HAVING`句[＃23575](https://github.com/pingcap/tidb/pull/23575)の結合クエリが含まれている場合に発生するクエリパニックの問題を修正します。
    ...
    -   大文字の名前のデータベースで`show table status`ステートメントを実行すると、誤った結果が返される問題を修正します[＃23958](https://github.com/pingcap/tidb/pull/23958)
...
-   TiFlash
    ...
    -   `Segment Split`の間に発生するTiFlashパニックの問題を修正します
