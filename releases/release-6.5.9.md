...
-   RocksDB の TiKV 構成項目[`track-and-verify-wals-in-manifest`](https://docs.pingcap.com/tidb/v6.5/tikv-configuration-file#track-and-verify-wals-in-manifest-new-in-v659)を追加します。これは、Write Ahead Log (WAL) [＃16549](https://github.com/tikv/tikv/issues/16549) @ [v01dスター](https://github.com/v01dstar)の破損の可能性を調査するのに役立ちます。
...
-   ツール
    ...
    -   バックアップと復元 (BR)
        ...
        -   ローリング再起動時のログバックアップの復旧ポイント目標（RPO）を最適化します。これにより、ローリング再起動時のログバックアップタスクのチェックポイントラグが短縮されます[＃15410](https://github.com/tikv/tikv/issues/15410) @ [ユジュンセン](https://github.com/YuJuncen) 。
        ...
        -   チェックポイントの遅延が大きい場合にログ バックアップ タスクを自動的に中止し、GC の長時間のブロッキングや潜在的なクラスターの問題を回避することをサポートします[＃50803](https://github.com/pingcap/tidb/issues/50803) @ [リドリスR](https://github.com/RidRisR)
...
-   ティドブ
    ...
    -   TiDB が SQL 文のクエリに`MemTableScan`の演算子[＃40937](https://github.com/pingcap/tidb/issues/40937) @ [中zc](https://github.com/zhongzc)が含まれている場合に、SQL 文の`WHERE <column_name>`フィルタリング条件を処理しない問題を修正しました。
    ...
    -   トランザクション[＃39664](https://github.com/pingcap/tidb/issues/39664) @ [天菜麻緒](https://github.com/tiancaiamao)で複数のステートメントをコミットするときにテーブル名の変更が有効にならない問題を修正しました
    ...
    -   `BIT`タイプの列[＃50850](https://github.com/pingcap/tidb/issues/50850) [＃50855](https://github.com/pingcap/tidb/issues/50855) @ [ジフハスト](https://github.com/jiyfhust)を処理するときに`REVERSE`関数がエラーを報告する問題を修正しました
    -   DDL操作[＃50993](https://github.com/pingcap/tidb/issues/50993) @ [ヤンケオ](https://github.com/YangKeao)を実行しているテーブルにデータを一括挿入するときに`INSERT IGNORE`エラーを報告する問題を修正しました
...
-   TiFlash
    ...
    -   `TIME`列の精度が変更された後にリージョンの移行、分割、または結合が発生すると、クエリが[＃8601](https://github.com/pingcap/tiflash/issues/8601) @ [ジェイソン・ファン](https://github.com/JaySon-Huang)失敗する可能性がある問題を修正しました。
...
-   ツール
    ...
    -   TiCDC
        ...
        -   storageシンクシナリオ[＃10592](https://github.com/pingcap/tiflow/issues/10592) @ [チャールズ・チャン96](https://github.com/CharlesCheung96)でTiCDCがAzureとGCSに正しくアクセスできない問題を修正
