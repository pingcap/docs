...
-   TiDB
    ...
    -   SQL文のクエリに`MemTableScan`の演算子[＃40937](https://github.com/pingcap/tidb/issues/40937) @ [zhongzc](https://github.com/zhongzc)が含まれている場合、TiDBがSQL文の`WHERE <column_name>`のフィルタリング条件を処理しない問題を修正しました。
    ...
    -   `BIT`タイプの列[＃50850](https://github.com/pingcap/tidb/issues/50850) [＃50855](https://github.com/pingcap/tidb/issues/50855) @ [jiyfhust](https://github.com/jiyfhust)を処理するときに`REVERSE`関数がエラーを報告する問題を修正しました
    -   DDL操作[＃50993](https://github.com/pingcap/tidb/issues/50993) @ [YangKeao](https://github.com/YangKeao)を実行しているテーブルにデータを一括挿入するときにエラーが報告される問題を修正しました`INSERT IGNORE`
...
-   ツール
    ...
    -   TiCDC
        ...
        -   storageシンクシナリオ[＃10592](https://github.com/pingcap/tiflow/issues/10592) @ [CharlesCheung96](https://github.com/CharlesCheung96)でTiCDCがAzureとGCSに正しくアクセスできない問題を修正
