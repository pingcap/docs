...
2018年1月22日に、TiDB 1.0.7がリリースされ、次の更新が行われました。
...
-   [`RunWorker`がDDLでfalseの場合の動作を更新します](https://github.com/pingcap/tidb/pull/5604)
...
-   [ログを追加します](https://github.com/pingcap/pd/pull/917)
...
1.0.6から1.0.7にアップグレードするには、PD-&gt;TiKV-&gt;TiDBのローリングアップグレード順序に従います。
