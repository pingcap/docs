...
-   ティビ
    ...
    -   グローバル統計の`Distinct_count`情報が間違っている可能性がある問題を修正[＃53752](https://github.com/pingcap/tidb/issues/53752) @ [ホーキングレイ](https://github.com/hawkingrei)
    ...
    -   式インデックス[＃51431](https://github.com/pingcap/tidb/issues/51431) @ [うわー](https://github.com/ywqzzy)名前を変更する`RENAME INDEX`を実行すると、内部列の名前が変更されない問題を修正しました。
    ...
    -   相関サブクエリ[＃52777](https://github.com/pingcap/tidb/issues/52777) @ [宜ビン87](https://github.com/yibin87)の TopN 演算子の誤った結果を修正
