...
+ Tools
    ...
    + Dumpling
        ...
        - Support using the `-c,--compress` parameter to specify the compression algorithm used by Dumpling, and the empty string means no compression [#202](https://github.com/pingcap/dumpling/pull/202)
