...
+ TiDB
    ...
    - Fix the issue that when updating a record and then querying it in a transaction, no record is returned [#21290](https://github.com/pingcap/tidb/issues/21290)
