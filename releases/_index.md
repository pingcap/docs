...
本文档列出了所有已发布的 TiDB 版本，按版本号降序排列。

如需了解 TiDB 长期支持（LTS）版本的支持周期，请参见 [TiDB 发布支持政策](https://pingcap.com/tidb-release-support-policy/)。
