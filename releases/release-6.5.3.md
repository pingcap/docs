...
+ Tools
    ...
    + TiCDC
        ...
        - Optimize the Decoder interface and add a new parameter `AddKeyValue` [#8861](https://github.com/pingcap/tiflow/issues/8861) [3AceShowHand](https://github.com/3AceShowHand)
