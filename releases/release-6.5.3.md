...
-   ツール
    ...
    -   Backup & Restore (BR)
        ...
        -   バックアップが失敗したときにBRのエラーメッセージ「resolve lock timeout」が誤解を招き、実際のエラー情報が隠れてしまう問題を修正しました[#43236](https://github.com/pingcap/tidb/issues/43236) @[YuJuncen](https://github.com/YuJuncen)
