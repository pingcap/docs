...
-   ティドブ
    ...
    -   ステイル読み取り で`DataIsNotReady`エラー[＃765](https://github.com/tikv/client-go/pull/765) @ [テーマ](https://github.com/Tema)が発生した場合にリーダー読み取りを使用してレイテンシーを削減します。
    -   ステイル読み取り [＃43325](https://github.com/pingcap/tidb/issues/43325) @ [あなた06](https://github.com/you06)を使用する際のヒット率とトラフィックを追跡するために、 `Stale Read OPS`と`Stale Read MBps`メトリックを追加します。

-   TiKV

    -   gzip を使用して`check_leader`リクエスト[＃14839](https://github.com/tikv/tikv/issues/14839) @ [cfzjywxk](https://github.com/cfzjywxk)を圧縮してトラフィックを削減します
...
-   ツール
    ...
    -   TiCDC
        ...
        -   Kafka [＃8865](https://github.com/pingcap/tiflow/issues/8865) @ [ハイ・ラスティン](https://github.com/Rustin170506)にデータを複製する際の検証に OAuth プロトコルの使用をサポート
        ...
        -   DDLレプリケーション操作を最適化して、DDL操作によるダウンストリームレイテンシー[＃8686](https://github.com/pingcap/tiflow/issues/8686) @ [ハイ・ラスティン](https://github.com/Rustin170506)への影響を軽減します。
...
-   ティドブ
    ...
    -   配置ルールのリサイクル中に TiDB が PD に重複したリクエストを送信し、PD ログ[＃33069](https://github.com/pingcap/tidb/issues/33069) @ [天菜麻緒](https://github.com/tiancaiamao)に多数の`full config reset`エントリが発生する問題を修正しました。
    ...
    -   パスワードの複雑さのチェックが有効になっているときに`tidb_auth_token`ユーザーの作成に失敗する問題を修正[＃44098](https://github.com/pingcap/tidb/issues/44098) @ [Cbcウェストウルフ](https://github.com/CbcWestwolf)
...
-   TiKV
    ...
    -   PD クラッシュにより PITR が[＃14184](https://github.com/tikv/tikv/issues/14184) @ [ユジュンセン](https://github.com/YuJuncen)で続行できなくなる可能性がある問題を修正しました
