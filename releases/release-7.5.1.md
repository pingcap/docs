...
-   TiCDC Changefeed、次の新しい構成項目が導入されています。
    ...
    -   [`consistent.flush-concurrency`](/ticdc/ticdc-changefeed-config.md) : 単一のREDOファイルのアップロードの同時実行をに設定できます [＃10226](https://github.com/pingcap/tiflow/issues/10226) @ [sdojjy](https://github.com/sdojjy)
...
-   TiDB
    ...
    -   [`FLASHBACK CLUSTER TO TSO`](https://docs.pingcap.com/tidb/v7.5/sql-statement-flashback-cluster)構文をサポート [＃48372](https://github.com/pingcap/tidb/issues/48372) @ [BornChanger](https://github.com/BornChanger)
    ...
    -   通常の`ADD INDEX`タスクにフォールバックするのではなく、複数の加速された`ADD INDEX` DDL タスクをキューに入れて実行できるようにサポートします。 [＃47758](https://github.com/pingcap/tidb/issues/47758) @ [tangenta](https://github.com/tangenta)
...
-   ツール
    ...
    -   Backup & Restore (BR)
        ...
        -   BRは`merge-schedule-limit`設定を`0` に設定することでリージョンのマージを一時停止できます。 [＃7148](https://github.com/tikv/pd/issues/7148) @ [3pointer](https://github.com/3pointer)
    ...
    -   TiCDC
        ...
        -   並列処理をに増やすことで、TiCDC がオブジェクトストレージにデータを複製する際のパフォーマンスが向上します。 [＃10098](https://github.com/pingcap/tiflow/issues/10098) @ [CharlesCheung96](https://github.com/CharlesCheung96)
...
-   TiDB
    ...
    -   パーティションがに削除された後、 `stats_meta`テーブルの履歴統計が更新されない問題を修正しました [＃49334](https://github.com/pingcap/tidb/issues/49334) @ [Rustin170506](https://github.com/Rustin170506)
...
-   TiFlash
    ...
    -   `ENUM`値が 0 の場合にTiFlash が`ENUM`誤って処理する問題を修正しました [＃8311](https://github.com/pingcap/tiflash/issues/8311) @ [solotzg](https://github.com/solotzg)
