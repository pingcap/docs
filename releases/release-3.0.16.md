...
-   TiKV
    ...
    -   PDクライアントログ改善 [＃8091](https://github.com/tikv/tikv/pull/8091)
...
-   TiDB
    ...
    -   `count`集計関数の 10 進プロパティの型推論を修正 [＃17702](https://github.com/pingcap/tidb/pull/17702)
...
-   PD
    ...
    -   PD Control でリージョンキーを照会する際の`404`エラーを修正しました [＃2577](https://github.com/pingcap/pd/pull/2577)
