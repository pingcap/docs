...
+ TiDB <!--tw@lilin90: the following 12 notes-->
    ...
    - Fix the issue that statistics of tables with the `BIT` type cannot be loaded [#62289](https://github.com/pingcap/tidb/issues/62289) @[YangKeao](https://github.com/YangKeao)
    ...
    - Fix the issue that when the collected column statistics are all in TopN, the row count estimate might always be 0 even if there are subsequent writes [#47400](https://github.com/pingcap/tidb/issues/47400) @[terry1purcell](https://github.com/terry1purcell)
    - Fix the issue that statistics of `BIT` type columns might fail to load into memory [#59759](https://github.com/pingcap/tidb/issues/59759) @[YangKeao](https://github.com/YangKeao)
