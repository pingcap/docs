...
| TiSpark        | [`spark.tispark.replica_read`](https://docs-archive.pingcap.com/tidb/v6.6/tispark-overview/#tispark-configurations)                                                                                                                                           | 新しく追加された | この設定項目は、読み取るレプリカの種類を制御します。値のオプションは`leader` 、 `follower` 、および`learner`です。                                                                                                                         |
