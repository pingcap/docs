...
+ Tools
    ...
    + TiCDC
        ...
        - Fix the issue that changefeed might get stuck in special scenarios such as when scaling in or scaling out TiKV or TiCDC nodes https://github.com/pingcap/tiflow/issues/8174 @[hicqu](https://github.com/hicqu)
