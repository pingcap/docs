...
summary: TiDB 1.0.6 は、Alter Table Auto_Increment構文のサポートやコストベースの計算のバグ修正などの更新を含んでいます。PDではホットリージョンスケジューラのストア選択の問題が修正されました。TiKVには変更はありません。1.0.5 から 1.0.6 にアップグレードするには、PD -&gt; TiKV -&gt; TiDB のローリング アップグレードの順序に従います。
---
