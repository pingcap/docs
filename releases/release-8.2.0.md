...
+ TiFlash
    ...
    - Fix the issue of query timeout when executing queries on partitioned tables that contain the empty partition [#9024](https://github.com/pingcap/tiflash/issues/9024) @[JinheLin](https://github.com/JinheLin)
