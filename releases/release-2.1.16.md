...
- SQL実行エンジン
    ...
    - スロークエリテーブルに、実行が成功したかどうかを示す`Succ`フィールドを追加します[#11412](https://github.com/pingcap/tidb/pull/11421)
...
- TiDB Binlog がKafka または ZooKeeper を使用する場合に Prometheus 設定ファイルが間違った形式で生成される問題を修正しました [#845](https://github.com/pingcap/tidb-ansible/pull/845)
