...
-   TiDBダッシュボード
    ...
    -   店舗の場所のトポロジーの視覚化をサポート[＃719](https://github.com/pingcap-incubator/tidb-dashboard/pull/719)
...
-   ツール
    ...
    -   TiCDC（v4.0.6以降のGA）
        ...
        -   `maxwell`フォーマットでのデータ出力をサポート[＃869](https://github.com/pingcap/tiflow/pull/869)
...
-   TiDB
    ...
    -   `metrics_schema`と`performance_schema`でテーブルを作成することを[＃19792](https://github.com/pingcap/tidb/pull/19792)する
    -   ユニオンエグゼキュータの同時実行性の調整をサポート[＃19886](https://github.com/pingcap/tidb/pull/19886)
    ...
    -   自動コミットステートメントの再試行のためにペシミスティックトランザクションモードに切り替えます[＃19796](https://github.com/pingcap/tidb/pull/19796)
    ...
    -   スローログ`update`フィールド`plan`に`insert`プランをエンコードし`delete` [＃19269](https://github.com/pingcap/tidb/pull/19269)
...
-   TiKV
    ...
    -   Grafanaのデフォルトテンプレートに`rocksdb perf context`のパネルを追加します[＃8467](https://github.com/tikv/tikv/pull/8467)
...
-   TiFlash
    ...
    -   Grafanaパネルを`write stall`つ追加します
    -   `dt_segment_force_merge_delta_rows`と`dt_segment_force_merge_delta_deletes`を追加して、 `write stall`のしきい値を調整します
    -   データ複製中のメモリ消費を削減するためにマルチスレッドによるリージョンスナップショットの適用を無効にするTiFlash-Proxyの設定`raftstore.snap-handle-pool-size`から`0`をサポート
...
-   ツール
    ...
    -   バックアップと復元（BR）
        ...
        -   サマリーログにリアルタイムのコストを追加[#486](https://github.com/pingcap/br/issues/486)
...
-   TiDB
    ...
    -   相関列のタイプが`Bit`の場合の`Apply`演算子のエラーを修正し[＃19692](https://github.com/pingcap/tidb/pull/19692)た
    -   ユーザーがMySQL8.0クライアント[＃19690](https://github.com/pingcap/tidb/pull/19690)で`processlist`と`cluster_log`をクエリしたときに発生する問題を修正します
    -   同じタイプのプランのプランダイジェストが異なる問題を修正します[＃19684](https://github.com/pingcap/tidb/pull/19684)
    ...
    -   [＃19611](https://github.com/pingcap/tidb/pull/19611)に`Apply`演算子がある場合のクエリエラーを修正し`HashJoin`
    ...
    -   テーブルendKeyとリージョンが同じである場合にTiDBが`no regions`エラーを返す問題を修正します[＃19895](https://github.com/pingcap/tidb/pull/19895)
    ...
    -   `TRUNCATE`操作のランタイムエラーを修正します[＃19445](https://github.com/pingcap/tidb/pull/19445)
    ...
    -   `case-when`式で生成された列を持つ`add index`操作が、解析エラー[＃19395](https://github.com/pingcap/tidb/pull/19395)に遭遇したときに正常に終了できるようにします。
    -   DDL操作が再試行するのに時間がかかりすぎるというバグを修正します[＃19488](https://github.com/pingcap/tidb/pull/19488)
...
-   PD
    ...
    -   スケジューラ[＃2871](https://github.com/tikv/pd/pull/2871)の空のHTTP応答を修正し[＃2874](https://github.com/tikv/pd/pull/2874)
...
-   ツール
    ...
    -   TiCDC
        ...
        -   場合によってはTiCDCがメモリリークする問題を修正します[＃942](https://github.com/pingcap/tiflow/pull/942)
