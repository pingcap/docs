...
+ Tools
    ...
    + Backup & Restore (BR)
        ...
        - Fix the issue that `resolve lock` is too frequent when there is no PITR backup task in TiDB cluster [#40759](https://github.com/pingcap/tidb/issues/40759) @[joccau](https://github.com/joccau)
