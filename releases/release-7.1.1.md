...
+ TiDB
    ...
    - Fix the issue that executing the `UPDATE` statement causes errors due to checking foreign key constraint [#44848](https://github.com/pingcap/tidb/issues/44848) @[crazycs520](https://github.com/crazycs520)
...
+ Tools
    ...
    + TiCDC
        ...
        - Fix the issue that Avro protocol meet incorrect Enum type value [#9262](https://github.com/pingcap/tiflow/pull/9262) @[3AceShowHand](https://github.com/3AceShowHand)
