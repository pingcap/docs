...
| TiKV | [`raft-engine.batch-compression-threshold`](/tikv-configuration-file.md#batch-compression-threshold) | Modified | Changes the default value from "8KiB" to "4KiB" to reduce the IOPS overhead of writing RaftLog entries and improve the compression ratio. |
