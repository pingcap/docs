...
+ TiDB
  ...
  <!--tw@lilin90 以下 18 条 -->
    ...
    - Fix the issue that adding indexes to large tables fails after enabling the distributed framework [#52640](https://github.com/pingcap/tidb/issues/52640) @[tangenta](https://github.com/tangenta)
    ...
    - Fix the issue that the status gets stuck when rolling back the partition DDL tasks [#51090](https://github.com/pingcap/tidb/issues/51090) @[lcwangchao](https://github.com/lcwangchao)
    - Fix the issue that TiDB unexpectedly restarts after importing data using TiDB Lightning [#52827](https://github.com/pingcap/tidb/issues/52827) @[hawkingrei](https://github.com/hawkingrei)
    - Fix the issue of incorrect `max_remote_stream` in the `explain analyze` result [#52646](https://github.com/pingcap/tidb/issues/52646) @[JaySon-Huang](https://github.com/JaySon-Huang)
...
+ TiFlash
  <!--tw@qiancai 2 -->
    ...
    - Fix the issue that TiFlash might return transiently incorrect results in high-concurrency read scenarios [#8845](https://github.com/pingcap/tiflash/issues/8845) @[JaySon-Huang](https://github.com/JaySon-Huang)
...
+ Tools
    ...
    + Backup & Restore (BR)
      <!--tw@hfxsd 7 -->
        ...
        - Fix the issue that the redundant information related to `--concurrency` appears in the log during a full backup [#50837](https://github.com/pingcap/tidb/issues/50837) @[BornChanger](https://github.com/BornChanger)
