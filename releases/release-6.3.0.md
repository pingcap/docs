...
* The minimum version of HAProxy that works with TiDB is now v1.5. HAProxy versions between v1.5 and v2.1 now require the `post-41` configuration option to be set in the `mysql-check`. It is recommended to use HAProxy version v2.2 or newer.
