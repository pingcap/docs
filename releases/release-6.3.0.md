...
* Support two more [window functions](/tiflash/tiflash-supported-pushdown-calculations.md) pushed down to TiFlash [#5579](https://github.com/pingcap/tiflash/issues/5579) @[SeaRise](https://github.com/SeaRise)
