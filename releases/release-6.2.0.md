...
| TiCDC | [--overwrite-checkpoint-ts](/ticdc/ticdc-manage-changefeed.md.md#resume-a-replication-task) | Newly added | This configuration is added to the `cdc cli changefeed resume` sub-command. |
