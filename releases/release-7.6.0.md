...
+ TiDB
    ...
    - Improve the balance of distributed framework tasks in the scenario where nodes are restarted [#47298](https://github.com/pingcap/tidb/issues/47298) @[ywqzzy](https://github.com/ywqzzy)
    ...
    - Optimize the speed of adding indexes to empty tables [#49682](https://github.com/pingcap/tidb/issues/49682) @[zimulala](https://github.com/zimulala)
    ...
    - `EXCHANGE PARTITION` operations now trigger maintenance updates of statistics information [#47354](https://github.com/pingcap/tidb/issues/47354) @[hi-rustin](https://github.com/hi-rustin)
    - TiDB supports building binary files that meet the requirements of FIPS [#47948](https://github.com/pingcap/tidb/issues/47948) @[tiancaiamao](https://github.com/tiancaiamao)
...
+ TiKV
    ...
    - Add priority labels to gRPC monitoring to display resource group data of different priorities @[bufferflies](https://github.com/bufferflies)
    ...
    -  Support dynamically adjusting the count of GC threads, with a default value of 1 [#16101](https://github.com/tikv/tikv/issues/16101) @[tonyxuqqi](https://github.com/tonyxuqqi)
...
+ TiFlash
    ...
    - Optimize the execution performance of `SEMIJOIN` and `LEFT OUTER SEMIJOIN` when only JOIN KEY equality conditions are included in `JOIN ON` [#47424](https://github.com/pingcap/tidb/issues/47424) @[gengliqi](https://github.com/gengliqi)
...
+ TiDB
    ...
    - Fix an issue that the behavior of the `ENFORCED` option in the `CHECK` constraint is inconsistent with MySQL 8.0 [#47567](https://github.com/pingcap/tidb/issues/47567) [#47631](https://github.com/pingcap/tidb/issues/47631) @[jiyfhust](https://github.com/jiyfhust)
    ...
    - Fix the issue that when `ALTER TABLE` modifies the type of a column referenced by a foreign key, the change in `DECIMAL` accuracy is not reported as an error [#49836](https://github.com/pingcap/tidb/issues/49836) @[yoshikipom](https://github.com/yoshikipom)
    ...
    - Fix the issue that in some scenarios the expression index does not find that the divisor is 0 [#50053](https://github.com/pingcap/tidb/issues/50053) @[lcwangchao](https://github.com/lcwangchao)
    <!--tw@qiancai 以下 26 条-->
    - Mitigate the issue that TiDB nodes might encounter OOM when dealing with a large number of tables [#50077](https://github.com/pingcap/tidb/issues/50077) @[zimulala](https://github.com/zimulala)
    ...
    - Fix the issue that MPP plans might not be selected when indexes on generated columns are set to be visible [#47766](https://github.com/pingcap/tidb/issues/47766) @[AilinKid](https://github.com/AilinKid)
...
+ TiKV
    ...
    - Fix the issue that TiKV might panic when gRPC threads is checking `is_shutdown` [#16236](https://github.com/tikv/tikv/issues/16236) @[pingyu](https://github.com/pingyu)
...
+ TiFlash
    ...
    - 修复在 TiDB 执行并发 DDL 遇到冲突后 TiFlash panic 的问题 Fix the TiFlash panic issue when TiFlash encounters conflicts during concurrent DDL execution [#8578](https://github.com/pingcap/tiflash/issues/8578) @[JaySon-Huang](https://github.com/JaySon-Huang)
    ...
    - Fix the bug that the `lowerUTF8` and `upperUTF8` functions do not allow characters in different cases to occupy different bytes [#8484](https://github.com/pingcap/tiflash/issues/8484) @[gengliqi](https://github.com/gengliqi)
    ...
    - Avoid printing excessive info logs for successfully executed short queries [#8592](https://github.com/pingcap/tiflash/issues/8592) @[windtalker](https://github.com/windtalker)
...
+ Tools
    ...
    + TiDB Data Migration (DM)
        ...
        <!--tw@ran-huang 3 条-->
        - Fix the issue that the "event type truncate not valid" is returned after upgrading DM [#10282](https://github.com/pingcap/tiflow/issues/10282) @[GMHDBJD](https://github.com/GMHDBJD)
        ...
        - Fix the issue of the migration task error when the downstream table structure contains `shard_row_id_bits` [#10308](https://github.com/pingcap/tiflow/issues/10308) @[GMHDBJD](https://github.com/GMHDBJD)
