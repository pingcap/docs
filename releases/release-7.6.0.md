...
| TiKV | [`gc.num-threads`](/tikv-configuration-file.md#num-threads-new-in-v658v751-and-v760) | Newly added | When `enable-compaction-filter` is set to `false`, this parameter controls the number of GC threads. The default value is `1`. |
