...
+ TiDB
    - Add new aggregate function `APPROX_COUNT_DISTINCT()` to calculate the approximate result of `COUNT(DISTINCT)`. [#18120](https://github.com/pingcap/tidb/pull/18120)
    - Support `MEMORY_QUOTA()` hint in `INSERT` statements. [#18101](https://github.com/pingcap/tidb/pull/18101)
    - Add config `enable-collect-execution-info` and session variable `tidb_enable_collect_execution_info` to control whether to collect execution information of each operator and record it in the slow query log. [#18073](https://github.com/pingcap/tidb/pull/18073), [#18072](https://github.com/pingcap/tidb/pull/18072)
    ...
    - Enable `IF()/BITXOR()/BITNEG()` to be pushed down to TiFlash Coprocessor. [#17651](https://github.com/pingcap/tidb/pull/17651)
    ...
    - Enable `JSON_LENGTH()` to be pushed down to TiFlash Coprocessor. [#17592](https://github.com/pingcap/tidb/pull/17592)
...
+ TiDB
    - Fix the incorrect execution plan when plan cache is enabled and `tidb_isolation_read_engines` is changed. [#17570](https://github.com/pingcap/tidb/pull/17570)
