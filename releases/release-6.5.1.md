...
+ TiDB
    ...
    - Fix the issue that IndexMerge plans might generate incorrect intervals on the SET type columns [#41273](https://github.com/pingcap/tidb/issues/41273) [#41293](https://github.com/pingcap/tidb/issues/41293) @[time-and-fate](https://github.com/time-and-fate)
    ...
    - Fix the issue that incorrect results might be returned when pushing down TopN operators with virtual columns to TiKV or TiFlash [#41355](https://github.com/pingcap/tidb/issues/41355) @[Dousir9](https://github.com/Dousir9)
