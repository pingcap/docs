...
On January 19, 2019, TiDB 3.0 Beta is released, corresponding to TiDB-Ansible of the v3.0.0-beta tag. TiDB 3.0 Beta builds on TiDB 2.1 with an added focus in stability, the SQL optimizer, statistics, and the execution engine.
