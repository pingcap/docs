...
On January 19, 2019, TiDB 3.0 Beta is released, corresponding to TiDB-Ansible of the master branch. TiDB 3.0 Beta builds on TiDB 2.1 with an added focus in stability, the SQL optimizer, statistics, and the execution engine.
