...
+ Tools
    ...
    + TiCDC
        ...
        - Fix the issue that TiCDC Kafka sink retries might leak Sarama client connections and background goroutines when Kafka admin or producer initialization fails, or when wrapped clients are closed [#12572](https://github.com/pingcap/tiflow/issues/12572) @[wlwilliamx](https://github.com/wlwilliamx) <!-- component: cdc --> <!-- pr: https://github.com/pingcap/tiflow/pull/12592 -->
