...
+ PD
    ...
    - Fix the issue that stale `pd_cluster_status` metrics of removed stores might remain in monitoring after TiKV scale-in, causing deleted stores to still appear in cluster status metrics [#9942](https://github.com/tikv/pd/issues/9942) @[okJiang](https://github.com/okJiang) <!-- component: pd --> <!-- pr: https://github.com/tikv/pd/pull/10188 -->
