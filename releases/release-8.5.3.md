...
+ TiDB <!--tw@qiancai: 8 notes-->
    ...
    - Add monitoring metrics for the merge sort phase when using Global Sort with indexes [#61025](https://github.com/pingcap/tidb/issues/61025) @[fzzf678](https://github.com/fzzf678)
...
+ TiDB
    ...
    - Fix the issue that causes inconsistent TiFlash query results after executing a lossy DDL [#61455](https://github.com/pingcap/tidb/issues/61455) @[Lloyd-Pottiger](https://github.com/Lloyd-Pottiger)
    - Fix the issue that GCS fails to retry on EOF errors [#59754](https://github.com/pingcap/tidb/issues/59754) @[D3Hunter](https://github.com/D3Hunter)
    ...
    - Fix the issue that after disabling metadata locking (MDL), a DDL that fails to update the schema version gets stuck [#61210](https://github.com/pingcap/tidb/issues/61210) @[wjhuang2016](https://github.com/wjhuang2016)
    ...
    - Fix the issue that an incorrect return value in the encoding logic of an aggregate expression causes queries to panic [#61735](https://github.com/pingcap/tidb/issues/61735) @[YangKeao](https://github.com/YangKeao) <!--tw@hfxsd: the following 12 notes-->    
