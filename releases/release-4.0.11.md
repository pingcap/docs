...
-   TiKV
    ...
    -   コプロセッサータスクの一時停止時間を記録する[＃9277](https://github.com/tikv/tikv/pull/9277)
    -   ロードベーススプリット[＃9354](https://github.com/tikv/tikv/pull/9354)のキー数とキーサイズのしきい値を追加します
...
-   ツール
    ...
    -   TiDB Lightning
        ...
        -   インポートプログレスバーを追加し、復元プログレスの精度を最適化します[＃506](https://github.com/pingcap/tidb-lightning/pull/506)
...
-   TiDB
    ...
    -   異なる照合の定数置換の問題を修正[＃22582](https://github.com/pingcap/tidb/pull/22582)
    ...
    -   バイナリ/文字列の長さが長すぎる場合の`WEIGHT_STRING`関数のランタイムpanicを修正します[＃22332](https://github.com/pingcap/tidb/pull/22332)
    ...
    -   [＃22136](https://github.com/pingcap/tidb/pull/22136)の不正確なランタイム統計の問題を修正し`IndexLookUp`
    -   クラスタがコンテナーにデプロイされるときに、メモリー使用量情報のキャッシュを追加する[＃22116](https://github.com/pingcap/tidb/pull/22116)
    -   デコードプランエラーの問題を修正[＃22022](https://github.com/pingcap/tidb/pull/22022)
    -   無効なウィンドウ仕様を使用した場合のエラーの報告[＃21976](https://github.com/pingcap/tidb/pull/21976)
    -   `PREPARE`ステートメントが`EXECUTE` 、または`DEALLOCATE` `PREPARE`でネストされている場合は、エラーを報告し[＃21972](https://github.com/pingcap/tidb/pull/21972)
    ...
    -   集計演算子[＃21957](https://github.com/pingcap/tidb/pull/21957)を使用する場合の結合の不明な列の問題を修正しました
    ...
    -   キー長が65536以上のJSONオブジェクトのエラーを報告する[＃21870](https://github.com/pingcap/tidb/pull/21870)
    ...
    -   サブクエリ[＃21808](https://github.com/pingcap/tidb/pull/21808)の複数のフィールドの比較の失敗を修正しました
    ...
    -   `cast`関数の強制力の値が誤って設定される問題を修正します[＃21714](https://github.com/pingcap/tidb/pull/21714)
    -   `IF`機能[＃21711](https://github.com/pingcap/tidb/pull/21711)を使用する際の予期しないpanicを修正
...
-   TiKV
    ...
    -   `region-split-check-diff`をカスタマイズできないという問題を修正します[＃9530](https://github.com/tikv/tikv/pull/9530)
...
-   PD
    ...
    -   ピアがまだあるトゥームストーンストアの削除を禁止する[＃3352](https://github.com/pingcap/pd/pull/3352)
    -   ストア制限を永続化できない問題を修正します[＃3403](https://github.com/pingcap/pd/pull/3403)
...
-   TiFlash
    ...
    -   TiDBとTiFlashの間で`0`または`NULL`で除算するという一貫性のない動作を修正します

-   ツール

    -   TiCDC

        -   `ErrTaskStatusNotExists`セッションと`capture`セッションの終了が同時に発生すると、TiCDCサービスが予期せず終了する可能性があるバグを修正します[＃1240](https://github.com/pingcap/tiflow/pull/1240)
    ...
    -   バックアップと復元（BR）
        ...
        -   BRがバックアップを復元した後にTiKVが大きなリージョンを生成する可能性がある問題を修正します[＃702](https://github.com/pingcap/br/pull/702)
