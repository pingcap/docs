...
-   ツール
    ...
    -   バックアップと復元 (BR)
        ...
        -   BRがバックアップを復元した後、TiKV が大きなリージョンを生成する可能性がある問題を修正します[#702](https://github.com/pingcap/br/pull/702)
        -   テーブルに Auto ID がない場合でもBRがテーブルの Auto ID を復元する問題を修正します[#720](https://github.com/pingcap/br/pull/720)
