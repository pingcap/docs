...
Release date: February , 2021 (TBD)
...
+ TiDB
    ...
    - Fix the issue of unknown column in join when using the aggregate operator [#21957](https://github.com/pingcap/tidb/pull/21957)
