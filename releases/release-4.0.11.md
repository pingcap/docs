...
-   TiDB
    ...
    -   `EXPLAIN`の結果と遅いログ[#21964](https://github.com/pingcap/tidb/pull/21964)のエンコーディングを統一する
...
-   ツール
    ...
    -   TiDB Lightning
        ...
        -   ソースファイルのカラム数とターゲットテーブル[#528](https://github.com/pingcap/tidb-lightning/pull/528)カラム数が一致しない場合にTiDBバックエンドがパニックするバグを修正
