...
-   ツール
    ...
    -   ティCDC
        ...
        -   TiDB または MySQL シンクにデータを複製するときに、主キー[＃8420](https://github.com/pingcap/tiflow/issues/8420) @ [趙新宇](https://github.com/zhaoxinyu)のない非 NULL ユニーク インデックスを持つ列に`CHARACTER SET`が指定されている場合に発生するデータの不整合を修正しました。
