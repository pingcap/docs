...
-   `enable-cross-table-merge = true`を変更して空のリージョンの数を減らすことにより、リージョン間のマージ機能を有効にします。 [#3129](https://github.com/tikv/pd/pull/3129)
...
-   DeltaIndex のメモリ使用量を制限して、大量のデータ ボリュームのシナリオで過剰なメモリ使用量が原因で発生するシステムメモリ(OOM) を回避します。
