...
Tools
    ...
    - TiDB Lightning
        ...
        - Fix the bug that lightning may not clean up metadata schema when some of the import contains no source files. [#28144](https://github.com/pingcap/tiflow/issues/28144)
        - Fix the bug that lighting return error if gcs url starts with gs:// [#32591](https://github.com/pingcap/tiflow/issues/32591)
