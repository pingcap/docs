...
+ TiCDC
    ...
    - Fix the replication failure occurred because the schema internally maintained in TiCDC fails to correctly handle the timing issue of read and write operations [#438](https://github.com/pingcap/ticdc/pull/438) [#450](https://github.com/pingcap/ticdc/pull/450) [#478](https://github.com/pingcap/ticdc/pull/478) [#496](https://github.com/pingcap/ticdc/pull/496)
...
+ TiFlash
    ...
    - Cache the `handle` and `version` columns to reduce of disk I/O of a single read or write request
    ...
    - Optimize the data of TiFlash chunk encode decimal
...
+ TiFlash
    ...
    - Disable the rough index optimization for the storage engine
