...
summary: TiDB 3.0.2は2019年8月7日にリリースされました。このバージョンでは、SQLオプティマイザーやSQL実行エンジン、サーバ、DDL、モニター、TiKV、PD、TiDB Ansibleなどのさまざまな部分で多くのバグが修正されています。また、TiDB BinlogやTiDB Lightningなどのツールも改善されています。
---
