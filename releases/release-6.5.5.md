...
aliases: ['/tidb/dev/release-6.5.5/','/tidb/v6.5/release-6.5.5','/tidb/v5.4/release-6.5.5','/tidb/v6.1/release-6.5.5','/tidb/v7.1/release-6.5.5','/tidb/v7.5/release-6.5.5','/tidb/v8.1/release-6.5.5']
---
...
+ Tools
    ...
    + Backup & Restore (BR)
        ...
        - Fix an error in BR integration test cases [#46561](https://github.com/pingcap/tidb/issues/46561) @[purelind](https://github.com/purelind)
