...
| TiCDC | [`changefeed-error-stuck-duration`](/ticdc/ticdc-changefeed-config.md) | Newly added | Control the duration the changefeed is allowed to automatically retry when internal errors or exceptions occur. |
