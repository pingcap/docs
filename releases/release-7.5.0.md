...
| TiKV | [`raftstore.inspect-interval`](/tikv-configuration-file.md#inspect-interval) | Modified | Modify the default value from `500ms` to `100ms` after optimizing the algorithm, which improves the sensitivity of slow node detection.|
