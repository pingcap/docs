...
| -------- | -------- | -------- | -------- |
| TiDB | [`tikv-client.copr-req-timeout-new-in-v750`](/tidb-configuration-file.md#copr-req-timeout) | Newly added | Sets the timeout of a single coprocessor request. |
