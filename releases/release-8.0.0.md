...
|--------|------------------------------|------|
| `tidb_ddl_version` | Renamed | Controls whether to enable TiDB DDL V2. To make the variable name more intuitive, starting from v8.0.0, this variable is renamed to [`tidb_enable_fast_create_table`](/system-variables.md#tidb_enable_fast_create_table-new-in-v800). |
...
| [`tidb_load_binding_timeout`](/system-variables.md#tidb_load_binding_timeout-new-in-v800) | Newly added | Controls the timeout of binding loading. If the time of binding loading exceeds this variable, it will stop. |
...
| TiDB  |  [`log.general-log-file`](/tidb-configuration-file.md#tidb_enable_collect_execution_info-new-in-v800) | Newly added | Specifies the file to save the general log to. The default is null, which means that the general log will be written to the instance file. |
