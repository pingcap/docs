...
| TiFlash | [`mark_cache_size`](/tiflash/tiflash-configuration.md) | Modified | The memory usage limit for data block meta information in TiFlash has been changed from the default value `5368709120` to `1073741824`, in order to reduce unnecessary memory usage. |
| TiFlash | [`minmax_index_cache_size`](/tiflash/tiflash-configuration.md) | Modified | The memory usage limit for the min-max index cache in TiFlash has been changed from the default value `5368709120` to `1073741824`, in order to reduce unnecessary memory usage. |
