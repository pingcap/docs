...
| TiFlash | [`mark_cache_size`](/tiflash/tiflash-configuration.md) | Modified | Change the default cache limit of the data block metadata in TiFlash from `5368709120` to `1073741824` to reduce unnecessary memory usage. |
| TiFlash | [`minmax_index_cache_size`](/tiflash/tiflash-configuration.md) | Modified | Change the default cache limit of the min-max index in TiFlash from `5368709120` to `1073741824` to reduce unnecessary memory usage. |
