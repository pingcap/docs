...
-   TiKV
    ...
    -   まれにRaftピアが休止状態に入り、ビジー状態のままになり、TiKV の再起動後にリーダー転送がブロックされる問題を修正しました[＃19203](https://github.com/tikv/tikv/issues/19203) @ [リクックスサシネーター](https://github.com/LykxSassinator)
