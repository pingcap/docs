...
+ TiDB
  <!-- tw: @hfxsd (8)-->
    ...
    - Fix the abnormal behavior when inserting a large scientific notation number to make it consistent with MySQL [#47787](https://github.com/pingcap/tidb/issues/47787) @[qw4990](https://github.com/qw4990)
  ...
  <!-- tw: @lilin90 (9)-->
    ...
    - Fix the issue that inserting an overlarge number in scientific notation returns a warning instead of an error [#47787](https://github.com/pingcap/tidb/issues/47787) @[qw4990](https://github.com/qw4990)
    - Fix the issue that the Connection Count monitoring metric is incorrect when some connections exit before the handshake is complete [#54428](https://github.com/pingcap/tidb/issues/54428) @[YangKeao](https://github.com/YangKeao)
