...
| [`tidb_allow_tiflash_cop`](/system-variables.md#tidb_allow_tiflash_cop-new-in-v730) | Newly added | Used to select the protocol for generating execution plans when TiDB sends computation tasks to TiFlash. |
