...
|--------|------------------------------|------|
| [`enable-32bits-connection-id`](/system-variables.md#enable-32bits-connection-id-new-in-v730) | Newly added | Controls whether to enable the 32-bit connection ID feature. |
