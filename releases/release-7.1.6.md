...
-   TiDB
    ...
    -   TiDBがチェックポイント[＃53009](https://github.com/pingcap/tidb/issues/53009) @ [lance6716](https://github.com/lance6716)から復元する前にローカルファイルの存在を確認しない問題を修正しました
    -   DMスキーマトラッカーがデフォルトの長さ[＃55138](https://github.com/pingcap/tidb/issues/55138) @ [lance6716](https://github.com/lance6716)よりも長いインデックスを作成できない問題を修正しました
...
-   TiKV
    ...
    -   大きなテーブルやパーティション[＃17304](https://github.com/tikv/tikv/issues/17304) @ [SpadeA-Tang](https://github.com/SpadeA-Tang)を削除した後に発生する可能性のあるトラフィック制御の問題を修正しました
    ...
    -   TiKVインスタンスに多数のリージョンがある場合、データインポート[＃16229](https://github.com/tikv/tikv/issues/16229) @ [SpadeA-Tang](https://github.com/SpadeA-Tang)中にTiKVがOOMになる可能性がある問題を修正しました。
...
-   PD
    ...
    -   リソース グループが過剰なログ[＃8159](https://github.com/tikv/pd/issues/8159) @ [nolouch](https://github.com/nolouch)を出力する問題を修正しました
...
-   TiFlash
    ...
    -   データベース[＃7296](https://github.com/pingcap/tiflash/issues/7296) @ [JaySon-Huang](https://github.com/JaySon-Huang)間で`ALTER TABLE ... EXCHANGE PARTITION`を実行した後にTiFlash がスキーマの同期に失敗する可能性がある問題を修正しました
    ...
    -   空のキー範囲を持つクエリがTiFlash上で読み取りタスクを正しく生成できず、 TiFlashクエリ[＃9108](https://github.com/pingcap/tiflash/issues/9108) @ [JinheLin](https://github.com/JinheLin)がブロックされる可能性がある問題を修正しました。
...
-   ツール
    ...
    -   TiCDC
        ...
        -   `TIMEZONE`タイプのデフォルト値が正しいタイムゾーン[＃10931](https://github.com/pingcap/tiflow/issues/10931) @ [3AceShowHand](https://github.com/3AceShowHand)に従って設定されない問題を修正
