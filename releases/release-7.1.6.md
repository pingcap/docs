...
-   ティドブ
    ...
    -   同期負荷QPSモニタリングメトリックが正しくない問題を修正[＃53558](https://github.com/pingcap/tidb/issues/53558) @ [ホーキングレイ](https://github.com/hawkingrei)
    ...
    -   SQLが実行プラン[＃50988](https://github.com/pingcap/tidb/issues/50988) @ [Cbcウェストウルフ](https://github.com/CbcWestwolf)を構築できない場合に監査ログフィルタリングが有効にならない問題を修正
