...
summary: TiDB 4.0.2は2020年7月1日にリリースされました。このバージョンでは、機密情報の削除や新しい機能の追加が行われました。例えば、INSERTステートメントでMEMORY_QUOTA()ヒントのサポートやTLS証明書のSANフィールドに基づく認証のサポートなどがあります。さらに、バグの修正や改善点も含まれています。
---
