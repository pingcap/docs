...
+ Server
    ...
    + Add the [HTTP API](https://github.com/pingcap/tidb/blob/release-8.1/docs/tidb_http_api.md)
...
+ DDL
    ...
    - [Support using the `ddl/owner/resign` HTTP interface to release the DDL owner and start electing a new DDL owner](https://github.com/pingcap/tidb/blob/release-8.1/docs/tidb_http_api.md)
...
+ Coprocessor
    ...
    - [Add Coprocessor `ReadPool` to improve the concurrency in processing the requests](https://github.com/tikv/rfcs/blob/release-8.1/text/0010-read-pool.md)
...
+ Transaction
    ...
    - [Add the `UnsafeDestroyRange` API to support to collecting space for the dropping table/index](https://github.com/tikv/rfcs/blob/release-8.1/text/0002-unsafe-destroy-range.md)
