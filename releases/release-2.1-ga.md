...
+ SQL executor
    ...
    - Support using the [`EXPLAIN ANALYZE` statement](/common/sql-statements/sql-statement-explain-analyze.md) to check the runtime statistics including the execution time and the number of returned rows of each operator
