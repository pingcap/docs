...
| [`max_execution_time`](/system-variables.md#max_execution_time) | Modified | Before v6.5.0, this variable takes effect on all types of statements. Starting from v6.5.0, this variable only controls the maximum execution time of read-only statements. |
