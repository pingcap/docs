...
- TiDB
    ...
    - `ALTER TABLE.. ADD INDEX`文を実行する際に TiDB panicが発生する問題を修正[#27687](https://github.com/pingcap/tidb/issues/27687)
...
- PD
    ...
    - ターゲットストアがダウンしているため、スケジューリングオペレーターが迅速に失敗できない問題を修正しました[#3353](https://github.com/tikv/pd/issues/3353)
