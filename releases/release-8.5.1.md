...
Starting from v8.5.1, TiDB resumes the support for CentOS Linux 7. If you plan to deploy TiDB version 8.5 or upgrade your cluster to this version, ensure you use TiDB v8.5.1 or a later version.
