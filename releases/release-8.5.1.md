...
- TiDB
    ...
    - パーティションテーブルの レンジ INTERVAL 構文糖衣が`MINUTE`間隔として使用できない問題を修正 [#57698](https://github.com/pingcap/tidb/issues/57698) @[mjonss](https://github.com/mjonss)
...
- PD
    ...
    - `tidb_enable_tso_follower_proxy`システム変数が有効になっている場合に PD がpanicする可能性がある問題を修正しました [#8950](https://github.com/tikv/pd/issues/8950) @[okJiang](https://github.com/okJiang)
    - `evict-leader-scheduler` が同じストア ID で繰り返し作成された場合に正しく動作しない問題を修正しました。 [#8756](https://github.com/tikv/pd/issues/8756) @[okJiang](https://github.com/okJiang)
