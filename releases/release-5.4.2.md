...
> **Warning:**
>
> It is not recommended to use v5.4.2, because this version has an known bug. For details, see [#12934](https://github.com/tikv/tikv/issues/12934). This bug is planned to be fixed in the upcoming v5.4.3.
