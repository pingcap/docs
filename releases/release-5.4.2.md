...
> **Warning:**
>
> v5.4.2 には既知のバグがあるため、使用は推奨されません。詳細は [#12934](https://github.com/tikv/tikv/issues/12934) をご覧ください。このバグは v5.4.3 で修正されています。 [バージョン5.4.3](/releases/release-5.4.3.md)の使用を推奨します。
