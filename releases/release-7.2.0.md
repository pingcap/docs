...
aliases: ['/tidb/dev/release-7.2.0/','/tidb/v7.2/release-7.2.0','/tidb/v5.4/release-7.2.0','/tidb/v6.1/release-7.2.0','/tidb/v6.5/release-7.2.0','/tidb/v7.1/release-7.2.0','/tidb/v7.5/release-7.2.0','/tidb/v8.1/release-7.2.0']
---
...
+ Tools
    ...
    + TiCDC
        ...
        - Fix the issue that TiCDC cannot create a changefeed with a downstream Kafka-on-Pulsar [#8892](https://github.com/pingcap/tiflow/issues/8892) @[hi-rustin](https://github.com/Rustin170506)
