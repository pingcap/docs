...
summary: TiDB 5.0.5は2021年12月3日にリリースされました。バージョン5.0.5では、TiKVのバグが修正されています。複数のキーで呼び出された場合に`GcKeys`タスクが動作しない問題が修正されました。この問題が原因で、圧縮フィルターGCがMVCC削除情報を削除しない可能性があります。
---
