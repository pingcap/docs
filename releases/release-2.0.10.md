...
summary: TiDB 2.0.10は2018年12月18日にリリースされました。このリリースでは、システムの互換性と安定性が大幅に向上しています。TiDBには多くの修正が含まれており、DDLジョブのキャンセルによる問題やUNION句の結果の長さが正しくない場合の問題などが修正されています。PDとTiKVにもそれぞれ問題の修正が含まれています。
---
