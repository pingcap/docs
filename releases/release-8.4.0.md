...
| TiKV                     | [`raft-engine.spill-dir`](/tikv-configuration-file.md#spill-dir-new-in-v840)                                             | 新しく追加された | TiKVインスタンスがRaftログファイルを保存するセカンダリディレクトリを制御し、 Raftログファイルのマルチディスクstorageをサポートします。                                                                                                           |
...
-   [Kafka1991](https://github.com/kafka1991) (初投稿者)
