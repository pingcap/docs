...
- TiDB
    ...
    - [オプティマイザ修正制御 47400](/optimizer-fix-controls.md#47400-new-in-v840)の使用をサポートし、オプティマイザが`estRows`の推定最小値を`1` 。これは、Oracle や Db2 などのデータベースと一貫性があります [#47400](https://github.com/pingcap/tidb/issues/47400) @[terry1purcell](https://github.com/terry1purcell)
