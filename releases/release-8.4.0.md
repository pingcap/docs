...
| TiFlash | [`storage.format_version`](/tiflash/tiflash-configuration.md) | Modified | The default value is changed from `5` to `7`, which allows the format to support the creation and storage of vector indexes.|
