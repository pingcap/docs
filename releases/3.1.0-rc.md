...
+ TiDB
    ...
    - Add `AUTO_RANDOM` ID cache for retrying statement and recovering table [#15393](https://github.com/pingcap/tidb/pull/15393)
    ...
    - Add a feature of automatically reading data from different roles according to the load balancing policy and add the leader-and-follower system variable to enable this feature [#15721](https://github.com/pingcap/tidb/pull/15721)
...
+ TiDB
    ...
    - Fix the issue that fails to check whether the current ReadEngine contains TiKV server when generating the execution plan using `Index Scan` [#15773](https://github.com/pingcap/tidb/pull/15773)
...
+ PD
    ...
    - Fix the issue that the placement rule is overwritten by another placement rule with the same startKey and endKey [#2222](https://github.com/pingcap/pd/pull/2222)
