...
On May 10, 2019, TiDB 3.0.0 RC1 is released. The corresponding TiDB-Ansible version is 3.0.0 RC1. Compared with TiDB 3.0.0 Beta.1, this release has greatly improved the stability, usability, features, the SQL optimizer, statistics, and the execution engine.
