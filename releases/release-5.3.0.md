...
| :---------- | :----------- | :----------- |
| [tidb_enable_noop_functions](/system-variables.md#tidb_enable_noop_functions-new-in-v40) | Modified |  No longer controls the `CREATE TEMPORARY TABLE` and `DROP TEMPORARY TABLE` behaviors. |
