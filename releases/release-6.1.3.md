...
<<<<<<< HEAD
        - Change the default value of [`transaction-atomicity`](/ticdc/manage-ticdc.md#configure-sink-uri-with-mysqltidb) from `table` to `none` to improve stability [#7505](https://github.com/pingcap/tiflow/issues/7505) @[asddongmen](https://github.com/asddongmen)
=======
...
>>>>>>> eadd88353 (add the reason for changing the default value (#11659))
