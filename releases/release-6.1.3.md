...
+ Tools
    ...
    + TiCDC
        ...
        - Fix the issue that the sink module gets stuck if the downstream network is unavailable [#7706](https://github.com/pingcap/tiflow/issues/7706) @[hicqu](https://github.com/hicqu)
