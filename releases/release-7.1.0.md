...
| TiKV | [`region-compact-min-redundant-rows`](/tikv-configuration-file.md#region-compact-min-redundant-rows) | Newly added | The number of redundant MVCC rows required to trigger RocksDB compaction. The default value is `50000`. |
| TiKV | [`region-compact-redundant-rows-percent`](/tikv-configuration-file.md#region-compact-redundant-rows-percent) | Newly added | The percentage of redundant MVCC rows required to trigger RocksDB compaction. The default value is `20`. |
