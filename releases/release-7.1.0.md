...
To learn about the performance of TiDB v7.1.0, you can refer to the [TPC-C performance test report](https://docs.tidb.io/tidbcloud/v7.1.0-performance-benchmarking-with-tpcc) and [Sysbench performance test report](https://docs.tidb.io/tidbcloud/v7.1.0-performance-benchmarking-with-sysbench) of the TiDB Cloud Dedicated cluster.
