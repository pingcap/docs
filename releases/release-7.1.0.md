...
| TiCDC | [`only-output-updated-columns`](/ticdc/ticdc-changefeed-config.md#ticdc-changefeed-配置文件说明) | Newly added | Controls whether only output updated columns to downstream                                                                                                                                                                                                                                                          |
