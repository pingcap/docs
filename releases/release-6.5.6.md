...
+ TiDB **tw@ran-huang --19 条**
    ...
    - Fix the issue that the result might be incorrect when calculating `COUNT(INT)` in MPP [#48643](https://github.com/pingcap/tidb/issues/48643) @[AilinKid](https://github.com/AilinKid)
    ...
    - Fix the issue that the result might be incorrect when pushing down predicates to common table expressions [#47881](https://github.com/pingcap/tidb/issues/47881) @[winoros](https://github.com/winoros)
    ...
    - Fix the issue of TiDB node panicking when DDL jobID is restored to 0 [#46296](https://github.com/pingcap/tidb/issues/46296) @[jiyfhust](https://github.com/jiyfhust)
