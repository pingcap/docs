...
- DDL
    ...
    - デフォルトでハッシュパーティションを有効にし、パーティション定義に列が1つしかない場合はレンジ列パーティションを有効にします[#9936](https://github.com/pingcap/tidb/pull/9936)
...
- TiDB Lightning
    ...
    - `tidb.pd-addr`と`tidb.port`が提供されていない場合は自動的に検出することで、必要な設定項目を削減します[#173](https://github.com/pingcap/tidb-lightning/pull/173)
