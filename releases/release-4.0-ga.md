...
- TiDB
    ...
    - パーティションテーブルで`admin check index` 、 `admin cleanup index` 、 `admin recover index`サポート [＃17392](https://github.com/pingcap/tidb/pull/17392) [＃17405](https://github.com/pingcap/tidb/pull/17405) [＃17317](https://github.com/pingcap/tidb/pull/17317)
