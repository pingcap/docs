...
+ Tools
    ...
    + TiCDC
        ...
        - Add changefeed checkpoint catch-up estimated time of arrival (ETA) in metrics [#5232](https://github.com/pingcap/tiflow/issues/5232)
...
+ Tools
    ...
    + TiCDC
        ...
        - (dup: release-5.4.0.md > Bug fixes> Tools> TiCDC)- Fix the issue that the `cached region` monitoring metric is negative [#4300](https://github.com/pingcap/tiflow/issues/4300)
