...
-   ティドブ
    ...
    -   `UPDATE` `INSERT`ステートメント`DELETE IGNORE` @ [ヤンケオ](https://github.com/YangKeao)で外部キーエラー[＃56678](https://github.com/pingcap/tidb/issues/56678)省略されない問題を修正
...
-   TiKV
    ...
    -   読み取りスレッドがRaft Engine[＃17383](https://github.com/tikv/tikv/issues/17383) @ [リクックスサシネーター](https://github.com/LykxSassinator)のMemTable内の古いインデックスにアクセスしたときに発生するpanic問題を修正しました。
