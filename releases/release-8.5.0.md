...
| TiKV | [`in-memory-engine.gc-run-interval`](/tikv-configuration-file.md#gc-run-interval-new-in-v850) | Newly added | Controls the time interval that the in-memory engine GC caches MVCC versions. The default value is `"3m"`.|
