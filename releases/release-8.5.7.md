...
+ TiDB
    ...
    - すべて、データベース単位、またはテーブル単位のスコープについて、保留中のオプティマイザ統計 delta を永続化する `FLUSH STATS_DELTA` 文をサポートしました。[#65668](https://github.com/pingcap/tidb/issues/65668) @[0xPoe](https://github.com/0xPoe)
