...
+ TiDB
    ...
    - [`FLUSH STATS_DELTA`](https://docs.pingcap.com/tidb/v8.5/sql-statement-flush-stats-delta) 文をサポートし、クラスター、データベース単位、またはテーブル単位のスコープについて、保留中のオプティマイザ統計 delta を永続化できるようにしました。[#65668](https://github.com/pingcap/tidb/issues/65668) @[0xPoe](https://github.com/0xPoe)
