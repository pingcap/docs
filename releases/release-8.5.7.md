...
+ TiDB
    ...
    - 代替インデックスが存在する場合に `IndexMerge` を考慮するためのoptimizer fix control をデフォルトで有効にし、より多くの適用可能なクエリで TiDB が `IndexMerge` プランを選択できるようにして、クエリ最適化を改善しました。[#26764](https://github.com/pingcap/tidb/issues/26764) @[time-and-fate](https://github.com/time-and-fate)
