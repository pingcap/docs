...
- ツール
    ...
    - TiDB Lightning
        ...
        - `black-white-list`を廃止し、より新しくて分かりやすいフィルター形式を導入します [#332](https://github.com/pingcap/tidb-lightning/pull/332)
...
- TiDB
    ...
    - `ADMIN REPAIR TABLE`文の実行で TiDB ノードのテーブルメタデータの再ロードに失敗する問題を修正しました。 [#18323](https://github.com/pingcap/tidb/pull/18323)
    ...
    - `IndexHashJoin`と`IndexMergeJoin`ワーカーがpanicしたときにOOMエラーを返す[#18527](https://github.com/pingcap/tidb/pull/18527)
