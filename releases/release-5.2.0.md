...
+ TiDB
    ...
    - Add a new status variation `last_plan_binding_update_time` status variation to view the timestamp corresponding to the binding cache in the current TiDB instance. [#26340](https://github.com/pingcap/tidb/pull/26340)
