...
-   PD
    ...
    -   HTTPクライアント[＃8142](https://github.com/tikv/pd/issues/8142) @ [Jmポテト](https://github.com/JmPotato)の再試行ロジックを改善する
...
-   ティドブ
    ...
    -   関連するサブクエリがある場合にウィンドウ関数がpanic可能性がある問題を修正[＃42734](https://github.com/pingcap/tidb/issues/42734) @ [ハイ・ラスティン](https://github.com/hi-rustin)
    ...
    -   自動統計収集中にシステム変数`tidb_enable_async_merge_global_stats`と`tidb_analyze_partition_concurrency`有効にならない問題を修正[＃53972](https://github.com/pingcap/tidb/issues/53972) @ [ハイ・ラスティン](https://github.com/hi-rustin)
