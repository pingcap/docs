...
-   PD
    ...
    -   HTTPクライアント[＃8142](https://github.com/tikv/pd/issues/8142) @ [JmPotato](https://github.com/JmPotato)の再試行ロジックを改善する
...
-   TiDB
    ...
    -   `root`ユーザーが`tidb_mdl_view` [＃53292](https://github.com/pingcap/tidb/issues/53292) @ [tangenta](https://github.com/tangenta)を照会できない問題を修正
...
-   TiKV
    ...
    -   キャッシュエントリが永続化される前に解放すると TiKV がpanic[＃17040](https://github.com/tikv/tikv/issues/17040) @ [glorv](https://github.com/glorv)を起こす問題を修正しました
...
-   PD
    ...
    -   `Filter`監視メトリック[＃8098](https://github.com/tikv/pd/issues/8098) @ [nolouch](https://github.com/nolouch)でデータが欠落している問題を修正しました
...
-   ツール
    ...
    -   TiCDC
        ...
        -   アップストリーム[＃11371](https://github.com/pingcap/tiflow/issues/11371) @ [lidezhu](https://github.com/lidezhu)で新しい照合順序が無効になっている場合、TiCDC がクラスター化インデックス テーブルの主キーを正しくデコードできない問題を修正しました。
