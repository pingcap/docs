...
- The query accesses temporary tables, or a table that contains generated columns, or uses static mode (`tidb_partition_prune_mode` is `static`) to access partitioning tables.
