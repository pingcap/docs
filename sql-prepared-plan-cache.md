...
Currently, the execution plan cache is disabled by default. You can enable this feature by setting the system variable `tidb_enable_prepared_plan_cache` to `ON`.
