...
[Partitioning](/partitioned-table.md) refers to physically split a table into smaller table partitions, this can be done by four different partition methods RANGE, LIST, HASH and KEY partitioning.
