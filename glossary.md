...
[Partitioning](/partitioned-table.md) refers to physically splitting a table into smaller table partitions, which can be done by partition methods such as RANGE, LIST, HASH, and KEY partitioning.
