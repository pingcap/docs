...
PD Control (pd-ctl) is a command-line tool to interface with the placement driver (PD) of the cluster. This can be used to obtain cluster status information and configuration and modify the cluster. For more information, see [PD Control User Guide](/pd-control.md).
