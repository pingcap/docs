...
> **Note：**
> The implementation of *Placement Rules in SQL* depends on *placement rules feature* of PD, refer [Configure Placement Rules](/configure-placement-rules.md)。In the context of Placement Rules in SQL，*placement rules* may be referred to *placement policies* attached to other objects, or rules that sent from TiDB to PD.
