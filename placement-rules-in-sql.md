...
- Support the physical isolation of computing resources between different users, which meets the isolation requirements of different users within an instance, and the isolation requirements of CPU, I/O, memory, and other resources with different mixed loads
...
* In TiDB v6.1.0 and v6.1.1, TiFlash learners are not configurable through Placement Rules syntax.
