...
* `tidb_runaway_quarantined_watch`: the most recently active quarantined watch rules for runaway queries (contains currently valid rules, and possibly also contains recently expired rules)
