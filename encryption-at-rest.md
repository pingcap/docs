...
To create a key on Azure, refer to the instructions in [Set and retrieve keys in Azure Key Vault using Azure portal](https://learn.microsoft.com/en-us/azure/key-vault/keys/quick-create-portal).
