...
2. Create a changefeed to replicate incremental data to Kafka:
    ...
    ```shell
<<<<<<< HEAD
    tiup ctl:v6.1.2 cdc changefeed create --pd="http://127.0.0.1:2379" --sink-uri="kafka://127.0.0.1:9092/kafka-topic-name?protocol=canal-json" --changefeed-id="kafka-changefeed" --config="changefeed.conf"
=======
...
>>>>>>> 58015a654 (add version to tiup ctl (2) (#11186))
    ...
    ```shell
<<<<<<< HEAD
    tiup ctl:v6.1.2 cdc changefeed create --pd="http://127.0.0.1:2379" --sink-uri="kafka://127.0.0.1:9092,127.0.0.2:9092,127.0.0.3:9092/kafka-topic-name?protocol=canal-json&partition-num=3&replication-factor=1&max-message-bytes=1048576" --config="changefeed.conf"
=======
...
3. After creating the changefeed, run the following command to check the changefeed status:
    ...
    ```shell
<<<<<<< HEAD
    tiup ctl:v6.1.2 cdc changefeed list --pd="http://127.0.0.1:2379"
=======
