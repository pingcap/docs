...
summary: TiDB 4.0の新機能であるロードベースの分割は、ホットスポットの問題を解決するために導入されました。この機能は、読み取りリクエストの負荷が特定のリージョンに集中する場合に自動的にリージョンを分割し、アクセス負荷のバランスをとります。また、この機能はデフォルトで有効になっていますが、パラメータを変更することも可能です。
---
