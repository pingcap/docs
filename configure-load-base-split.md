...
Load Base Split is enabled by default, but the parameter is set to a rather low value, defaulting to `3000`. If you want to disable this feature, set the threshold high enough.
