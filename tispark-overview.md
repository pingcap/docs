...
| `spark.tispark.stale_read`                      | optional         | The stale read timestamp(ms). see [here](https://github.com/pingcap/tispark/blob/master/docs/features/stale_read.md) for more detail                                                                                                                                                                                                                                                                                                                |
