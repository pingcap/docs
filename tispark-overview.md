...
aliases: ['/docs/dev/tispark-overview/','/docs/dev/reference/tispark/','/docs/dev/get-started-with-tispark/','/docs/dev/how-to/get-started/tispark/','/docs/dev/how-to/deploy/tispark/','tidb/dev/get-started-with-tispark/','/zh/tidb/stable/get-started-with-tispark']
---
