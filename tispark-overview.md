...
| `spark.tispark.replica_read` | `leader` | The type of replica to read. The value options are `leader`, `follower`, and `learner`. Multiple types can be specified at the same time and TiSpark selects according to the order. |
