...
aliases: ['/docs/stable/command-line-flags-for-pd-configuration/','/docs/v4.0/command-line-flags-for-pd-configuration/','/docs/stable/reference/configuration/pd-server/configuration/']
---
