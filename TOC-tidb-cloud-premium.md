...
- 管理 {{{ .premium }}} 实例
  - [创建 {{{ .premium }}} 实例](/tidb-cloud/premium/create-tidb-instance-premium.md)
  - 连接到你的 {{{ .premium }}} 实例
    - [网络连接概述](/tidb-cloud/premium/connect-to-tidb-instance.md)
    - [通过 Public Endpoint 连接](/tidb-cloud/premium/connect-to-premium-via-public-connection.md)
  ...
  - [备份和恢复 TiDB Cloud 数据](/tidb-cloud/premium/backup-and-restore-premium.md)
  - [从 {{{ .premium }}} 导出数据](/tidb-cloud/premium/premium-export.md)
  - 使用 TiFlash 实现 HTAP
  ...
  - [删除 {{{ .premium }}} 实例](/tidb-cloud/premium/delete-tidb-instance.md)
- 迁移或导入数据
  ...
  - 将数据导入 TiDB Cloud
    ...
    - [从云存储导入 CSV 文件](/tidb-cloud/premium/import-csv-files-premium.md)
    - [从 Amazon S3 导入 CSV 文件](/tidb-cloud/premium/import-from-s3-premium.md)
    - [从云存储导入 Parquet 文件](/tidb-cloud/import-parquet-files-serverless.md)
    - [从云存储导入快照文件](/tidb-cloud/import-snapshot-files-serverless.md)
    - [使用 MySQL CLI 导入](/tidb-cloud/premium/import-with-mysql-cli-premium.md)
  - 参考
...
- 安全
  ...
  - 审计管理
    - [数据库审计日志](/tidb-cloud/premium/tidb-cloud-auditing-premium.md)
...
- SQL 参考
  ...
  - SQL 语句
    ...
    - [`CANCEL DISTRIBUTION JOB` 语句](/sql-statements/sql-statement-cancel-distribution-job.md)
    ...
    - [`DISTRIBUTE TABLE` 语句](/sql-statements/sql-statement-distribute-table.md)
    ...
    - [`SHOW DISTRIBUTION JOBS` 语句](/sql-statements/sql-statement-show-distribution-jobs.md)
    ...
    - [`SHOW TABLE DISTRIBUTION` 语句](/sql-statements/sql-statement-show-table-distribution.md)
