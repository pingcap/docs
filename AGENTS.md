...
1. Use `.ai/README.md` as the map of the repo-local AI guidance.
...
Read `.ai/README.md` first when you need the current layout of repo-local AI guidance.
...
- `create-or-update-doc-translation-pr`: create or update an EN -> ZH translation PR that maps an English docs change or incremental source update to `pingcap/docs-cn`, using the bundled scripts in `.ai/skills/create-or-update-doc-translation-pr/scripts/` when applicable
...
- For translation PR creation or update workflows, prefer the script-backed process in `.ai/skills/create-or-update-doc-translation-pr/`.
