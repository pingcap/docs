...
Note: DDL operations are not transactions. You don't need corresponding COMMIT statements when executing DDL.
...
Note: UPDATE and DELETE without WHERE filter operate on the entire table.
