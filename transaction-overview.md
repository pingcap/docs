...
TiDB supports distributed transactions using either [pessimistic](/pessimistic-transaction.md) or [optimistic](/optimistic-transaction.md) transaction modes. Starting from TiDB 3.0.8, TiDB uses the pessimistic transaction mode by default.
