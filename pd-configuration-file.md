...
+ Default value: Starting from v7.2.0, the default value is changed from `false` to `true`. If your cluster is upgraded from a version earlier than v7.2.0 to v7.2.0 or later, the default value does not change.
