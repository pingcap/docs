...
> **Warning:** 
>
> Starting from TiDB v8.3.0, the `INL_MERGE_JOIN` hint is deprecated because it might return incorrect results. Do not use this hint in new queries. It might be removed in a future release.
