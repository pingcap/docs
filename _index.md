...
[TiDB Configuration File](https://docs.pingcap.com/tidb/dev/tidb-configuration-file)

[TiDB Configuration Options](https://docs.pingcap.com/tidb/dev/command-line-flags-for-tidb-configuration)
