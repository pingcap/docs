...
[TiDB Self-Managedとは](https://docs.pingcap.com/tidb/v8.5/overview)
...
[TiUPを使用して TiDBクラスターをデプロイ](https://docs.pingcap.com/tidb/v8.5/production-deployment-using-tiup)

[Kubernetes に TiDBクラスターをデプロイ](https://docs.pingcap.com/tidb-in-kubernetes/stable)
...
[クラスターのアップグレード](https://docs.pingcap.com/tidb/v8.5/upgrade-tidb-using-tiup)

[クラスターのスケール](https://docs.pingcap.com/tidb/v8.5/scale-tidb-using-tiup)

[クラスターデータのバックアップと復元](https://docs.pingcap.com/tidb/v8.5/backup-and-restore-overview)
...
[TiDB設定ファイルのパラメータ](https://docs.pingcap.com/tidb/v8.5/tidb-configuration-file)
