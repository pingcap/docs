...
| Type       | Upper limit   |
|:----------|:----------|
| Size       | 6 MB by default. You can adjust the size limit via the [`txn-entry-size-limit`](/tidb-configuration-file.md#txn-entry-size-limit-span-class"version-mark"new-in-v50span) configuration item. |
