...
> **Warning:**
>
> When disabling Titan for TiDB versions earlier than v8.5.0, it is not recommended to update the TiKV configuration item [`rocksdb.titan.enabled`](/tikv-configuration-file.md#enabled) to `false` to avoid TiKV crashes. Following Step 1 is sufficient to disable Titan.
