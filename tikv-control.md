...
Damaged SST files in TiKV might cause the TiKV process to panic. Before TiDB v6.1.0, it causes TiKV to panic at once. Since TiDB v6.1.0, the TiKV process will panic 1 hour after SST files are damaged.
