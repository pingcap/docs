...
- If you only need to [collect statistics on some columns](/statistics.md#collect-statistics-of-some-columns) of some partitions in a table, use the following syntax:
