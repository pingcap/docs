...
| [`tidb_enable_stats_owner`](/system-variables.md#tidb_enable_stats_owner-new-in-v840) | `ON` | This variable controls whether the corresponding TiDB instance can run automatic statistics update tasks. |
