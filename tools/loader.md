...
```
  ...
  -status-addr string: the pprof address of Loader. It can also be used by Prometheus to pull Loader metrics
...
# The pprof address of Loader. It can also be used by Prometheus to pull Loader metrics.
status-addr = ":8272"
