...
### Step 3: Configure and restart the DM-master service
...
Edit the `inventory.ini` file, comment or delete the line where the old DM-master instance exists, and add the information of the new DM-master instance.
