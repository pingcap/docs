...
> - Generally, all the following upgrade examples assume that all the data replication tasks have been paused before upgrade and all the replication tasks are restarted manually after DM upgrade is finished.
