...
For details about the precheck feature, see [Precheck the upstream MySQL instance configuration](/tools/dm/precheck.md#precheck-the-upstream-mysql-instance-configuration).
