...
- `subdir`: 
    ...
    - After [a switch between master and slave instances](../tools/data-migration-cluster-operations.md#switch-between-master-and-slave-instances) in the upstream, DM-worker generates a new `subdir` directory with an incremental serial number.
