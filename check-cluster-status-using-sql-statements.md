...
- [`TIDB_INDEXES`](/reference/system-databases/information-schema.md#tidb_indexes-table)
- [`ANALYZE_STATUS`](/reference/system-databases/information-schema.md#analyze_status-table)
- [`TIDB_HOT_REGIONS`](/reference/system-databases/information-schema.md#tidb_hot_regions-table)
- [`TIKV_STORE_STATUS`](/reference/system-databases/information-schema.md#tikv_store_status-table)
- [`TIKV_REGION_STATUS`](/reference/system-databases/information-schema.md#tikv_region_status-table)
- [`TIKV_REGION_PEERS`](/reference/system-databases/information-schema.md#tikv_region_peers-table)
...
- The feature of `SHOW ANALYZE STATUS` is the same with that of [the `ANALYZE_STATUS` table](/reference/system-databases/information-schema.md#analyze_status-table).
