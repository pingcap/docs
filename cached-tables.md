...
- The data volume of the table is small, for example, below 4 MiB.
...
- The table is frequently accessed, and you expect a better read performance, for example, when facing hotspots on small tables while directly reading from TiKV.
