...
To enable log redaction in the DM-worker, set the value of [`log.redact-info-log`](/dm/dm-workeriguration-file.md#redact-info-log-new-in-v90) to `true`. This configuration value defaults to `false`, which means that log redaction is disabled.
