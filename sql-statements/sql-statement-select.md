...
|:--------------------- | :-------------------------------------------------- |
|`TableOptimizerHints`| This is the hint to control the behavior of TiDB's optimizer. You can refer to [Optimizer Hints](/optimizer-hints.md) for more information. |
...
|`Window window_definition`| This is the grammar for window function which is usually used to do some analytical computation. You can refer to [Window Function](/functions-and-operators/window-functions.md) for more information. |
