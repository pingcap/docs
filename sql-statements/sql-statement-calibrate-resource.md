...
- [Estimate capacity based on actual workload](##estimate-capacity-based-on-actual-workload) feature requires `SELECT` privilege for all tables in the `METRICS_SCHEMA` schema.
