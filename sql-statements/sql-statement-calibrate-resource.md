...
Because TiKV does not monitor CPU usage on macOS, it reports an error that the corresponding monitoring data is empty, as shown in the following example.
