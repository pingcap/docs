...
aliases: ['/docs/stable/sql-statements/sql-statement-flush-status/','/docs/v4.0/sql-statements/sql-statement-flush-status/','/docs/stable/reference/sql/statements/flush-status/']
---
