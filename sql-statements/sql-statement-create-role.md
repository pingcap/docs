...
The `CREATE ROLE` statement in TiDB is fully compatible with roles, which are a feature of MySQL 8.0. If you find any compatibility differences, report them via [an issue on GitHub](https://github.com/pingcap/tidb/issues/new/choose).
