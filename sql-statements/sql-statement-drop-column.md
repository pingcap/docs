...
aliases: ['/docs/stable/sql-statements/sql-statement-drop-column/','/docs/v4.0/sql-statements/sql-statement-drop-column/','/docs/stable/reference/sql/statements/drop-column/']
---
