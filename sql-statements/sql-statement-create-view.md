...
* At present, any view in TiDB cannot be inserted or updated (that is, INSERT VIEW and UPDATE VIEW are not supported). `WITH CHECK OPTION` only does syntax compatibility but does not take effect.
