...
The `FLASHBACK` execution progress can be viewed via the [Raft admin > Peer in Flashback State](/grafana-tikv-dashboard.md#raft-admin) metrics and the log. The following is an example:
