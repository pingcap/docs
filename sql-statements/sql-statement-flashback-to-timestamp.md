...
> **Warning:**
>
> The `FLASHBACK CLUSTER TO TIMESTAMP` syntax is not applicable to [TiDB Serverless](/tidb-cloud/select-cluster-tier.md#serverless-tier-beta) clusters. Do not execute this statement on TiDB Serverless clusters to avoid unexpected results.
