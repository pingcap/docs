...
> **Warning:**
>
> When you use this feature in TiDB v7.1.0, some Regions might not be finished after the FLASHBACK operation. It is recommended to avoid using this feature in v7.1.0. For more information, see issue [#44292](https://github.com/pingcap/tidb/issues/44292).
>
