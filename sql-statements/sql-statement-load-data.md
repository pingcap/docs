...
-   `DEFINED NULL BY 'my-null'`ように`DEFINED NULL BY`を使用すると、 `my-null` NULL 値と見なされます。
-   `DEFINED NULL BY ... OPTIONALLY ENCLOSED`を使用する場合、 `DEFINED NULL BY 'my-null' OPTIONALLY ENCLOSED` 、 `my-null` 、 `"my-null"` ( `ENCLOSED BY '"`仮定) は NULL 値と見なされます。
