...
- `ADD INDEX`:
    ...
    - `MAX_WRITE_SPEED`: the maximum bandwidth limit for importing index records from each TiDB node to each TiKV node. The initial value is set by [`tidb_ddl_reorg_max_write_speed`](/system-variables.md#tidb_ddl_reorg_max_write_speed-new-in-v6512-v755-and-v850).
