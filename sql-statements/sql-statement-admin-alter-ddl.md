...
- `ADD INDEX`:
  ...
  For v8.5.4 and earlier TiDB  versions, the preceding parameters only work for `ADD INDEX` jobs that are submitted and running after [`tidb_enable_dist_task`](/system-variables.md#tidb_enable_dist_task-new-in-v710) is disabled.
