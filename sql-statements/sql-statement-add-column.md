...
- 新しい列を追加するときに`PRIMARY KEY`または`UNIQUE INDEX`を`GLOBAL`として指定して[グローバルインデックス](/global-indexes.md)を設定することは、 [パーティションテーブル](/partitioned-table.md)の TiDB 拡張であり、MySQL と互換性がありません。
