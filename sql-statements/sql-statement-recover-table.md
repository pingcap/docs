...
aliases: ['/docs/stable/sql-statements/sql-statement-recover-table/','/docs/v4.0/sql-statements/sql-statement-recover-table/','/docs/stable/reference/sql/statements/recover-table/']
---
