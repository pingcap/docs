...
aliases: ['/docs/stable/sql-statements/sql-statement-drop-table/','/docs/v4.0/sql-statements/sql-statement-drop-table/','/docs/stable/reference/sql/statements/drop-table/']
---
