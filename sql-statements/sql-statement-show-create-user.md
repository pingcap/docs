...
aliases: ['/docs/stable/sql-statements/sql-statement-show-create-user/','/docs/v4.0/sql-statements/sql-statement-show-create-user/','/docs/stable/reference/sql/statements/show-create-user/']
---
