...
aliases: ['/docs/stable/sql-statements/sql-statement-add-index/','/docs/v4.0/sql-statements/sql-statement-add-index/','/docs/stable/reference/sql/statements/add-index/','/docs/v4.0/reference/sql/statements/add-index/']
---
