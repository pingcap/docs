...
このステートメントは、TiDB システム データベース内のユーザーアカウントのユーザーパスワードを変更します。
...
TiDBの`SET PASSWORD`文はMySQLと完全に互換性があります。互換性に違いがある場合は、 [バグを報告してください](https://docs.pingcap.com/tidb/stable/support)。
