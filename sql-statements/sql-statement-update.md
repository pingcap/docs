...
This statement is expected to be fully compatible with MySQL. If you find any compatibility difference, [reported it via an issue](https://github.com/pingcap/tidb/issues/new/choose) on GitHub.
