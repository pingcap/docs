...
* Does not support modifying some data types (for example, some TIME types, Bit, Set) are not supported due to some compatibility issues of the `cast` function's behavior between TiDB and MySQL.
