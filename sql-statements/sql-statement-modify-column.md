...
aliases: ['/docs/stable/sql-statements/sql-statement-modify-column/','/docs/v4.0/sql-statements/sql-statement-modify-column/','/docs/stable/reference/sql/statements/modify-column/']
---
