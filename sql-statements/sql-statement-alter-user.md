...
aliases: ['/docs/stable/sql-statements/sql-statement-alter-user/','/docs/v4.0/sql-statements/sql-statement-alter-user/','/docs/stable/reference/sql/statements/alter-user/']
---
