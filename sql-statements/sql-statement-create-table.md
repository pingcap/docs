...
aliases: ['/docs/stable/sql-statements/sql-statement-create-table/','/docs/v4.0/sql-statements/sql-statement-create-table/','/docs/stable/reference/sql/statements/create-table/']
---
