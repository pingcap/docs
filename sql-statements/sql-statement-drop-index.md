...
aliases: ['/docs/stable/sql-statements/sql-statement-drop-index/','/docs/v4.0/sql-statements/sql-statement-drop-index/','/docs/stable/reference/sql/statements/drop-index/']
---
