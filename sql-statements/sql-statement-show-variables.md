...
aliases: ['/docs/stable/sql-statements/sql-statement-show-variables/','/docs/v4.0/sql-statements/sql-statement-show-variables/','/docs/stable/reference/sql/statements/show-variables/']
---
