...
aliases: ['/docs/stable/sql-statements/sql-statement-explain-analyze/','/docs/v4.0/sql-statements/sql-statement-explain-analyze/','/docs/stable/reference/sql/statements/explain-analyze/']
---
