...
aliases: ['/docs/stable/sql-statements/sql-statement-show-warnings/','/docs/v4.0/sql-statements/sql-statement-show-warnings/','/docs/stable/reference/sql/statements/show-warnings/']
---
