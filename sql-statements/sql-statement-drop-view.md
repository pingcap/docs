...
aliases: ['/docs/stable/sql-statements/sql-statement-drop-view/','/docs/v4.0/sql-statements/sql-statement-drop-view/','/docs/stable/reference/sql/statements/drop-view/']
---
