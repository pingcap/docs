...
- `IMPORT INTO` does not support importing data into an empty partition while other partitions of the same table already contain data. The target table must be entirely empty for import operations.
