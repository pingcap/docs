...
| SQLステートメント                                                                  | 説明                                            |
| --------------------------------------------------------------------------- | --------------------------------------------- |
| [`BACKUP`](/sql-statements/sql-statement-backup.md)                         | TiDBクラスターの分散バックアップを実行します。                      |
...
| [`SHUTDOWN`](/sql-statements/sql-statement-shutdown.md)                 | クライアントに接続されているTiDBインスタンスを停止します。TiDBクラスター全体を停止するわけではありません。                                                                                                                |
