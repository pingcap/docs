...
| [`CALIBRATE RESOURCE`](/sql-statements/sql-statement-calibrate-resource.md) | Estimates and outputs the [`Request Unit (RU)`](/tidb-resource-control#what-is-request-unit-ru) capacity of the current cluster. |
