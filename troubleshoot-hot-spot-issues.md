...
## Using TiKV MVCC In-Memory Engine to mitigate read hotspots caused by high MVCC read amplification

During long GC times or frequent updates and deletions, read hotspots may occur due to scanning a large number of MVCC versions. To alleviate this type of hotspot, you can enable the in-memory engine feature, see [TiKV MVCC In-Memory Engine](/tikv-in-memory-engine.md) for details.
