...
- Disk spill for the Sort, MergeJoin, and HashJoin operators is introduced in v4.0.0; disk spill for the non-concurrent algorithm of the HashAgg operator is introduced in v5.2.0; disk spill for the concurrent algorithm of the HashAgg operator is introduced in v8.0.0 and becomes a feature for general availability(GA) since v8.2.0. You can enable or disable the parallel HashAgg spill function by setting system variable [`tidb_enable_concurrent_hashagg_spill`](https://docs.pingcap.com/tidb/stable/system-variables#tidb_enable_concurrent_hashagg_spill-new-in-v800). This system variable will be deprecated in the future.
