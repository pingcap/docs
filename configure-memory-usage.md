...
- Disk spill for the Sort, MergeJoin, and HashJoin operators is introduced in v4.0.0; disk spill for the non-concurrent algorithm of the HashAgg operator is introduced in v5.2.0; disk spill for the concurrent algorithm of the HashAgg operator is introduced in v8.0.0 and becomes GA in v8.2.0. User could close or open parallel HashAgg spill function by system variable `tidb_enable_parallel_hashagg_spill`(This is a temporary system variable and will be deleted in the future).
