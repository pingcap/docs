...
**Attention**：In a mixed deployment scenario, the tidb_server_memory_limit should be the memory usage threshold for a single tidb-server instance, instead of the total memory threshold for the whole physical machine memory.
