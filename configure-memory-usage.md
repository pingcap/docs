...
- Disk spill for the Sort, MergeJoin, and HashJoin operator is introduced in v4.0.0; disk spill for the non-concurrent HashAgg operator is introduced in v5.2.0; disk spill for the concurrent HashAgg operator is introduced in v7.6.0.
