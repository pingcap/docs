...
- Determines whether to enable `global kill` feature. To enable this feature, set the value of this configuration item to `true`. When enabled, this feature can safely kill any connection even when TiDB servers are behind a load balancer.
- Default value: false
