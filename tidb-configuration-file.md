...
### `table-column-count-limit` <span class="version-mark">v5.0の新機能</span> {#table-column-count-limit-new-in-v5-0}

-   単一テーブル内の列数の上限を設定します。
-   デフォルト値: `1017`
-   現在、有効な値の範囲は`[1017, 4096]`です。

### `index-limit` <span class="version-mark">v5.0で追加</span> {#index-limit-new-in-v5-0}
...
### `enable-tcp4-only` <span class="version-mark">v5.0の新機能</span> {#enable-tcp4-only-new-in-v5-0}
...
### `enable-enum-length-limit` <span class="version-mark">v5.0で追加</span> {#enable-enum-length-limit-new-in-v5-0}
...
### `graceful-wait-before-shutdown` <span class="version-mark">（v5.0の新機能）</span> {#graceful-wait-before-shutdown-new-in-v5-0}
...
### <code>txn-entry-size-limit</code><span class="version-mark">は v4.0.10 および v5.0.0 で追加されました。</span> {#txn-entry-size-limit-new-in-v4010-and-v500}
