...
+ Currently, the valid value range is `[0, 128]`. The value 0 means the automatic mode, which adjusts concurrency based on the configuration of the server. Before v8.2.0, the minimum value is 1.
