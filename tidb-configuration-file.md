...
+ The certificate file path, which is used by [TiProxy](/tiproxy-overview.md) for session migration.
+ Default value: ""
...
+ The key file path used by [TiProxy](/tiproxy-overview.md) for session migration.
+ Default value: ""
