...
+ When [`IMPORT INTO`](/sql-statements/sql-statement-import-into.md) is used to import data, the sorted data are at first stored in the TiDB local temporary directory, and then imported into TiKV in batches.
