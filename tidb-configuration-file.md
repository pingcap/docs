...
+ For scenarios with conflicts, after enabling this configuration, TiDB includes the auto-commit transactions into the global lock-waiting management, which avoids dead locks and mitigates the latency spike brought by deadlock-causing conflicts.
