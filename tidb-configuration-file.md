...
- Determines whether to enable `global kill` feature. Set the value of this configuration item to `true` to enable this feature. When enabled, this feature can safely kill any connection even when TiDB servers are behind a load balancer.
- Default value: false
