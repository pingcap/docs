...
- Default value: `false`.
- Enabling this option is useful when TiDB is used with LVS for load balancing since the `toa` module can correctly parse the real client IP from the TCP header.
