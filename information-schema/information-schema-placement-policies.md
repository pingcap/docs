...
summary: PLACEMENT_POLICIES表は、すべての配置ポリシーに関する情報を提供します。TiDBサーバーレスクラスターでは使用できません。12行の情報が含まれており、配置ポリシーのみが表示されます。代わりにSHOW PLACEMENTステートメントを使用すると、正規バージョンの配置ルールが表示されます。また、テーブルt3を含むすべての情報を表示することもできます。
---
