...
| [`PLACEMENT_POLICIES`](/information-schema/information-schema-placement-policies.md)    | Provides information on all objects that have explicit placement rules assigned. |
