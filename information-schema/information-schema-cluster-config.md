...
aliases: ['/docs/stable/system-tables/system-table-cluster-config/','/docs/v4.0/system-tables/system-table-cluster-config/','/docs/stable/reference/system-databases/cluster-config/','/tidb/stable/system-table-cluster-config/','/tidb/v4.0/system-table-cluster-config/']
---
