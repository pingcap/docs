...
-   `STATUS_ADDRESS` : HTTP APIのサービスアドレス。tikv-ctl、pd-ctl、tidb-ctlの一部のコマンドはこのAPIとこのアドレスを使用する場合があります。このアドレスを使用して、クラスタの詳細情報を取得することもできます。詳細は[TiDB HTTP API ドキュメント](https://github.com/pingcap/tidb/blob/release-8.1/docs/tidb_http_api.md)を参照してください。
