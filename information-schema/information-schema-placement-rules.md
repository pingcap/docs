...
The `PLACEMENT_RULES` table provides information on all explicitly configured [placement rules](/placement-rules.md). This includes both placement policies, and directly attached rules.
