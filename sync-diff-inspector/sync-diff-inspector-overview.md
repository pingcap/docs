...
+ Binary package. Click [tidb-community-toolkit-v5.3.0-linux-amd64](https://download.pingcap.org/tidb-community-toolkit-v5.3.0-linux-amd64.tar.gz) to download.
