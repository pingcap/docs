...
aliases: ['/docs/stable/sync-diff-inspector/sync-diff-inspector-overview/','/docs/v4.0/sync-diff-inspector/sync-diff-inspector-overview/','/docs/stable/reference/tools/sync-diff-inspector/overview/','/docs/v4.0/reference/tools/sync-diff-inspector/overview/']
---
...
This guide introduces the key features of sync-diff-inspector and describes how to configure and use this tool. You can download it at [tidb-community-toolkit-v4.0.16-linux-amd64](https://download.pingcap.org/tidb-community-toolkit-v4.0.16-linux-amd64.tar.gz).
