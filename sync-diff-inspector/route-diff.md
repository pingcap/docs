...
aliases: ['/docs/stable/sync-diff-inspector/route-diff/','/docs/v4.0/sync-diff-inspector/route-diff/','/docs/stable/reference/tools/sync-diff-inspector/route-diff/']
---
