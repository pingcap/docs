...
- Throttle duration: The duration that the execution of the scheduler requests is blocked when flow control is triggered due to too many L0 files. If this metric has values, it indicates that flow control exists.
...
- Txn command throttled duration: The block duration for commands related to transactions due to throttling. Under normal circumstances, this metric is 0.
- Non-txn command throttled duration: The block duration for other commands due to throttling. Under normal circumstances, this metric is 0.
