...
- Transaction
    ...
    - Transaction Types Per Seconds: the number of transactions per second using the two-phase commit (2PC), async commit, and one-phase commit (1PC) mechanisms, including both success and failure numbers
