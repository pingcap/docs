...
- Use [Dumpling](https://docs.pingcap.com/zh/tidb/stable/dumpling-overview) to export a historical snapshot. Dumpling performs well in exporting larger sets of data.
</CustomContent>
