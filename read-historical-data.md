...
aliases: ['/docs/v2.1/read-historical-data/','/docs/v2.1/how-to/get-started/read-historical-data/']
---
...
In TiDB, Garbage Collection (GC) runs periodically to remove the obsolete data versions. For GC details, see [TiDB Garbage Collection (GC)](/garbage-collection.md)
