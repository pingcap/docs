...
- [TiDB in Kubernetes documentation for TiDB Operator 1.2](https://docs.pingcap.com/tidb-in-kubernetes/v1.2/)
- [TiDB in Kubernetes documentation for TiDB Operator 1.1](https://docs.pingcap.com/tidb-in-kubernetes/v1.1/)