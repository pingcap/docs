...
Unlike traditional Offline DDL, which locks database objects and blocks user modifications until the DDL operation is completed. TiDB does not support Offline DDL.
