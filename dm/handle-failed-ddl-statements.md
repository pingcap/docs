...
2.  `query-status <task-name>`使用してタスクのステータス`shard_table_2`表示すると、MySQL インスタンス 1 の`shard_table_2`テーブルと MySQL インスタンス`shard_db_2`の`shard_db_1`テーブルによって報告された次のエラーを確認できます。
