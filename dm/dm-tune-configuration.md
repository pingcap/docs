...
> - `mydumpers` . `threads`は、簡単にするために`mydumper-thread`設定項目に置き換えることができます。
...
> - `loaders` . `pool-size`は、簡単にするために`loader-thread`設定項目に置き換えることができます。
...
> - `syncers` . `worker-count`は、簡単にするために`syncer-thread`設定項目に置き換えることができます。
