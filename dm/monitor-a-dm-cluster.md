...
| storage残り                    | リレーログが占めるディスクの残りストレージ容量                                                         | 該当なし | 該当なし   |
...
| storage残り                 | リレーログが占有するディスクの残りストレージ容量                                    | 値が10G未満になるとアラートが必要になります                                                         | 致命的    |
...
| storage残り                 | リレーログが占めるディスク内の残りのストレージ容量                                   | 値が10G未満になるとアラートが発生します                                                           | 致命的    |
