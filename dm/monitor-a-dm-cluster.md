...
| メトリック名                      | 説明                                          | 警告                               | 重大度レベル |
| :-------------------------- | :------------------------------------------ | :------------------------------- | :----- |
| 1分あたりのDMマスター開始リーダーコンポーネントの数 | DM マスターがリーダー関連コンポーネントを有効にしようとする 1分あたりの試行回数 | 該当なし                             | 該当なし   |
| 異なる状態のワーカーの数                | 異なる状態のDMワーカーの数                              | 一部の DM ワーカーが 1時間以上オフラインになっています  | 致命的    |
| ワーカーの状態                     | DMワーカーの状態                                   | 該当なし                             | 該当なし   |
