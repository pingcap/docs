...
| total bytes for load unit | The bytes processed in the parsing, generating data KV, and generating index KV stages of the import process by the load unit | N/A | N/A |
