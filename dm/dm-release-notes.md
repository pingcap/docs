...
summary: TiDBデータ移行リリースノートは、DM v5.4以降、TiDBリリースノートに統合されました。v5.4以降のDMリリースノートについては、対応するTiDBリリースノートを参照してください。v5.3.0以前のDMリリースノートについては、バージョン5.3、2.0、および1.0のリンクを参照してください。
---

# TiDBデータ移行リリースノート {#tidb-data-migration-release-notes}

DM v5.4以降、TiDBデータ移行のリリースノートは、同バージョンのTiDBリリースノートに統合されました。
