...
詳しい設定方法については[上流データベース設定ファイル](/dm/dm-source-configuration-file.md)参照してください。
...
設定項目`enable-relay`設定方法については[上流データベース設定ファイル](/dm/dm-source-configuration-file.md)参照してください。
