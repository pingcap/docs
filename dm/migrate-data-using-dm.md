...
[TiUP を使用して DM クラスターをデプロイする](/dm/deploy-a-dm-cluster-using-tiup.md)におすすめです。トライアルまたはテスト用に[バイナリを使用して DM クラスターを展開する](/dm/deploy-a-dm-cluster-using-binary.md)を使用することもできます。
...
1.  MySQL-1 関連の情報を`conf/source1.yaml`に書き込みます。
