...
-   `class` ：エラータイプ。
    ...
    | `dm-worker`       | DM-労働者サービス                              | `[code=40066:class=dm-worker:scope=internal:level=high] ExecuteDDL timeout, try use query-status to query whether the DDL is still blocking`                                                                                                                                                     |
