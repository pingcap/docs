...
![DM benchmark](/media/dm/dm-benchmark-01-en.png)

#### TiDB key indicator monitor

![TiDB transaction's OPS and duration](/media/dm/dm-benchmark-02-en.png)
![TiDB's query duration and QPS](/media/dm/dm-benchmark-03-en.png)
