...
summary: TiUPを使用してDMクラスターを管理する方法についてのドキュメントです。TiUPを使用してDMコンポーネントのヘルプ情報を表示し、クラスターのリストを表示する方法、クラスターを開始する方法、クラスターのステータスを確認する方法、クラスターをスケールインする方法、クラスターをスケールアウトする方法、ローリングアップグレードの方法、構成を更新する方法、コンポーネントを更新する方法、DM-Ansibleを使用してデプロイされたDM 1.0クラスターをインポートおよびアップグレードする方法、操作ログを表示する方法、DMクラスター内のホストでコマンドを実行する方法、dmctlの使用方法、システムのネイティブSSHクライアントを使用してクラスターに接続する方法について説明されています。
---
