...
- Description:
    ...
    When the relay log processing unit encounters a non-autorecoverable error (for example, binlog file not found), or when it encounters multiple recoverable errors in a short period of time (for example, network problems), this unit moves to `Paused` state, and an alert is triggered immediately.
...
- Description:
    ...
    When the Dump processing unit encounters a non-autorecoverable error (for example, binlog file not found), or when it encounters multiple recoverable errors in a short period of time (for example, network problems), this unit moves to the `Paused` state, and an alert is triggered immediately.
...
- Description:
    ...
    When the Load processing unit encounters a non-autorecoverable error (for example, binlog file not found), or when it encounters multiple recoverable errors in a short period of time (for example, network problems), this unit moves to the `Paused` state, and an alert is triggered immediately.
...
- Description:
    ...
    When the binlog replication processing unit encounters a non-autorecoverable error (for example, binlog file not found), or when it encounters multiple recoverable errors in a short period of time (for example, network problems), this unit moves to the `Paused` state, and an alert is triggered immediately.
