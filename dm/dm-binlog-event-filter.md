...
If you need to block and report errors on DDL statements generated by some upstream operations before the DM replicates data to TiDB, you can use the following settings:
