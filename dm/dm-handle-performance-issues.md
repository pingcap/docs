...
Before diagnosing an issue, you can refer to the [DM 2.0-GA Benchmark Report](https://github.com/pingcap/docs-dm/blob/release-5.3/en/dm-benchmark-v5.3.0.md).
