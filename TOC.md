    ...
    -   ベクトル検索
        ...
        -   統合
            ...
            -   ORMライブラリ
                ...
                -   [ジャンゴ](/vector-search/vector-search-integrate-with-django-orm.md)
...
-   ストリームデータ
    ...
    -   参照
        ...
        -   [TiCDC の互換性](/ticdc/ticdc-compatibility.md)
...
-   チュートリアル
    ...
    -   PDマイクロサービスを使用する
        ...
        -   [TiUPを使用して PD マイクロサービス ノードをスケールする](/scale-microservices-using-tiup.md)
...
-   TiDBツール
    ...
    -   TiProxy
        ...
        -   [交通リプレイ](/tiproxy/tiproxy-traffic-replay.md)
...
-   参照
    ...
    -   SQL
        ...
        -   データ型
            ...
            -   [ベクトル型](/vector-search/vector-search-data-types.md)
        -   関数と演算子
