...
+ Reference
  ...
  + SQL
    ...
    + SQL Statements
      ...
      + [`ADMIN (BINDINGS)`](/sql-statements/sql-statement-admin-bindings.md)
      + [`ADMIN CANCEL DDL`](/sql-statements/sql-statement-admin-cancel-ddl.md)
      + [`ADMIN CHECKSUM TABLE`](/sql-statements/sql-statement-admin-checksum-table.md)
      + [`ADMIN CHECK [TABLE|INDEX]`](/sql-statements/sql-statement-admin-check-table-index.md)
      + [`ADMIN PLUGINS`](/sql-statements/sql-statement-admin-plugins.md)
      + [`ADMIN RECOVER INDEX`](/sql-statements/sql-statement-admin-recover-index.md)
      + [`ADMIN RELOAD`](/sql-statements/sql-statement-admin-reload.md)
      + [`ADMIN REPAIR TABLE`](/sql-statements/sql-statement-admin-repair-table.md)
      + [`ADMIN SHOW DDL`](/sql-statements/sql-statement-admin-show-ddl.md)
      + [`ADMIN SHOW SLOW`](/sql-statements/sql-statement-admin-show-slow.md)
