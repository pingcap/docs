...
- TiDB Tools
  ...
  - TiDB Lightning
    ...
    - Physical Import Mode
      - [Overview](/tidb-lightning/tidb-lightning-physical-import-mode.md)
      - [Requirements and Limitations](/tidb-lightning/tidb-lightning-physical-import-mode.md#必要条件及限制)
      - [Configuration and Usage](/tidb-lightning/tidb-lightning-physical-import-mode-usage.md#配置及使用)
      - [冲突数据检测](/tidb-lightning/tidb-lightning-physical-import-mode-usage.md#冲突数据检测)
      - [Performance Tuning](/tidb-lightning/tidb-lightning-physical-import-mode-usage.md#性能调优)
    - Logical Import Mode
      - [Overview](/tidb-lightning/tidb-lightning-logical-import-mode.md)
      - [Requirements and Limitations](/tidb-lightning/tidb-lightning-logical-import-mode.md#必要条件及限制)
      - [Configuration and Usage](/tidb-lightning/tidb-lightning-logical-import-mode-usage.md#配置及使用)
      - [冲突数据检测](/tidb-lightning/tidb-lightning-logical-import-mode-usage.md#冲突数据检测)
      - [Performance Tuning](/tidb-lightning/tidb-lightning-logical-import-mode-usage.md#性能调优)
    ...
    - References
      ...
      - [Command Line Parameters](/tidb-lightning/tidb-lightning-command-line-full.md)
      - [Monitor and Alerts](/tidb-lightning/monitor-tidb-lightning.md)
