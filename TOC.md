...
- Application Develop
  - Quick Start
    ...
    - [CRUD SQL in TiDB](/develop/dev-tidb-crud-sql.md)
    - Build a Simple CRUD App with TiDB
      - [Java](/develop/dev-sample-application-java.md)
  - Developer
    - [Overview](/develop/dev-overview.md)
  ...
  - Connect to TiDB
    ...
    - [Connection Pools and Connection Parameter](/develop/dev-connection-parameters.md)
  - Database Schema Design
    - [Overview](/develop/dev-schema-design-overview.md)
    - [Create a Database](/develop/dev-create-database.md)
    - [Create a Table](/develop/dev-create-table.md)
    - [Create Secondary Indexes](/develop/dev-create-secondary-indexes.md)
  - Write Data
    - [Insert Data](/develop/dev-insert-data.md)
    - [Update Data](/develop/dev-unstable-result-set.md)
    - [Delete Data](/develop/dev-delete-data.md)
    - [Prepared Statement](/develop/dev-prepared-statement.md)
  - Read Data
    - [Get Data from Single Table](/develop/dev-get-data-from-single-table.md)
    - [Multi-table Join Queries](/develop/dev-join-tables.md)
    - [Subqueries](/develop/dev-use-subqueries.md)
    - [Paginate Results](/develop/dev-paginate-results.md)
    - [Views](/develop/dev-use-views.md)
    - [Temporary Tables](/develop/dev-use-temporary-tables.md)
    - [Common Table Expression](/develop/dev-use-common-table-expression.md)
    - Read Replica Data
      - [Follower Read](/develop/dev-use-follower-read.md)
      - [Stale Read](/develop/dev-use-stale-read.md)
    - [HTAP Queries](/develop/dev-hybrid-oltp-and-olap-queries.md)
  - Transaction
    - [Overview](/develop/dev-transaction-overview.md)
    - [Optimistic and Pessimistic Transaction](/develop/dev-optimistic-and-pessimistic-transaction.md)
    - [Transaction Restraints](/develop/dev-transaction-restraints.md)
    - [Transaction Troubleshoot](/develop/dev-transaction-troubleshoot.md)
  - Optimize
    - [Overview](/develop/dev-optimize-sql-overview.md)
    - [SQL Optimize](/develop/dev-optimize-sql.md)
    - [Best Practices](/develop/dev-optimize-sql-best-practices.md)
    - Others
      - [Implicit Type Conversion](/develop/dev-implicit-type-conversion.md)
      - [Unique Serial Number Generation](/develop/dev-unique-serial-number-generation.md)
  - Troubleshoot
    - [Overview](/develop/dev-troubleshoot-overview.md)
    - Others
      - [Unstable Result Set](/develop/dev-unstable-result-set.md)
      - [Timeouts](/develop/dev-timeouts-in-tidb.md)
  - Reference
    - SQL
      - [Bookshop Example Application](/develop/dev-bookshop-schema-design.md)
    - Guidelines
      - [Object Naming Guidelines](/develop/dev-object-naming-guidelines.md)
      - [SQL Development Specification](/develop/dev-sql-development-specification.md)
- Deploy
