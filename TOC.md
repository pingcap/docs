...
>>>>>>> a8a6903... tools: update binlog slave to binlog consumer (#3522)
+ Reference
  + SQL
  ...
  + Configuration
    ...
    + pd-server
      - [Configuration Flags](/pd-configuration-file.md)
    + tikv-server
      - [Configuration Flags](/tikv-configuration-file.md)
  + Security
  ...
  - [Garbage Collection (GC)](/garbage-collection.md)
  + Performance
