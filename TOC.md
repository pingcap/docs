...
+ Reference
  ...
  + SQL
    ...
    + Data Types
      ...
      + Numeric Types
        - [`BIT`](dev/reference/sql/data-types/numeric.md#bit)
        - [`BOOL|BOOLEAN`](dev/reference/sql/data-types/numeric.md#boolean)
        - [`TINYINT`](dev/reference/sql/data-types/numeric.md#tinyint)
        - [`SMALLINT`](dev/reference/sql/data-types/numeric.md#smallint)
        - [`MEDIUMINT`](dev/reference/sql/data-types/numeric.md#mediumint)
        - [`INT|INTEGER`](dev/reference/sql/data-types/numeric.md#integer)
        - [`BIGINT`](dev/reference/sql/data-types/numeric.md#bigint)
        - [`SERIAL`](dev/reference/sql/data-types/numeric.md#serial)
        - [`DECIMAL`](dev/reference/sql/data-types/numeric.md#decimal)
        - [`FLOAT`](dev/reference/sql/data-types/numeric.md#float)
        - [`DOUBLE`](dev/reference/sql/data-types/numeric.md#double)
      + Date and Time Types
        - [`DATE`](dev/reference/sql/data-types/date-and-time.md#date)
        - [`DATETIME`](dev/reference/sql/data-types/date-and-time.md#datetime)
        - [`TIMESTAMP`](dev/reference/sql/data-types/date-and-time.md#timestamp)
        - [`TIME`](dev/reference/sql/data-types/date-and-time.md#time)
        - [`YEAR`](dev/reference/sql/data-types/date-and-time.md#year)
      + String Types
        - [`CHAR`](dev/reference/sql/data-types/string.md#char)
        - [`VARCHAR`](dev/reference/sql/data-types/string.md#varchar)
        - [`TEXT`](dev/reference/sql/data-types/string.md#text)
        - [`LONGTEXT`](dev/reference/sql/data-types/string.md#longtext)
        - [`BINARY`](dev/reference/sql/data-types/string.md#binary)
        - [`VARBINARY`](dev/reference/sql/data-types/string.md#varbinary)
        - [`TINYBLOB`](dev/reference/sql/data-types/string.md#tinyblob)
        - [`BLOB`](dev/reference/sql/data-types/string.md#blob)
        - [`MEDIUMBLOB`](dev/reference/sql/data-types/string.md#mediumblob)
        - [`LONGBLOB`](dev/reference/sql/data-types/string.md#longblob)
        - [`ENUM`](dev/reference/sql/data-types/string.md#enum)
        - [`SET`](dev/reference/sql/data-types/string.md#set)
