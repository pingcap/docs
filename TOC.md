  ...
  + SQL
    ...
    + Data Types
      ...
      + [Numeric Types](dev/reference/sql/data-types.md#numeric-types)
        - [`BIT`](dev/reference/sql/data-types/bit.md)
        - [`BOOL|BOOLEAN`](dev/reference/sql/data-types/boolean.md)
        - [`TINYINT`](dev/reference/sql/data-types/tinyint.md)
        - [`SMALLINT`](dev/reference/sql/data-types/smallint.md)
        - [`MEDIUMINT`](dev/reference/sql/data-types/mediumint.md)
        - [`INT|INTEGER`](dev/reference/sql/data-types/integer.md)
        - [`BIGINT`](dev/reference/sql/data-types/bigint.md)
        - [`SERIAL`](dev/reference/sql/data-types/serial.md)
        - [`DECIMAL`](dev/reference/sql/data-types/decimal.md)
        - [`FLOAT`](dev/reference/sql/data-types/float.md)
        - [`DOUBLE`](dev/reference/sql/data-types/double.md)
      + [Date and Time Types](dev/reference/sql/data-types.md#date-and-time-types)
        - [`DATE`](dev/reference/sql/data-types/date.md)
        - [`DATETIME`](dev/reference/sql/data-types/datetime.md)
        - [`TIMESTAMP`](dev/reference/sql/data-types/timestamp.md)
        - [`TIME`](dev/reference/sql/data-types/time.md)
        - [`YEAR`](dev/reference/sql/data-types/year.md)
      + [String Types](dev/reference/sql/data-types.md#string-types)
        - [`CHAR`](dev/reference/sql/data-types/char.md)
        - [`VARCHAR`](dev/reference/sql/data-types/varchar.md)
        - [`TEXT`](dev/reference/sql/data-types/text.md)
        - [`LONGTEXT`](dev/reference/sql/data-types/longtext.md)
        - [`BINARY`](dev/reference/sql/data-types/binary.md)
        - [`VARBINARY`](dev/reference/sql/data-types/varbinary.md)
        - [`TINYBLOB`](dev/reference/sql/data-types/tinyblob.md)
        - [`BLOB`](dev/reference/sql/data-types/blob.md)
        - [`MEDIUMBLOB`](dev/reference/sql/data-types/mediumblob.md)
        - [`LONGBLOB`](dev/reference/sql/data-types/longblob.md)
        - [`ENUM`](dev/reference/sql/data-types/enum.md)
        - [`SET`](dev/reference/sql/data-types/set.md)
      - [`JSON`](dev/reference/sql/data-types/json.md)
