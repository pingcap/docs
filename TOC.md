...
- Reference
  ...
  - SQL
    ...
    - SQL Statements
      ...
      - [`创建 MASKING POLICY`](/sql-statements/sql-statement-create-masking-policy.md)
      ...
      - [`刷新 STATS`](/sql-statements/sql-statement-refresh-stats.md)
      ...
      - [`显示 MASKING POLICIES`](/sql-statements/sql-statement-show-masking-policies.md)
