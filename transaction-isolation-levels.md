...
category: reference
aliases: ['/docs/v3.1/reference/transactions/transaction-isolation/']
---
...
> **Note:**
>
> In the default configuration of TiDB v3.1, the automatic transaction retry is disabled. For how this feature influences the isolation level and how to enable it, see [automatic retry](/optimistic-transaction.md#automatic-retry).
