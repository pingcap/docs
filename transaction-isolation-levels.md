...
> **Note:**
>
> In the default configuration of TiDB v3.1, the automatic transaction retry is disabled. For how this feature influences the isolation level and how to enable it, see [automatic retry](/reference/transactions/transaction-optimistic.md#automatic-retry).
