...
This is the [recommended](https://help.openai.com/en/articles/8984345-which-distance-function-should-i-use) function to use with embeddings created by OpenAI.
