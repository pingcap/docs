...
TiDB Cloud provides some connection examples in the **Connect** > **Dev Tools** dialog. You can follow the instructions in [Connect via standard connection](/tidb-cloud/connect-via-standard-connection.md) to connect to a TiDB Serverless Tier cluster.
