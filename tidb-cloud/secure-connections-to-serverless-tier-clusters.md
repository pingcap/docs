...
TiDB Serverless Tier supports TLS 1.2 and TLS 1.3. TLS 1.0 and TLS 1.1 are not supported due to security reasons. For background, refer to IETF [Deprecating TLS 1.0 and TLS 1.1](https://datatracker.ietf.org/doc/rfc8996/).
