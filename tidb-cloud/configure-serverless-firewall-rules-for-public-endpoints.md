...
summary: 了解如何安全地为 TiDB Cloud Starter 或 TiDB Cloud Essential 实例配置和管理具有公共访问权限的防火墙规则。
---
...
- 只有指定的 IP 地址可以访问你的 TiDB Cloud Starter 或 Essential 实例。  
    ...
    - 你可以在 TiDB Cloud Starter 或 Essential 实例创建后更新允许的 IP 地址。  
...
如果你的 TiDB Cloud Starter 实例托管在 AWS 上，你可以参考官方 [AWS IP address list](https://docs.aws.amazon.com/vpc/latest/userguide/aws-ip-ranges.html) 启用来自 **所有 AWS IP 地址** 的访问。
