...
TiDB Cloud is a fully-managed Database-as-a-Service (DBaaS) that brings the flexibility and power of [TiDB](/overview.md), an open-source HTAP (Hybrid Transactional and Analytical Processing) database, to Google Cloud and AWS.
