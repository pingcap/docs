...
4. TiDB Serverless lets you create [branches](/tidb-cloud/branch-overview.md). You can choose to connect to each branch via **branch** drop-down list. `main` represents the cluster itself.
