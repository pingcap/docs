...
4. TiDB Serverless lets you create [branches](/tidb-cloud/branch-overview.md). You can choose to connect to a branch via the **Branch** drop-down list. `main` represents the cluster itself.
