...
4. TiDB Cloud lets you create [branches](/tidb-cloud/branch-overview.md) for your MySQL-compatible {{{ .starter }}} or {{{ .essential }}} instance. After a branch is created, you can choose to connect to the branch via the **Branch** drop-down list. `main` represents the {{{ .starter }}} or Essential instance itself.
