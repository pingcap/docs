...
- Each [vector](/tidb-cloud/vector-search-search-search-data-types.md) supports up to 16383 dimensions.
...
See [Vector search restrictions](/tidb-cloud/vector-search-search-search-index.md#restrictions).
