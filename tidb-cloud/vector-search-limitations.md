...
- Each [vector](/tidb-cloud/vector-search-search-data-types.md) supports up to 16383 dimensions.
...
See [Vector search restrictions](/tidb-cloud/vector-search-search-index.md#restrictions).
