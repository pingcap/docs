...
summary: {{{ .starter }}} または {{{ .essential }}} クラスターを作成する方法を学びます。
---

# {{{ .starter }}} または Essential クラスタを作成する {#create-a-starter-or-essential-cluster}

このドキュメントでは、 [TiDB Cloudコンソール](https://tidbcloud.com/)で {{{ .starter }}} または {{{ .essential }}} クラスターを作成する方法について説明します。
...
ロール`Organization Owner`または`Project Owner`の場合は、次のように {{{ .starter }}} または {{{ .essential }}} クラスターを作成できます。
