...
詳細については、[ベクトル検索（プレビュー）の概要](/ai/guides/vector-search-overview.md)を参照してください。
...
埋め込みモデルは、データを[ベクトル埋め込み](/ai/guides/vector-search-overview.md#vector-embedding)に変換するアルゴリズムです。適切な埋め込みモデルを選択することは、セマンティック検索結果の正確性と関連性を確保するために非常に重要です。
