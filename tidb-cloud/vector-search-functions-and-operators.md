...
The following functions are designed specifically for [Vector data types](/tidb-cloud/vector-search-search-search-data-types.md).
...
The following built-in functions and operators are extended to support operations on [Vector data types](/tidb-cloud/vector-search-search-search-data-types.md).
...
For more information about how vector arithmetic works, see [Vector Data Type | Arithmetic](/tidb-cloud/vector-search-search-search-data-types.md#arithmetic).
...
For more information about how vectors are compared, see [Vector Data Type | Comparison](/tidb-cloud/vector-search-search-search-data-types.md#comparison).
...
For more information about how to use `CAST()`, see [Vector Data Type | Cast](/tidb-cloud/vector-search-search-search-data-types.md#cast).
