...
- The default collation for the utf8mb4 character set in TiDB is `utf8mb4_bin`. In MySQL 8.0, it is `utf8mb4_0900_ai_ci`. If the default collation is used in the upstream MySQL, because TiDB is not compatible with `utf8mb4_0900_ai_ci`, AWS DMS cannot create the target table in TiDB and cannot migrate the data. If you encounter such a problem, you can modify the collation of the source database to `utf8mb4_bin`.
