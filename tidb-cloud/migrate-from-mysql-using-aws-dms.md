...
- If you want to learn more about how to connect AWS DMS to {{{ .starter }}} or TiDB Cloud Dedicated, see [Connect AWS DMS to TiDB Cloud clusters](/tidb-cloud/tidb-cloud-connect-aws-dms.md).
...
- If you want to migrate from Amazon RDS for Oracle to {{{ .starter }}} Using AWS DMS, see [Migrate from Amazon RDS for Oracle to {{{ .starter }}} Using AWS DMS](/tidb-cloud/migrate-from-oracle-using-aws-dms.md).
