...
| Connected: IM 订阅 TiDB Cloud 报警/告警 ([Slack](/tidb-cloud/monitor-alert-slack.md), [Zoom](/tidb-cloud/monitor-alert-zoom.md), [Flashduty](/tidb-cloud/monitor-alert-flashduty.md), [PagerDuty](/tidb-cloud/monitor-alert-pagerduty.md), [Webhook](/tidb-cloud/monitor-alert-webhook.md), [Lark](/tidb-cloud/monitor-alert-lark.md))                                                                                          | -                            | -                                            | ✔                                              | ✔                                         |
...
- Connected: IM 订阅 TiDB Cloud 报警/告警
    ...
    该功能让你可以通过 IM 工具便捷订阅报警/告警通知，及时获知关键更新。详情参见 [通过 Slack 订阅](/tidb-cloud/monitor-alert-slack.md)、[通过 Zoom 订阅](/tidb-cloud/monitor-alert-zoom.md)、[通过 Flashduty 订阅](/tidb-cloud/monitor-alert-flashduty.md)、[通过 PagerDuty 订阅](/tidb-cloud/monitor-alert-pagerduty.md)、[通过 Webhook 订阅](/tidb-cloud/monitor-alert-webhook.md) 和 [通过 Lark 订阅](/tidb-cloud/monitor-alert-lark.md)。
