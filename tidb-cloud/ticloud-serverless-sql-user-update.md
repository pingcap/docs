...
Update a TiDB Cloud cluster SQL user:
...
Update a TiDB Cloud cluster SQL user in interactive mode:

```shell
ticloud serverless sql-user update
```

Update a TiDB Cloud cluster SQL user in non-interactive mode:
