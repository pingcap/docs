...
The process of importing snapshot files is similar to that of importing Parquet files. For more information, see [Import Apache Parquet Files from Amazon S3, GCS and Azure Blob Storage into TiDB Cloud](/tidb-cloud/import-parquet-files-serverless.md).
