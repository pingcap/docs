...
# クラスターリソースをサーバーレスまたは専用クラスターリソースに移行する {#migrate-cluster-resource-to-serverless-or-dedicated-cluster-resource}
...
## ステップ3. ターゲットクラスターリソースの構成を削除する {#step-3-delete-the-configuration-of-your-target-cluster-resource}
