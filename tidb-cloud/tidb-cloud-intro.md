...
- TiDB Cloud Dedicated
    ...
    Currently, TiDB Cloud Dedicated is generally available on AWS, Google Cloud and Azure. For more information, see [TiDB Cloud Dedicated](https://www.pingcap.com/tidb-cloud-dedicated).
