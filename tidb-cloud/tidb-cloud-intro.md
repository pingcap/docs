...
-   {{{ .byoc }}}
    ...
    {{{ .byoc }}}は、より高度な制御、Security、およびコンプライアンスを必要とする大規模な本番ワークロード向けに設計されています。TiDB Cloudの自動運用、伸縮自在なスケーラビリティ、エンタープライズグレードのSecurityの利点を活用しながら、自身のAWSアカウントでデータプレーンを実行できます。
