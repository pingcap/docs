...
2. On the **Clusters** page, click the name of your cluster, click the **Data Replication** tab on the left navigation, and click the **Data Migration** tab. The **Data Migration** page is displayed.
