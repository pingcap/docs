...
- For a {{{ .starter }}} cluster, you can have up to 400 concurrent connections. If you set a [spending limit](/tidb-cloud/manage-serverless-spend-limit.md), this limit increases to 5,000.
