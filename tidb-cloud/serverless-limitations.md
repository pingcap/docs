...
TiDB Cloud Starter 和 TiDB Cloud Essential 支持几乎所有 TiDB 支持的 workload，但与 TiDB Self-Managed 或 TiDB Cloud Dedicated 集群相比，存在一些功能差异。本文档描述了 TiDB Cloud Starter 和 TiDB Cloud Essential 的限制。
