...
| SetSpendLimit                     | 编辑 TiDB Cloud Serverless 集群的消费上限                             |
| UpdateMaintenanceWindow           | 修改维护窗口开始时间                                                  |
| DeferMaintenanceTask              | 延迟维护任务                                                          |
| CreateBranch                      | 为 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群创建分支         |
| DeleteBranch                      | 删除 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群的分支         |
| SetBranchRootPassword             | 为 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群的分支设置 root 密码 |
