...
| ConnectBranchGitHub            | Connect to the cluster and a GitHub repository to enable branching integration       |
| DisconnectBranchGitHub         | Disconnect from the cluster and a GitHub repository to disable branching integration |
