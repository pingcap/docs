...
| ConnectBranchGitHub            | Connect to the cluster and a GitHub repository to enable database branching        |
| DisconnectBranchGitHub         | Disconnect from the cluster and a GitHub repository to disable database branching  |
