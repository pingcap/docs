...
| 組織への招待状を再送信               | 組織に参加するためのユーザーの招待を再送信する                      |
...
| ゴミ箱から復元                   | ゴミ箱内のバックアップファイルに基づいてTiDBクラスターに復元する           |
