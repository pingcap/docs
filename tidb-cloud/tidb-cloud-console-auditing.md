...
| ConnectBranchGitHub            | Connect the main branch(cluster) and Github repository           |
| DisconnectBranchGitHub         | DisConnect the main branch(cluster) and Github repository        |
