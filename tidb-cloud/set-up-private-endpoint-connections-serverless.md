...
1. 要获取 **VPC ID** 和 **Subnet ID**，请前往 AWS 管理控制台，在相关区域查找。请确保填写你在 [step 1](#step-1-choose-a-tidb-cluster) 中获取的 **Availability Zone ID**。
...
> **Tip:**
>
> 在运行该命令前，你需要已安装并配置好 AWS CLI。详情请参见 [AWS CLI configuration basics](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-quickstart.html)。
