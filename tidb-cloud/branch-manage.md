...
This document describes how to manage TiDB Cloud Starter branches using the [TiDB Cloud console](https://console.tidb.io/signup?provider_source=alicloud). To manage it using the TiDB Cloud CLI, see [`ticloud branch`](/tidb-cloud/ticloud-branch-create.md).
