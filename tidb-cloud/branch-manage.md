...
1. In the [TiDB Cloud console](https://tidbcloud.com/), navigate to the [**Clusters**](https://console.tidb.io/clusters) page of your project, and then click the name of your target TiDB Cloud Serverless cluster to go to its overview page.
