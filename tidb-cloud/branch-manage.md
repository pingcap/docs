...
This document describes how to manage TiDB Cloud Starter branches using the [TiDB Cloud console](https://{{{.console-url}}}/signup?provider_source=alicloud). To manage it using the TiDB Cloud CLI, see [`ticloud branch`](/tidb-cloud/ticloud-branch-create.md).
...
1. In the [TiDB Cloud console](https://{{{.console-url}}}/signup?provider_source=alicloud), navigate to the [**Clusters**](https://{{{.console-url}}}/project/clusters) page of your project, and then click the name of your target TiDB Cloud Starter cluster to go to its overview page.
