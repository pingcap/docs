...
9. After the import task is completed, you can click **Explore your data by Chat2Query** to query your imported data. For more information about how to use Chat2Qury, see [Try Chat2Query](/tidb-cloud/tidb-cloud-quickstart.md#step-2-try-chat2query-beta).
