...
Connect to a branch of a {{{ .starter }}} cluster:
...
Connect to a {{{ .starter }}} branch in interactive mode:

```shell
ticloud serverless branch shell
```

Connect to a {{{ .starter }}} branch with the default user in non-interactive mode:

```shell
ticloud serverless branch shell -c <cluster-id> -b <branch-id>
```

Connect to a {{{ .starter }}} branch with the default user and password in non-interactive mode:

```shell
ticloud serverless branch shell -c <cluster-id> -b <branch-id> --password <password>
```

Connect to a {{{ .starter }}} branch with a specific user and password in non-interactive mode:
