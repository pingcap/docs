...
- A [TiDB Cloud account](https://{{{.console-url}}}/signup?provider_source=alicloud) and a TiDB Cloud Starter cluster on TiDB Cloud. For more details, see [TiDB Cloud Quick Start](https://docs.tidb.io/tidbcloud/tidb-cloud-quickstart#step-1-create-a-tidb-cluster).
