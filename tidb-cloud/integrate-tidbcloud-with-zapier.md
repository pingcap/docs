...
- A [TiDB Cloud account](https://tidbcloud.com/signup) and a TiDB Cloud Starter cluster on TiDB Cloud. For more details, see [TiDB Cloud Quick Start](https://docs.tidb.io/tidbcloud/tidb-cloud-quickstart#step-1-create-a-tidb-cluster).
