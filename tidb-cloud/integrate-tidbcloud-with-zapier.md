...
3.  アクションを設定する
    ...
    1.  前の手順と同様に、**プロジェクト名**、**クラスター名**、 **TiDBパスワード**、**データベース名**を入力してください。
...
| トリガー         | 説明                                        |
| ------------ | ----------------------------------------- |
| 新しいクラスター      | 新しいクラスターが作成されたときにトリガーされます。                |
...
| アクション         | 説明                                                            | リソース                                    |
| ------------- | ------------------------------------------------------------- | --------------------------------------- |
| クラスターの検索       | 既存のTiDB Cloud StarterインスタンスまたはTiDB Cloud Dedicatedクラスターを検索します。 | なし                                      |
| クラスターを作成する     | 新しいクラスターを作成します。TiDB TiDB Cloud Starterインスタンスの作成のみをサポートしています。  | なし                                      |
