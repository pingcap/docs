...
- A [TiDB Cloud account](https://console.tidb.io/signup?provider_source=alicloud) and a TiDB Cloud Starter cluster on TiDB Cloud. For more details, see [TiDB Cloud Quick Start](https://docs.tidb.io/tidbcloud/tidb-cloud-quickstart#step-1-create-a-tidb-cluster).
...
|---|---|---|
| Find Cluster | Finds an existing TiDB Cloud Starter cluster. | None |
| Create Cluster | Creates a new cluster. Only supports creating a TiDB Cloud Starter cluster. | None |
| Find Database | Finds an existing database. | A TiDB Cloud Starter cluster |
| Create Database | Creates a new database. | A TiDB Cloud Starter cluster |
| Find Table | Finds an existing Table. | A TiDB Cloud Starter cluster and a database |
| Create Table | Creates a new table. | A TiDB Cloud Starter cluster and a database |
| Create Row | Creates a new row. | A TiDB Cloud Starter cluster, a database, and a table |
| Update Row | Updates an existing row. | A TiDB Cloud Starter cluster, a database, and a table |
| Find Row | Finds a row in a table via a lookup column. | A TiDB Cloud Starter cluster, a database, and a table |
| Find Row (Custom Query) | Finds a row in a table via a custom query the you provide. | A TiDB Cloud Starter cluster, a database, and a table |
