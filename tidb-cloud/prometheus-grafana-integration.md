...
| `tidbcloud_changefeed_status`                            | gauge      | `changefeed: <changefeed-id>`<br/>`instance_id: <instance id>`<br/>`instance_name: <instance name>`                                         | 変更フィードのステータス:<br/> `-1` : 不明<br/>`0` : 通常<br/>`1` : 警告<br/>`2` : 失敗<br/>`3` : 停止しました<br/>`4` : 完了<br/>`6` : 警告<br/>`7` : その他 |
