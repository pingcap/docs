...
または、 TiDB Cloud Dedicatedクラスタの[**Alert**](/tidb-cloud/monitor-built-in-alerting.md#view-alerts)ページの右上隅にある**「購読」**をクリックすることもできます。**Alert Subscription**ページに移動します。
...
または、 TiDB Cloud Essentialインスタンスの[**Alert**](/tidb-cloud/monitor-built-in-alerting.md#view-alerts)ページの右上隅にある**「購読」**をクリックすることもできます。**Alert Subscription**ページに移動します。
...
または、 TiDB Cloud Premiumインスタンスの[**Alert**](/tidb-cloud/monitor-built-in-alerting.md#view-alerts)ページの右上隅にある**「購読」**をクリックすることもできます。**Alert Subscription**ページに移動します。
