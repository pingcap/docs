...
Delete a TiDB Cloud cluster SQL user:
...
Delete a TiDB Cloud cluster SQL user in interactive mode:

```shell
ticloud serverless sql-user delete
```

Delete a TiDB Cloud cluster SQL user in non-interactive mode:
