...
> **Note:**
>
> Currently, the database audit logging feature is only available upon request. To request this feature, click **Help** in the lower-right corner of TiDB Cloud console, fill in "Apply for database audit logging" in the **Description** field, and then click **Send**.
