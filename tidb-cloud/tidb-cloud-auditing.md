...
> **Note:**
>
> After the audit log is disabled, the last log file will not be pushed to the bucket on the cloud. You can push this file in either of the following ways:
>
