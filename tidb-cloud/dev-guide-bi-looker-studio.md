...
1. Navigate to the [**Clusters**](https://{{{.console-url}}}/project/clusters) page, and click **?** in the lower-right corner. A **Help** dialog is displayed.
...
1. On the [**Clusters**](https://{{{.console-url}}}/project/clusters) page, click the name of your TiDB Cloud Starter cluster to go to its overview page.
