---
title: Connect to TiDB Cloud Starter with Looker Studio
summary: Learn how to connect to TiDB Cloud Starter using Looker Studio.
---

# Connect to TiDB Cloud Starter with Looker Studio

TiDB is a MySQL-compatible database, TiDB Cloud Starter is a fully managed TiDB offering, and [Looker Studio](https://lookerstudio.google.com/) is a free web-based BI tool that can visualize data from various sources.

In this tutorial, you can learn how to connect to your TiDB Cloud Starter cluster with Looker Studio.
...
- [Create a TiDB Cloud Starter cluster](/develop/dev-guide-build-cluster-in-cloud.md#step-1-create-a-tidb-cloud-starter-cluster)

## Step 1. Import a dataset

You can import the S&P 500 dataset provided in the interactive tutorial of TiDB Cloud Starter.

1. Navigate to the [**Clusters**](https://console.tidb.io/project/clusters) page, and click **?** in the lower-right corner. A **Help** dialog is displayed.
...
1. On the [**Clusters**](https://console.tidb.io/project/clusters) page, click the name of your TiDB Cloud Starter cluster to go to its overview page.
