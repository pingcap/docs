...
summary: 了解如何通过 PagerDuty 获取报警通知，监控你的 TiDB 集群。
---
...
- 通过 PagerDuty 订阅功能仅对订阅了 **Enterprise** 或 **Premium** [support plan](/tidb-cloud/connected-care-overview.md) 的组织开放。
...
5. 在 **Name** 字段中输入名称，在 **Integration Key** 字段中输入你的 PagerDuty 集成密钥。
