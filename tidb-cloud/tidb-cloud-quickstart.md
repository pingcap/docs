...
This tutorial will guide you through an easy way to get started with TiDB Cloud. You can also follow the step-by-step tutorials on the [**Getting Started**](https://tidbcloud.com/console/getting-started) page in the TiDB Cloud console.
...
[TiDB Serverless](/tidb-cloud/select-cluster-tier.md#tidb-serverless-beta) (Beta) is the best way to get started with TiDB Cloud. To create a TiDB Serverless cluster, follow these steps:

1. If you don't have a TiDB Cloud account, click [here](https://tidbcloud.com/free-trial) to sign up.
...
2. [Log in](https://tidbcloud.com/) to your TiDB Cloud account.
    ...
    The [**Clusters**](https://tidbcloud.com/console/clusters) page will be displayed by default.
...
3. In the editor, you can either simply type `--` followed by your instructions to let AI automatically generate SQL queries, or write SQL queries manually.
    ...
    > **Note:**
    >
    > SQL queries generated by AI are not 100% accurate and may still require further tweaking.
...
After running the queries, you will immediately see the query logs and results at the bottom of the page.
...
3. Choose a TiDB Serverless cluster that you want to use for the tutorial, and click **Import Dataset**. The import process may take approximately one minute.
