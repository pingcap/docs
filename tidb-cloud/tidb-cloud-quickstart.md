...
2. To try the AI capacity of TiDB Cloud, follow the on-screen instructions to allow PingCAP and our AI service provider to use your code snippets for research and service improvement, and then click **Save and Get Started**.
