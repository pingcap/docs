...
3. In the editor, you can either simply type `--` and your instructions to let AI generate SQL queries automatically or write SQL queries manually.
...
- For more information about how to use Chat2Query to explore your data, see [Chat2Query](/tidb-cloud/connect-via-chat2query.md).
