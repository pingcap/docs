...
1. If you do not have a TiDB Cloud account, click [here](https://{{{.console-url}}}/free-trial?provider_source=alicloud) to sign up.
...
2. [Log in](https://{{{.console-url}}}/signup?provider_source=alicloud) to your TiDB Cloud account.
    ...
    The [**Clusters**](https://{{{.console-url}}}/project/clusters) page is displayed by default.
