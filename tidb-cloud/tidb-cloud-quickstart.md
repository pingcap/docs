...
## Step 2. Try TiDB Cloud AI capacity
...
3. In the editor, you can either type a SQL statement manually or follow the on-screen instructions to let AI generate a SQL statement for you.
