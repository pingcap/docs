...
- Currently Vector data types cannot store double-precision floating point numbers. This will be supported in a future release. In the meantime, if you import double-precision floating point numbers for Vector data types, they will be converted to single-precision numbers. 
