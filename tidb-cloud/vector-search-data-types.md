...
- Vector index support: You can build a [vector search index](/tidb-cloud/vector-search-search-search-index.md) to speed up vector searching.
...
For available functions and operators over the vector data types, see [Vector Functions and Operators](/tidb-cloud/vector-search-search-search-functions-and-operators.md).

For more information about building and using a vector search index, see [Vector Search Index](/tidb-cloud/vector-search-search-search-index.md).
...
However, note that you cannot build a [vector search index](/tidb-cloud/vector-search-search-search-index.md) for this column, as vector distances can be only calculated between vectors with the same dimensions.

## Comparison

You can compare vector data types using [comparison operators](/functions-and-operators/operators.md) such as `=`, `!=`, `<`, `>`, `<=`, and `>=`. For a complete list of comparison operators and functions for vector data types, see [Vector Functions and Operators](/tidb-cloud/vector-search-search-search-functions-and-operators.md).
...
For additional cast functions, see [Vector Functions and Operators](/tidb-cloud/vector-search-search-search-functions-and-operators.md).
...
For restrictions on vector data types, see [Vector search limitations](/tidb-cloud/vector-search-search-search-limitations.md) and [Vector index restrictions](/tidb-cloud/vector-search-search-search-index.md#restrictions).
...
- [Vector Functions and Operators](/tidb-cloud/vector-search-search-search-functions-and-operators.md)
- [Vector Search Index](/tidb-cloud/vector-search-search-search-index.md)
- [Improve Vector Search Performance](/tidb-cloud/vector-search-search-search-improve-performance.md)