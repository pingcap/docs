...
TiDB Cloud makes deploying, managing, and maintaining your TiDB clusters even simpler with a fully managed cloud instance that you control through an intuitive console. You are able to easily deploy on Amazon Web Services, Azure, or Google Cloud to quickly build mission-critical applications.
...
TiDB Cloud is currently available on Amazon Web Services, Azure, and Google Cloud.
