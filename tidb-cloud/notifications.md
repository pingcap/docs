...
| --- | --- | --- |
| TiDB Cloud Starter instance creation | 创建了一个 [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) 实例。 | 所有项目成员 |
| TiDB Cloud Starter instance deletion | 删除了一个 TiDB Cloud Starter 实例。 | 所有项目成员 |
| TiDB Cloud Essential instance creation | 创建了一个 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) 实例。 | 所有项目成员 |
| TiDB Cloud Essential instance deletion | 删除了一个 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) 实例。 | 所有项目成员 |
...
| Starter instance spending limit threshold alert | 组织下 TiDB Cloud Starter 实例的 [消费限额阈值](/tidb-cloud/manage-serverless-spend-limit.md) 达到。 | `Organization Owner`、`Organization Billing Manager`、`Organization Billing Viewer` 和 `Project Owner` |
