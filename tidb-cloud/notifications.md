...
| TiDB Cloud Dedicatedクラスターの作成   | [TiDB Cloud Dedicated](/tidb-cloud/select-cluster-tier.md#tidb-cloud-dedicated)クラスターが作成されます。 | プロジェクトメンバー全員                                                                                              |
| TiDB Cloud Dedicatedクラスターの削除   | TiDB Cloud Dedicatedクラスターが削除されました。                                                           | プロジェクトメンバー全員                                                                                              |
