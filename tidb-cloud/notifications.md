...
To view notifications, click **Notification** in the lower-left corner of the [TiDB Cloud console](https://{{{.console-url}}}/signup?provider_source=alicloud).
