...
3. Fill in the import parameters:
    ...
    Then, click **Validate** to verify whether TiDB Cloud has the access to the sample data in the specified bucket URL. If you encounter the `AccessDenied` error after clicking **Validate**, see [Troubleshoot Permission Errors during Data Import from S3](/tidb-cloud/troubleshoot-import-permission-error.md).
