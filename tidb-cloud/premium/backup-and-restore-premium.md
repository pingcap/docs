...
{{{ .premium }}} supports restoring backups from cloud object storage (such as AWS S3 or Alibaba Cloud OSS) to a new instance. This feature is compatible with backups generated from {{{ .dedicated }}} clusters or self-managed (on-premises) clusters.
