...
[主要概念](https://docs.pingcap.com/tidbcloud/key-concepts/?plan=premium)
...
[TiDB Cloudをお試しください](https://docs.pingcap.com/tidbcloud/tidb-cloud-quickstart/?plan=premium)

[HTAPを試してみてください](https://docs.pingcap.com/tidbcloud/tidb-cloud-htap-quickstart/?plan=premium)
...
[クイックスタート](https://docs.pingcap.com/developer/dev-guide-build-cluster-in-cloud/)

[サンプルアプリケーション](https://docs.pingcap.com/developer/dev-guide-sample-application-java-spring-boot/)

</LearningPath>

<LearningPath label="Maintain" icon="cloud7">

[TiDB Cloud Premiumインスタンスを作成する](https://docs.pingcap.com/tidbcloud/create-tidb-instance-premium/?plan=premium)
...
[APIを使用する（ベータ版）](https://docs.pingcap.com/api/)

</LearningPath>

<LearningPath label="Migrate" icon="cloud3">

[Amazon RDS for Oracleより](https://docs.pingcap.com/tidbcloud/migrate-from-oracle-using-aws-dms/?plan=premium)

[サンプルデータのインポート](https://docs.pingcap.com/tidbcloud/import-sample-data-serverless/?plan=premium)

[CSVファイルをインポートする](https://docs.pingcap.com/tidbcloud/import-csv-files-premium/?plan=premium)

[Parquetファイルのインポート](https://docs.pingcap.com/tidbcloud/import-parquet-files-serverless/?plan=premium)

[MySQL CLI を使用](https://docs.pingcap.com/tidbcloud/import-with-mysql-cli-premium/?plan=premium)

</LearningPath>

<LearningPath label="Monitor" icon="cloud6">

[ステータスと指標](https://docs.pingcap.com/tidbcloud/monitor-tidb-cluster/?plan=premium)

[内蔵監視機能](https://docs.pingcap.com/tidbcloud/built-in-monitoring-premium/?plan=premium)
...
[TiFlashのパフォーマンスをチューニング](https://docs.pingcap.com/tidbcloud/tune-tiflash-performance/?plan=premium)
...
[ユーザーロール](https://docs.pingcap.com/tidbcloud/manage-user-access/?plan=premium/#user-roles)

[ユーザープロファイルの管理](https://docs.pingcap.com/tidbcloud/manage-user-access/?plan=premium/#manage-user-profiles)

[組織アクセスを管理する](https://docs.pingcap.com/tidbcloud/manage-user-access/?plan=premium/#manage-organization-access)

[IPアクセスリストを設定する](https://docs.pingcap.com/tidbcloud/configure-ip-access-list-premium/?plan=premium)

</LearningPath>

<LearningPath label="Billing" icon="cloud2">

[価格設定](https://docs.pingcap.com/tidbcloud/tidb-cloud-billing/?plan=premium/#pricing-for-premium)

[請求書](https://docs.pingcap.com/tidbcloud/tidb-cloud-billing/?plan=premium/#invoices)

[クレジット](https://docs.pingcap.com/tidbcloud/tidb-cloud-billing/?plan=premium/#credits)
