...
4.  （オプション）このTiDB Cloud Premium インスタンスを管理用のプロジェクトにグループ化するには、 **[インスタンスをプロジェクトにグループ化]**をクリックし、インスタンスの対象となるプロジェクトを選択します。組織内にプロジェクトがない場合は、 **Create a Project**をクリックして作成できます。
