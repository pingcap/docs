...
4.  （オプション）このTiDB Cloud Premium インスタンスを管理用のプロジェクトにグループ化するには、 **[インスタンスをプロジェクトにグループ化] を**クリックし、インスタンスの対象となるプロジェクトを選択します。組織内にプロジェクトがない場合は、 **Create a Project**クリックして作成できます。
