...
# クラウドストレージからCSVファイルをTiDB Cloud Premiumにインポートする {#import-csv-files-from-cloud-ストレージ-into-tidb-cloud-premium}
...
-   CSV ファイルが Amazon S3 にある場合は、 TiDB Cloud Premium インスタンスに対して[Amazon S3へのアクセスを設定する](/tidb-cloud/configure-external-ストレージ-access.md#configure-amazon-s3-access)。
...
-   CSV ファイルが Alibaba Cloud Object Storage Service (OSS) にある場合は、 TiDB Cloud Premium インスタンスの[Alibaba Cloud Object Storage Service (OSS) へのアクセスを設定する](/tidb-cloud/configure-external-ストレージ-access.md#configure-alibaba-cloud-object-ストレージ-service-oss-access)。
