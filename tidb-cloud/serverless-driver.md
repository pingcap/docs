...
- The server blocks requests from arbitrary browser origins via CORS to protect your credentials. As a result, you can only use the serverless driver from backend services.
