...
* Support joining multiple organizations by invitation.
    ...
    In the TiDB Cloud console, you can view all organizations you have joined and switch them. For details, see [Switch organizations](/tidb-cloud/manage-user-access.md#switch-organizations).
