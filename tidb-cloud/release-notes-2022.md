...
* Support joining multiple organizations by invitation.
    ...
    In the TiDB Cloud console, you can view all organizations you have joined and switch between them. For details, see [Switch between organizations](/tidb-cloud/manage-user-access.md#switch-organizations).
