...
> **ノート：**
>
> VPC ピアリング接続は、TiDB Dedicatedクラスターでのみ使用できます。 VPC ピアリングを使用して[<a href="/tidb-cloud/select-cluster-tier.md#tidb-serverless-beta">TiDB Serverlessクラスター</a>](/tidb-cloud/select-cluster-tier.md#tidb-serverless-beta)に接続することはできません。
