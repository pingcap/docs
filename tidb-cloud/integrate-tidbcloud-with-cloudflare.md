...
Cloudflare WorkersはV8エンジン上で動作するため、直接TCP接続を確立できず、Cloudflare WorkersからTiDB Cloudへの接続が難しい場合があります。TiDB [TiDB Cloud Serverless Driver](/develop/serverless-driver.md)HTTP接続を介してCloudflare Workersに接続するのに役立ちます。 レス
