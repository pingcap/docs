...
你可能会发现从 Cloudflare Workers 连接 TiDB Cloud 有一定难度，因为 Cloudflare Workers 运行在 V8 引擎上，无法直接建立 TCP 连接。你可以使用 [TiDB Cloud serverless driver](/develop/serverless-driver.md) 通过 HTTP 连接帮助你连接到 Cloudflare Workers。
