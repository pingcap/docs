---
title: 将 TiDB Cloud 集成到 Cloudflare
summary: 了解如何在 TiDB Cloud 上部署 Cloudflare Workers。
---

# 将 TiDB Cloud 集成到 Cloudflare Workers
...
> **注意：**
>
> TiDB Cloud serverless driver 只能在 Starter 和 Essential 中使用。
...
4. 在终端中，你会被问到一系列与项目相关的问题。所有问题均选择默认值即可。
