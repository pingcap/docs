...
| --filter strings                 | Specify the exported table(s) with table filter patterns. See [here](https://docs.pingcap.com/tidb/stable/table-filter) to learn table filter.              | No       | Only works in non-interactive mode.                  |
