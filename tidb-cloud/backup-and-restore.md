...
- TiDB Dedicated supports restoring user accounts and sql bindings from backups by default from TiDB v6.2.0.
- TiDB Dedicated does not support support restoring system variables stored in the `mysql` schema. 
