...
> **Tip**
>
> To learn how to back up and restore data on {{{ .starter }}} or {{{ .essential }}} clusters, see [Back Up and Restore Data on {{{ .starter }}}, Essential, or Premium](/tidb-cloud/backup-and-restore-serverless.md).
