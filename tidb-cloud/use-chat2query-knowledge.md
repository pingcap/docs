...
> **Note:**
>
> Knowledge base related endpoints are only available for [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#tidb-cloud-starter) clusters hosted on AWS by default.
