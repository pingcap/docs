...
2. **在某类问题上表现不佳时**：当 Chat2Query 经常在某些特定问题上出错或难以处理时，添加 few-shot example 可以帮助提升其在这些问题上的表现。
...
> **Note:**
>
> 请确保新添加术语解释的准确性，因为解释的质量会影响 Chat2Query 的学习效果。不正确的解释不仅无法提升 Chat2Query 的结果，还可能带来负面影响。
...
- **限定查询范围**：如果你希望 SQL 只考虑某些表或字段，可以通过 instruction 进行指定。
