...
| TiKV Storage Usage | node, limit | The storage usage statistics or upper limit of each TiKV node. The used storage size includes the logical data size in the storage engine, as well as WAL files and temporary files. |
...
| TiFlash Storage Usage | node, limit | The storage usage statistics or upper limit of each TiFlash node. The used storage size includes the logical data size in the storage engine, as well as WAL files and temporary files. |
