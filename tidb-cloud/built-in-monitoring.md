...
| 使用済みストレージサイズ | 行ベースストレージ、行ベース標準ストレージ、列ベースストレージ  | 行ベースストレージ、行ベース標準ストレージ、列ベースストレージのサイズ。このメトリックは、各ストレージタイプのサイズが50 MiB以上の場合にのみ表示されます。現在、**行ベース標準ストレージ**は**行ベースストレージ**と同じ意味です。|
