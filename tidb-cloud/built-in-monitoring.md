...
summary: TiDB Cloudの組み込みメトリックを表示する方法と、これらのメトリックの意味を理解する方法を学習します。
---
...
| メトリック名         | ラベル           | 説明                                                                            |
| :------------- | :------------ | :---------------------------------------------------------------------------- |
| DB あたりの QPS    | すべて、{データベース名} | 各データベースで 1 秒あたりに実行された SQL ステートメントの数`SELECT` `INSERT`の SQL タイプ`UPDATE`に収集されます。 |
