...
This tutorial walks you through how to use [Django](https://www.djangoproject.com/) ORM to interact with the [TiDB Vector Search](/tidb-cloud/vector-search-search-search-overview.md), store embeddings, and perform vector search queries.
