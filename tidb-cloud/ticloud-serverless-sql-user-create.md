...
Create a TiDB Cloud cluster SQL user:
...
Create a TiDB Cloud cluster SQL user in interactive mode:

```shell
ticloud serverless sql-user create
```

Create a TiDB Cloud cluster SQL user in non-interactive mode:
