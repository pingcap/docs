...
Create a SQL user in a {{{ .starter }}} or {{{ .essential }}} cluster:
...
Create a SQL user in a {{{ .starter }}} or {{{ .essential }}} cluster in interactive mode:

```shell
ticloud serverless sql-user create
```

Create a SQL user in a {{{ .starter }}} or {{{ .essential }}} cluster in non-interactive mode:
