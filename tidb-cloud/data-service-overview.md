...
> **Note:**
>
> Data Serviceは、AWS でホストされているTiDB Cloud Starter でのみご利用いただけます。TiDB Cloud Dedicated クラスターでData Serviceをご利用になる場合は、 [TiDB Cloudサポート](/tidb-cloud/tidb-cloud-support.md)にお問い合わせください。
