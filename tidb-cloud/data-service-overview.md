...
> **Note:**
>
> Data Service is available for [TiDB Cloud Serverless](/tidb-cloud/select-cluster-tier.md#tidb-cloud-serverless) (now [{{{ .starter }}}](https://docs.tidb.io/tidbcloud/select-cluster-tier/#tidb-cloud-starter)) clusters. To use Data Service in TiDB Cloud Dedicated clusters, contact [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md).
