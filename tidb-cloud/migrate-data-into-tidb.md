...
> **Note:**
>
> It is recommended that you use the Migration Jobs feature to migrate MySQL-compatible databases. See [Migrate MySQL-Compatible Databases to TiDB Cloud Using Migration Jobs](/tidb-cloud/migration-job.md).
