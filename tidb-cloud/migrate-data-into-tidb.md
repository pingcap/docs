...
- If your source data is located in Amazon S3 cloud storage, take the following steps:
    ...
    2. From the [TiDB Cloud console](https://tidbcloud.com/), choose the target project, navigate to the [**Clusters**](https://tidbcloud.com/console/clusters) page, and then click the name of your target cluster to go to its own overview page. Click **Import Data**, and then fill in the importing related information on the **Data Import** page.
