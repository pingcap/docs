...
- If your source data is located in Amazon S3 cloud storage, take the following steps:
    ...
    2. From the [TiDB Cloud console](https://tidbcloud.com/), navigate to the [**Clusters**](https://tidbcloud.com/console/clusters) page, choose your target project on the top of the left navigation bar, and then click the name of your target cluster to go to its own overview page. Click **Import Data**, and then fill in the importing related information on the **Data Import** page.
