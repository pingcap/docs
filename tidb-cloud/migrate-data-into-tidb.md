...
- If your source data is located in Amazon S3 cloud storage, take the following steps:
    ...
    2. From the TiDB Cloud console, navigate to the **Clusters** page, and then click the name of your target cluster to go to its own overview page. In the upper-right corner, click **...**, select **Import Data**, and then fill in the importing related information on the **Data Import Task** page.
