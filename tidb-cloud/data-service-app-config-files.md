...
| `settings.timeout`   | 整数  | エンドポイントのタイムアウト (ミリ秒単位)。デフォルトでは`5000`です。 `1` ～ `30000`の整数に設定できます。                                                                                                                                                                                    |
| `settings.row_limit` | 整数  | エンドポイントが操作または返すことができる最大行数。デフォルトでは`50`です。 `batch_operation`を`0`に設定した場合、 `1`から`2000`までの整数を設定できます。 `batch_operation` `1`に設定した場合、 `1`から`100`までの整数を設定できます。                                                                                               |
