...
TiDB Cloud changefeed を使用すると、 TiDB Cloudから他のデータサービスにデータをストリーミングできます。現在、 TiDB Cloud Dedicated は、 Apache Kafka、MySQL、 TiDB Cloud、およびクラウドstorageへのデータストリーミングをサポートしています。
