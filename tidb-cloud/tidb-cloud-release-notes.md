...
- Support decreasing the number of TiKV and TiFlash nodes to scale in a TiDB Dedicated Tier cluster.
...
- Introduce the **Monitoring** page for Serverless Tier clusters.
