...
- Optimal performance with low latency
    ...
    | Transaction model | Threads | tpmC  | Avg Latency (ms) |
    |-------------------|---------|-------|------------------|
    | TPCC              | 25      | 4,486 | 2.24             |

    Sysbench OLTP performance:

    | Transaction model | Threads | TPS    | Avg Latency (ms) |
    |-------------------|---------|--------|------------------|
...
- Optimal performance with low latency
    ...
    | Transaction model | Threads | tpmC   | QPS    | Avg Latency (ms) |
    |-------------------|---------|--------|--------|------------------|
    | TPCC              | 300     | 14,532 | 13,137 | 608              |

    Sysbench OLTP performance:

    | Transaction model | Threads | TPS    | QPS    | Avg Latency (ms) |
    |-------------------|---------|--------|--------|------------------|
