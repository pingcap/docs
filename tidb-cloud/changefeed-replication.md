...
> * **TiDB Cloud Replication** is only available upon request. To request this feature, click **?** in the lower-right corner of the [TiDB Cloud console](https://tidbcloud.com), fill in "Apply for TiDB Cloud Replication" in the **Description** field, and then click **Send**.
