...
1. Fill in the PoC application form by doing one of the following:
    ...
    - In the [TiDB Cloud console](https://tidbcloud.com/), click <MDSvgIcon name="IconTopContactUs" /> **Contact Us** in the upper-right corner, and select **Apply for PoC** to fill in the application form.
