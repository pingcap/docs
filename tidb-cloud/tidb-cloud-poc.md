...
Because the amount of PoC credits is limited, to maximize the value of credits, it is recommended that you create a [Serverless Tier cluster](/tidb-cloud/select-cluster-tier.md#tidb-serverless) (one-year free trial) for compatibility tests and preliminary analysis on TiDB Cloud.
