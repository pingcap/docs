...
If you are interested in doing a PoC, feel free to contact <a href="mailto:tidbcloud-support@pingcap.com">US</a> before you get started. The support team can help you create a test plan and walk you through the PoC procedures smoothly.
...
For more information about the success criteria and how to create a test plan, feel free to contact <a href="mailto:tidbcloud-support@pingcap.com">US</a>.
...
If you have any questions, contact [US](/tidb-cloud/tidb-cloud-support.md) for consultation.
...
If you want to extend the PoC trial period or are running out of trial points, contact [US](https://en.pingcap.com/contact-us/) for help.

### 5. I'm stuck with a technical problem. How do I get help for my PoC?

You can always contact [US](/tidb-cloud/tidb-cloud-support.md) for help.
