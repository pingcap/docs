...
1. Fill in the PoC application form by doing one of the following:
    ...
    - In the [TiDB Cloud console](https://tidbcloud.com/), click the <MDSvgIcon name="icon-top-apply-for-poc" /> in the upper-right corner to fill in the PoC application form.
...
Alternatively, you can also click the <MDSvgIcon name="icon-top-account-settings" /> icon in the upper-right corner of the TiDB Cloud console, click **Billing**, and click **Credits** to see the credit details page.
