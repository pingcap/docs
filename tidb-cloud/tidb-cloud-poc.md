...
Alternatively, you can also switch to your target organization using the drop-down box in the upper-left corner of the TiDB Cloud console, click **Billing** in the left navigation pane, and then click the **Credits** tab to view the credit information.
