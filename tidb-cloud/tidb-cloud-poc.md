...
1. Fill in the PoC application form by doing one of the following:
    ...
    - If you have already [created a Developer Tier](/tidb-cloud/tidb-cloud-quickstart.md#step-1-create-a-tidb-cluster) (one-year free trial), an prompt bar about submitting your PoC application is displayed in the TiDB Cloud console. You can click the PoC application link in the bar to fill in the PoC application form. Alternatively, you can also click **Apply for PoC** in the upper-right corner of the console to access the application form.
...
If you want to extend the PoC trial period or are running out of credits, contact [PingCAP](https://en.pingcap.com/contact-us/) for help.
