...
TiDB Cloudは、高可用性と大容量データの強力な整合性が求められる様々なユースケースに適しています。[TiDB の紹介](https://docs.pingcap.com/tidb/stable/overview)では、主要な機能とシナリオをリストアップしています。お客様のビジネスシナリオに当てはまるかどうかご確認ください。
