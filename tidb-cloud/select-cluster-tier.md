...
2. Click **Connect** in the upper-right corner of the area. A connection dialog box is displayed.
    ...
    > **Tip:**
    >
    > Alternatively, you can also click the name of your cluster on the **Cluster List** page and click **Connect** in the upper-right corner.
...
Alternatively, you can log in to the TiDB Cloud console, and then click **Resume** for the cluster on the **Cluster List** page.
