...
aliases: ['/tidbcloud/public-preview/serverless-tier-cluster']
---
...
For each TiDB Cloud account, you can use create a complimentary Serverless Tier cluster to use during the beta phase. Although you can only run one Serverless Tier cluster at a time, you can delete and recreate the cluster as many times as you wish.
