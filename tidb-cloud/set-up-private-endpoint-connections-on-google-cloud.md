...
This document describes how to connect to your TiDB Dedicated cluster via Google Cloud Private Service Connect.
...
### Why cannot I see the endpoints generated by directly copying the service attachment in the TiDB Cloud console?

In the TiDB Cloud console, you can only view endpoints that are created through the command generated on the **Create Google Cloud Private Endpoint** page, allowing you to see all the created endpoints within the same Google Cloud project ID.
