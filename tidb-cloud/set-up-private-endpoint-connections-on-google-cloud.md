...
借助 Google Cloud Private Service Connect，端点连接是安全且私有的，不会将你的数据暴露在公网。此外，端点连接支持 CIDR 重叠，并且更易于网络管理。
...
如需了解私有端点和端点服务的更详细定义，请参见以下 Google Cloud 文档：
...
在 Google Cloud Shell 成功执行命令后，返回 TiDB Cloud 控制台并点击 **Accept Endpoint Access**。
