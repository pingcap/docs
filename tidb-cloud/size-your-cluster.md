...
-   2 vCPU TiKV は、最大 500 GiB のストレージ容量をサポートします。
...
## パフォーマンスの参照 {#performance-reference}

このセクションでは、いくつかの一般的な TiDBクラスタスケールの[TPC-C](https://www.tpc.org/tpcc/)および[シスベンチ](https://github.com/akopytov/sysbench)のパフォーマンス テスト結果を提供します。これは、クラスタサイズを決定する際の参考として使用できます。

### 4 vCPU、8 vCPU、および 16 vCPU パフォーマンス リファレンス {#4-vcpu-8-vcpu-and-16-vcpu-performance-references}
...
### 2 vCPU パフォーマンス リファレンス {#2-vcpu-performance-reference}
...
パフォーマンス データは次のように確認できます。

<details><summary>TiDB: 2 vCPU * 2; TiKV: 2 vCPU * 3</summary>
...
-   低レイテンシで最適なパフォーマンス
    ...
    | ---------- | ---- | ----- | ------------ |
    | 入れる        | 25   | 2508  | 7.92         |
    | ポイントセレクト   | 50   | 16858 | 1.72         |
    | 読み書き       | 50   | 360   | 4.95         |
    | インデックスを更新  | 25   | 1653年 | 14.05        |
    | 非インデックスの更新 | 25   | 2800  | 8.02         |
...
-   最大 TPS と QPS
    ...
    | ---------- | ---- | ----- | ------------ |
    | 入れる        | 100  | 6147  | 14.77        |
    | ポイントセレクト   | 100  | 19462 | 3.21         |
    | 読み書き       | 100  | 378   | 9.58         |
    | インデックスを更新  | 100  | 3140  | 30.34        |
    | 非インデックスの更新 | 100  | 5805  | 15.92        |
