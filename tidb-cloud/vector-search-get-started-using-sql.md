...
TiDB extends MySQL syntax to support [Vector Search](/tidb-cloud/vector-search-search-overview.md) and introduce new [Vector data types](/tidb-cloud/vector-search-search-data-types.md) and several [vector functions](/tidb-cloud/vector-search-search-functions-and-operators.md).
...
When creating a table, you can define a column as a [vector](/tidb-cloud/vector-search-search-overview.md#vector-embedding) column by specifying the `VECTOR` data type.
...
Insert three documents with their [vector embeddings](/tidb-cloud/vector-search-search-overview.md#vector-embedding) into the `embedded_documents` table:
...
>
> In real-world applications, [embedding models](/tidb-cloud/vector-search-search-overview.md#embedding-model) often produce vector embeddings with hundreds or thousands of dimensions.
