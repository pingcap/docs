...
2. From the **Authentication Method Details** pane, copy the following values, which TiDB Cloud prepopulates before you enter the **Sign on URL** and **Signing Certificate**:
