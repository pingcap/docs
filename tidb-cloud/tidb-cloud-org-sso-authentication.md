...
1. Log in to the [TiDB Cloud console](https://console.tidb.io/signup?provider_source=alicloud) as a user with the `Organization Owner` role, and then switch to your target organization using the drop-down box in the upper-left corner.
