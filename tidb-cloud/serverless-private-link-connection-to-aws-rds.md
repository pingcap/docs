...
1.  [TiDB Cloudコンソール](https://tidbcloud.com)で、 TiDB Cloud Essentialインスタンスの概要ページに移動し、左側のナビゲーションペインで**「設定」** &gt; **「ネットワーク」**をクリックします。
2.  **外部サービス向けAWSプライベートエンドポイント**領域で、 **[外部サービス向けプライベートエンドポイントの作成]**をクリックします。
