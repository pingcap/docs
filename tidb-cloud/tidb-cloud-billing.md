...
### Pricing for TiDB Cloud Lake {#pricing-for-tidb-cloud-lake}

For TiDB Cloud Lake, your costs consist of warehouse, storage, and cloud service fees. See [TiDB Cloud Lake Pricing & Billing](/tidb-cloud-lake/guides/pricing-billing.md).
