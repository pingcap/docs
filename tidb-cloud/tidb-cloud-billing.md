...
> **Note:**
>
> [TiDB Serverless clusters](/tidb-cloud/select-cluster-tier.md#serverless-tier-beta) are free until May 31, 2023, with a 100% discount off. After that, usage beyond the [free quota](/tidb-cloud/select-cluster-tier.md#usage-quota) will be charged.
