...
If the free quota of a cluster is exhausted within the month, the cluster is automatically throttled. This limit will remain in place until you [increase the spending limit](/tidb-cloud/manage-serverless-spend-limit.md#update-spending-limit) or until the next month.
