...
> **ノート：**
>
> [開発者層クラスター](/tidb-cloud/select-cluster-tier.md#developer-tier)は最大1年間無料で使用できます。開発者層クラスタの使用に対して課金されることはなく、 TiDB Cloudの請求書に開発者層の料金が表示されることもありません。
...
-   GCP
    ...
    すべてのバックアップはGCPクラウドストレージに保存されます。クラウドストレージ料金を支払うだけで、追加料金は請求されません。詳細については、 [GCPCloudStorageの価格](https://cloud.google.com/storage/pricing)を参照してください。
...
TiDB Cloudは、これらの料金を発生時に顧客に渡します。これは、公開されている[AWS](https://aws.amazon.com/ec2/pricing/on-demand/)および[GCP](https://cloud.google.com/vpc/network-pricing)の価格表を使用して計算され、追加料金はかかりません。
