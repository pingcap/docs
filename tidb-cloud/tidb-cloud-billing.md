...
> **Note:**
>
> [Serverless Tier clusters](/tidb-cloud/select-cluster-tier.md#tidb-serverless) are free to use in beta. You will not be charged for the use of your Serverless Tier cluster, and your TiDB Cloud bill will not display any Serverless Tier charges.
