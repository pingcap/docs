...
After you contact our sales for receiving an invoice on a monthly basis or if you signed up for TiDB Cloud through AWS Marketplace or Google Cloud Marketplace, TiDB Cloud will generate the invoice for the previous month at the beginning of each month.
