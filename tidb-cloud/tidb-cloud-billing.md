...
> **Note:**
>
> [Serverless Tier clusters](/tidb-cloud/select-cluster-tier.md#serverless-tier) are free to use in beta phase. You will not be charged for the use of your Serverless Tier cluster, and your TiDB Cloud bill will not display any Serverless Tier charges.
