...
Before you manage an endpoint, make sure that you have created a cluster and a Data App. For more information, see [Create a TiDB Serverless cluster](/tidb-cloud/create-tidb-cluster-serverless.md), [Create a TiDB Dedicated cluster](/tidb-cloud/create-tidb-cluster.md), and [Create a Data App](/tidb-cloud/data-service-manage-data-app.md#create-a-data-app).
