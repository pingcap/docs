...
| 声明                             | TiDB Cloud専用 | TiDB Cloud Starter とTiDB Cloud Essential |
| :----------------------------- | :----------- | :--------------------------------------- |
...
| 関数と演算子  | TiDB Cloud専用 | TiDB Cloud Starter とTiDB Cloud Essential                                                                        |
| :------ | :----------- | :-------------------------------------------------------------------------------------------------------------- |
| `SLEEP` | 制限なし         | [`SLEEP()`関数](https://docs.pingcap.com/tidbcloud/miscellaneous-functions)は、最大 300 秒のスリープ時間しかサポートできないという制限があります。 |

## システムテーブル {#system-tables}

| データベース               | テーブル                                 | TiDB Cloud専用    | TiDB Cloud Starter とTiDB Cloud Essential |
| :------------------- | :----------------------------------- | :-------------- | :--------------------------------------- |
...
| 変数                                        | TiDB Cloud専用     | TiDB Cloud Starter とTiDB Cloud Essential |
| :---------------------------------------- | :--------------- | :--------------------------------------- |
