...
| `ADMIN PLUGINS ENABLE` | Supported | Not supported [^7] |
| `ADMIN PLUGINS DISABLE` | Supported | Not supported [^7] |
...
| `SHOW PLUGINS` | Supported | Not supported [^7] |
| `SHUTDOWN` | Not supported [^4] | Not supported [^4] |
| `PLAN REPLAYER` | Supported | Supported in a different way[^10] |
...
| `interactive_timeout` | No limitation | Read-only [^9] |
| `max_allowed_packet` | No limitation | Read-only [^9] |
| `plugin_dir` | No limitation | Not supported [^7] |
| `plugin_load` | No limitation | Not supported [^7] |
| `require_secure_transport` | Not supported [^11] | Read-only [^9] |
| `skip_name_resolve` | No limitation | Read-only [^9] |
| `sql_log_bin` | No limitation | Read-only [^9] |
| `tidb_cdc_write_source` | No limitation | Read-only [^9] |
| `tidb_check_mb4_value_in_utf8` | Not supported [^4] | Not supported [^4] |
| `tidb_config` | Not supported [^4] | Not supported [^4] |
| `tidb_ddl_disk_quota` | No limitation | Read-only [^9] |
| `tidb_ddl_enable_fast_reorg` | No limitation | Read-only [^9] |
| `tidb_ddl_error_count_limit` | No limitation | Read-only [^9] |
| `tidb_ddl_flashback_concurrency` | No limitation | Read-only [^9] |
| `tidb_ddl_reorg_batch_size` | No limitation | Read-only [^9] |
| `tidb_ddl_reorg_priority` | No limitation | Read-only [^9] |
| `tidb_ddl_reorg_worker_cnt` | No limitation | Read-only [^9] |
| `tidb_enable_1pc` | No limitation | Read-only [^9] |
| `tidb_enable_async_commit` | No limitation | Read-only [^9] |
| `tidb_enable_auto_analyze` | No limitation | Read-only [^9] |
| `tidb_enable_collect_execution_info` | Not supported [^4] | Not supported [^4] |
| `tidb_enable_ddl` | No limitation | Read-only [^9] |
| `tidb_enable_gc_aware_memory_track` | No limitation | Read-only [^9] |
| `tidb_enable_gogc_tuner` | No limitation | Read-only [^9] |
| `tidb_enable_local_txn` | No limitation | Read-only [^9] |
| `tidb_enable_resource_control` | No limitation | Read-only [^9] |
| `tidb_enable_slow_log` | Not supported [^4] | Not supported [^4] |
| `tidb_enable_stmt_summary` | No limitation | Read-only [^9] |
| `tidb_enable_telemetry` | Not supported [^4] | Not supported [^4] |
| `tidb_enable_top_sql` | No limitation | Read-only [^9] |
| `tidb_enable_tso_follower_proxy` | No limitation | Read-only [^9] |
| `tidb_expensive_query_time_threshold` | Not supported [^4] | Not supported [^4] |
| `tidb_force_priority` | Not supported [^4] | Not supported [^4] |
| `tidb_gc_concurrency` | No limitation | Read-only [^9] |
| `tidb_gc_enable` | No limitation | Read-only [^9] |
| `tidb_gc_life_time` | No limitation | Read-only [^9] |
| `tidb_gc_max_wait_time` | No limitation | Read-only [^9] |
| `tidb_gc_run_interval` | No limitation | Read-only [^9] |
| `tidb_gc_scan_lock_mode` | No limitation | Read-only [^9] |
| `tidb_general_log` | Not supported [^4] | Not supported [^4] |
| `tidb_generate_binary_plan` | No limitation | Read-only [^9] |
| `tidb_gogc_tuner_threshold` | No limitation | Read-only [^9] |
| `tidb_guarantee_linearizability` | No limitation | Read-only [^9] |
| `tidb_isolation_read_engines` | No limitation | Read-only [^9] |
| `tidb_log_file_max_days` | No limitation | Read-only [^9] |
...
| `tidb_placement_mode` | No limitation | Read-only [^9] |
...
| `tidb_scatter_region` | No limitation | Read-only [^9] |
| `tidb_server_memory_limit` | No limitation | Read-only [^9] |
| `tidb_server_memory_limit_gc_trigger` | No limitation | Read-only [^9] |
| `tidb_server_memory_limit_sess_min_size` | No limitation | Read-only [^9] |
| `tidb_simplified_metrics` | No limitation | Read-only [^9] |
...
| `tidb_stats_load_sync_wait` | No limitation | Read-only [^9] |
| `tidb_stmt_summary_history_size` | No limitation | Read-only [^9] |
| `tidb_stmt_summary_internal_query` | No limitation | Read-only [^9] |
| `tidb_stmt_summary_max_sql_length` | No limitation | Read-only [^9] |
| `tidb_stmt_summary_max_stmt_count` | No limitation | Read-only [^9] |
| `tidb_stmt_summary_refresh_interval` | No limitation | Read-only [^9] |
| `tidb_sysproc_scan_concurrency` | No limitation | Read-only [^9] |
...
| `tidb_tso_client_batch_max_wait_time` | No limitation | Read-only [^9] |
...
| `tidb_txn_mode` | No limitation | Read-only [^9] |
| `tidb_wait_split_region_finish` | No limitation | Read-only [^9] |
| `tidb_wait_split_region_timeout` | No limitation | Read-only [^9] |
| `txn_scope` | No limitation | Read-only [^9] |
| `validate_password.enable` | No limitation | Always enabled [^8] |
| `validate_password.length` | No limitation | At least `8` [^8] |
| `validate_password.mixed_case_count` | No limitation | At least `1` [^8] |
| `validate_password.number_count` | No limitation | At least `1` [^8] |
| `validate_password.policy` | No limitation | Can only be `MEDIUM` or `STRONG` [^8] |
| `validate_password.special_char_count` | No limitation | At least `1` [^8] |
| `wait_timeout` | No limitation | Read-only [^9] |
