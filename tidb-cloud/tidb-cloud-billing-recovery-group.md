...
TiDB Cloudは、リカバリグループのプライマリクラスターにデプロイされたTiKVノードのサイズに基づいて、リカバリグループの料金を請求します。クラスターを[リカバリグループを作成する](/tidb-cloud/recovery-group-get-started.md)アップグレードする際に、リカバリグループのプライマリクラスターを選択できます。TiKV構成が大きいほど、リカバリグループの保護コストが高くなります。
