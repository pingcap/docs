...
> **Tip:**
>
> To learn how to connect to a {{{ .starter }}} or {{{ .essential }}} cluster via public connection, see [Connect to {{{ .starter }}}, Essential, or Premium via Public Endpoint](/tidb-cloud/connect-via-standard-connection-serverless.md).
