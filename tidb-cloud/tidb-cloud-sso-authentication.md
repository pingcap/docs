...
This document describes how to log in to the [TiDB Cloud console](https://tidbcloud.com/) via basic Single Sign-on (SSO) authentication, which is quick and convenient.	Single Sign-On (SSO) allows members of your TiDB Cloud organization to authenticate using an identity from an identity provider (IdP) instead of using an email address and password.
