...
5. Click **I understand, delete it**.
    ...
    - Automatic backups will expire and be automatically deleted once the retention period ends, except for the latest backup. The default retention period is 7 days if you don't modify it. The latest automatic backup will not be deleted unless you explicitly delete it.
