...
- Automatic backups will expire and be automatically deleted once the retention period has passed. The default retention
  period is 7 days if you don't modify it. 
