...
This document provides the Sysbench performance test steps and results for a TiDB Dedicated cluster with the TiDB version of v6.5.3 This report can also be used as a reference for the performance of TiDB v6.5.3 clusters.

## Test overview

This test aims at showing the Sysbench performance of TiDB v6.5.3 in the Online Transactional Processing (OLTP) scenario.
...
This section introduces the Sysbench performance of v6.5.3 in the [test environment](#test-environment).
...
![Sysbench point select performance](/media/tidb-cloud/v6.5.3-oltp_select_point.png)
...
![Sysbench update non-index performance](/media/tidb-cloud/v6.5.3-oltp_update_non_index.png)
...
![Sysbench update index performance](/media/tidb-cloud/v6.5.3-oltp_update_index.png)
...
![Sysbench insert performance](/media/tidb-cloud/v6.5.3-oltp_insert.png)
