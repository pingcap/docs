...
You can use the built-in AI-assisted SQL Editor in the [TiDB Cloud console](https://console.tidb.io/signup?provider_source=alicloud) to maximize your data value.
...
- SQL Editor is available by default for [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#tidb-cloud-starter) clusters.
...
- To disable AI, click <MDSvgIcon name="icon-top-account-settings" /> in the lower-left corner of the [TiDB Cloud console](https://console.tidb.io/signup?provider_source=alicloud), click **Account Settings**, click the **Privacy** tab, and then disable the **AI-powered Data Exploration** option.
