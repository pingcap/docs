...
SQL queries generated by the AI in Chat2Query are not 100% accurate and might still need your further tweak.
...
2. Click your cluster name, and then click <MDSvgIcon name="icon-left-sql-editor" /> **Chat2Query** in the left navigation pane.
