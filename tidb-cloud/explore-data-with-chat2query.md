...
> **Note:**
>
> Chat2Query is only available for TiDB Serverless clusters that are v6.5.0 or later and are hosted on AWS. If you want to use Chat2Query on TiDB Dedicated, please contact [support](/tidb-cloud/tidb-cloud-support.md).
...
- The [Chat2Query API](/tidb-cloud/use-chat2query-api.md) is only available for [Serverless Tier](/tidb-cloud/select-cluster-tier.md#serverless-tier-beta) clusters. If you want to use on TiDB Dedicated, please contact [support](/tidb-cloud/tidb-cloud-support.md).
...
- Whether to enable [Chat2Query API](/tidb-cloud/use-chat2query-api.md) (only available for [Serverless Tier](/tidb-cloud/select-cluster-tier.md#serverless-tier-beta) clusters)
