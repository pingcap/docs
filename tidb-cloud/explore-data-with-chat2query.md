...
- The [Chat2Query API](/tidb-cloud/use-chat2query-api.md) is only available for [Serverless Tier](/tidb-cloud/select-cluster-tier.md#serverless-tier-beta) clusters.
