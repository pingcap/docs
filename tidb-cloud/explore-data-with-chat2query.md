...
> **Note:**
>
> Chat2Query is only available for [TiDB Serverless](/tidb-cloud/select-cluster-tier.md#tidb-serverless-beta) clusters that are v6.5.0 or later and are hosted on AWS.
