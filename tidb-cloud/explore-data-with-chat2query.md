...
- Chat2Query and the [Chat2Query API](https://docs.pingcap.com/tidbcloud/use-chat2query-api) are available by default for [TiDB Serverless](https://docs.pingcap.com/tidbcloud/select-cluster-tier#tidb-serverless) clusters. To use Chat2Query or the Chat2Query API on [TiDB Dedicated](https://docs.pingcap.com/tidbcloud/select-cluster-tier#tidb-dedicated) clusters, contact [TiDB Cloud support](https://docs.pingcap.com/tidbcloud/tidb-cloud-support).
...
2. Click your cluster name, and then click **Chat2Query** in the left navigation pane.
    ...
    > **Note:**
    >
    > In the following cases, the **Chat2Query** entry is displayed in gray and not clickable.
    >
