...
When you access Chat2Query for the first time, you will see a dialog about whether to allow PingCAP and OpenAI to use your code snippets to research and improve the services.
