...
When you access Chat2Query for the first time, you will be prompted with a dialog about whether to allow PingCAP and our AI service provider to use your code snippets to research and improve the services.
