...
You can use the built-in AI-assisted SQL Editor in the [TiDB Cloud console](https://{{{.console-url}}}/) to maximize your data value.
...
- SQL Editor is only available by default for [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#tidb-cloud-starter) clusters hosted on AWS.

## Access SQL Editor

1. Go to the [**Clusters**](https://{{{.console-url}}}/project/clusters) page of your project.
...
- To disable AI, click <MDSvgIcon name="icon-top-account-settings" /> in the lower-left corner of the [TiDB Cloud console](https://{{{.console-url}}}/), click **Account Settings**, click the **AI & Privacy** tab, and then disable the **AI-powered Data Exploration** option.
