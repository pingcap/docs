...
- SQL Editor is available by default for [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#tidb-cloud-starter) and [TiDB Cloud Essentials](/tidb-cloud/select-cluster-tier.md#tidb-cloud-essentials) clusters.

## Access SQL Editor

1. Go to the [**Clusters**](https://console.tidb.io/project/clusters) page of your project.
...
- To disable AI, click <MDSvgIcon name="icon-top-account-settings" /> in the lower-left corner of the [TiDB Cloud console](https://console.tidb.io/), click **Account Settings**, click the **AI & Privacy** tab, and then disable the **AI-powered Data Exploration** option.
