...
2. 左側のナビゲーションペインで、**Integrations** > **Integration to Datadog (Preview)** をクリックします。
3. Datadog API key を入力し、Datadog Region を選択します。
4. **Test Integration** をクリックします。
...
2. 左側のナビゲーションペインで、**Settings** > **Integrations** > **Integration to Datadog (Preview)** をクリックします。
3. Datadog API key を入力し、Datadog Region を選択します。
4. **Test Integration** をクリックします。
