...
- A TiDB cluster. For more information, see [Create a {{{ .starter }}}, Essential, or Premium Cluster](/tidb-cloud/create-tidb-cluster-serverless.md) or [Create a TiDB Cloud Dedicated cluster](/tidb-cloud/create-tidb-cluster.md).
