...
customConfig:
  ...
  sinks:
    ...
    gcs_upload_oom_file:
      type: gcp_cloud_storage_upload_file
      inputs:
        - oom_file_key_transform
      bucket: ${BUCKET}

    gcs_upload_replayer_file:
      type: gcp_cloud_storage_upload_file
      inputs:
        - replayer_file_key_transform
      bucket: ${BUCKET}
...
podPriorityClassName: dataplane-node-o11y-critical
...
serviceAccount:
  ...
  create: true
  annotations:
    iam.gke.io/gcp-service-account: ${SA_ROLE_ARN}
