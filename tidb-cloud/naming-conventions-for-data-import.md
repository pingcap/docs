...
- For CSV files, see **Advanced Settings** > **Mapping Settings** in [Step 4. Import CSV files to TiDB Cloud](/tidb-cloud/import-csv-files-serverless.md#step-4-import-csv-files-to-tidb-cloud-starter)
- For Parquet files, see **Advanced Settings** > **Mapping Settings** in [Step 4. Import Parquet files to TiDB Cloud](/tidb-cloud/import-parquet-files-serverless.md#step-4-import-parquet-files-to-tidb-cloud-starter)
