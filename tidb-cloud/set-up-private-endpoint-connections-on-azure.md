...
3.  **「接続の種類」**ドロップダウンリストで**「プライベートエンドポイント」**を選択し、 **Create Private Endpoint Connection**をクリックして、 **「Azureプライベートエンドポイント接続の作成」**ダイアログを開きます。
...
5.  **「リソース」**タブで、**接続方法**として**「リソース ID またはエイリアスを使用して Azure リソースに接続する」を**選択し、コピーしたTiDB Cloudリソース ID を**Resource ID or alias**フィールドに貼り付けます。
