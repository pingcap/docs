...
> - 如需了解如何通过私有终端节点连接 TiDB Cloud Starter 或 TiDB Cloud Essential 实例，请参见以下文档：
...
> - To learn how to connect to a TiDB Cloud Starter or TiDB Cloud Essential instance via private endpoint, see [Connect to TiDB Cloud Starter via AWS PrivateLink](/tidb-cloud/set-up-private-endpoint-connections-serverless.md).
