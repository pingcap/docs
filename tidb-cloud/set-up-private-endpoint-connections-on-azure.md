...
> - To learn how to connect to a {{{ .starter }}} or {{{ .essential }}} cluster via private endpoint, see [Connect to {{{ .starter }}} or {{{ .essential }}} via Private Endpoint](/tidb-cloud/set-up-private-endpoint-connections-serverless.md).
