...
2. Use [Dumpling](https://docs.pingcap.com/tidb/stable/dumpling-overview) to export data from your TiDB instance, then use community tools such as [mydumper/myloader](https://centminmod.com/mydumper.html) to load data to the MySQL service.
...
1. Navigate to the instance overview page of the target TiDB instance, and then click **Data** > **Changefeed** in the left navigation pane.
...
8. In **Start Replication Position**, configure the starting position for your MySQL sink.
    ...
    - If you do not have any data in the upstream TiDB instance, select **Start replication from now on**.
...
9. Click **Next** to configure your changefeed specification.
    ...
    - In the **Changefeed Specification** area, specify the number of Changefeed Capacity Units (CCUs) to be used by the changefeed.
