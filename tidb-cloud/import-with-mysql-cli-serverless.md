...
- You have access to your {{{ .starter }}} or {{{ .essential }}} instance. If you do not have, create one following the instructions in [Build a TiDB Cloud Cluster](/develop/dev-guide-build-cluster-in-cloud.md).
