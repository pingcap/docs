...
2. In the AWS Management Console, [create a policy](#create-a-policy) for your Amazon S3 bucket.
3. In the AWS Management Console, [create a role](#create-a-role) for your Amazon S3 bucket.
...
In the AWS Management Console, create a managed policy for your Amazon S3 bucket.
...
In the AWS Management Console, create an access role for TiDB Cloud and get the role ARN.
