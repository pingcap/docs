...
> **Note:**
>
> Currently, **Key Visualizer** is unavailable for [TiDB Serverless clusters](/tidb-cloud/select-cluster-tier.md#serverless-tier-beta).
...
> **Note:**
>
> Key Visualizer is only available for [TiDB Dedicated clusters](/tidb-cloud/select-cluster-tier.md#dedicated-tier).
