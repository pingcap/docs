...
<LearningPathContainer platform="tidb-cloud" title="TiDB Cloud Dedicated" subTitle="TiDB Cloud Dedicated 专为关键业务而设计，提供跨多个可用区的高可用性、强大的水平扩展能力和完整的 HTAP 能力。">
...
[从 MySQL 迁移](https://docs.pingcap.com/zh/tidbcloud/migrate-from-mysql-using-data-migration/)
...
[从 Apache Parquet 文件](https://docs.pingcap.com/zh/tidbcloud/import-parquet-files)
