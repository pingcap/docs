...
> **Note:**
>
> Export more than 1T is not allowed. If you want to export more than 1T data or need to speed up the export, please contact [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md).
...
For more information, see [Alibaba Cloud Object Storage Service (OSS) access](/tidb-cloud/serverless-external-storage.md#configure-alibaba-cloud-object-storage-service-oss-access).
