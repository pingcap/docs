...
For more information, see [Configure External Storage Access for TiDB Cloud Starter](/tidb-cloud/serverless-external-storage.md#configure-alibaba-cloud-object-storage-service-oss-access).
