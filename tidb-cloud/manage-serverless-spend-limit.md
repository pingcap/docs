...
> **Note:**
>
> The spending limit is only applicable to TiDB Serverless [scalable clusters](/tidb-cloud/select-cluster-tier.md#scalable-clusters).
...
## Upgrade to Scalable Cluster

For an existing TiDB Serverless free cluster, you can upgrade to Scalable Cluster as follows:
