...
| More than 20 SQL statements exceeded 256 ms within 1 minute | Check for recent schema or index changes. Review the slow query list in the TiDB Cloud console. It might take several minutes for the corresponding slow query records to appear. If you cannot identify the root cause, contact [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md).|
| More than 20 SQL statements exceeded 512 ms within 1 minute | Check for recent schema or index changes. Review the slow query list in the TiDB Cloud console. It might take several minutes for the corresponding slow query records to appear. If you cannot identify the root cause, contact [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md).|
| More than 20 SQL statements exceeded 4096 ms within 1 minute | Check for recent schema or index changes. Review the slow query list in the TiDB Cloud console. It might take several minutes for the corresponding slow query records to appear. If you cannot identify the root cause, contact [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md).|
