...
| TiKV storage utilization exceeds 80% | Consider increasing the node number or node storage size for TiKV to increase your storage capacity. Usage above 80% can lead to latency spikes, and more may result in request errors.|
