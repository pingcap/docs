...
| QPSが80%減少                               | <li>クエリのレイテンシーの増加がドロップの原因かどうかを確認してください。</li><li>アプリケーションが正常に動作していることを確認してください。意図的なドロップの場合は、このアラートを無視してください。ドロップが意図的でなく、根本原因が特定できない場合は、直ちに[TiDB Cloudサポート](/tidb-cloud/tidb-cloud-support.md)にお問い合わせください。</li>                                                                    |
