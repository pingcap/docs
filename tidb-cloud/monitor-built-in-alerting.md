...
| TiKV storage utilization exceeds 80% | Consider increasing the node number or node storage size for TiKV to increase your storage capacity. Storage usage of TiKV exceeding 80% can cause latency spikes, and higher usage might cause requests to fail. |
