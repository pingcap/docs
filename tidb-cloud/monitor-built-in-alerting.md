...
| TiKV storage utilization exceeds 80% | Consider increasing the node number or node storage size for TiKV to increase your storage capacity. Usage above 80% can lead to latency spikes, and higher usage may result in request errors.|
| TiFlash storage utilization exceeds 80% | Consider increasing the node number or node storage size for TiFlash to increase your storage capacity. Usage above 80% indicates disk exhaustion and may result in request errors.|
