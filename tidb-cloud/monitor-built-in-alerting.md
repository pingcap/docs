...
| One TiDB node is reporting as down for 10 minutes | Check the impact of your workload , and add a new node when neccessary. PingCAP technical support will also be notified by this alert and we will take action to fix the issue as soon as possible. |
| One TiKV node is reporting as down for 10 minutes | Check the impact of your workload , and add a new node when neccessary. PingCAP technical support will also be notified by this alert and we will take action to fix the issue as soon as possible. |
| One PD node is reporting as down for 10 minutes | PingCAP technical support will also be notified by this alert and we will take action to fix the issue as soon as possible.  |
| One TiFlash node is reporting as down for 10 minutes | Check the impact of your workload , and add a new node when neccessary. PingCAP technical support will also be notified by this alert and we will take action to fix the issue as soon as possible.  |
