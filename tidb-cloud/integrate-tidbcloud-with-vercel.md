...
1. In the [TiDB Cloud console](https://console.tidb.io/signup?provider_source=alicloud), go to the [**Data Service**](https://console.tidb.io/data-service) page of your project.
