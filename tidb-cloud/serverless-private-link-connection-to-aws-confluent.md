...
このドキュメントでは、 [AWS エンドポイントサービスプライベートリンク接続](/tidb-cloud/serverless-private-link-connection.md)を使用してTiDB Cloud Essential クラスターを AWS 上の[Confluent Cloud 専用クラスター](https://docs.confluent.io/cloud/current/clusters/cluster-types.html)に接続する方法について説明します。
...
## ステップ3. ネットワークの下にConfluent Cloud専用クラスターを作成する {#step-3-create-a-confluent-cloud-dedicated-cluster-under-the-network}
