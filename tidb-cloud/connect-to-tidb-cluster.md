...
> **Tip:**
>
> To learn how to connect to a {{{ .starter }}} or {{{ .essential }}} cluster, see [Connect to Your {{{ .starter }}}, Essential, or Premium Cluster](/tidb-cloud/connect-to-tidb-cluster-serverless.md).
