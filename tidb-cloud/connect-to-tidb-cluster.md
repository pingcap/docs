...
After your TiDB cluster is created on TiDB Cloud, you can connect to your TiDB cluster. Depending on whether you are using a TiDB Serverless cluster or a TiDB Dedicated cluster, you can find the available connection methods as follows:

## TiDB Serverless

For TiDB Serverless clusters, you can connect to your cluster via one of the following methods:
