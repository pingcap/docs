...
# Use TiDB Cloud Dedicated Cluster Resource {#use-tidb-cloud-dedicated-cluster-resource}
...
## Get project IDs using the <code>tidbcloud_projects</code> data source {#get-project-ids-using-the-code-tidbcloud-projects-code-data-source}
...
## Modify a TiDB Cloud Dedicated cluster {#modify-a-tidb-cloud-dedicated-cluster}
...
### Add a TiFlash component {#add-a-tiflash-component}
...
### Pause or resume a cluster {#pause-or-resume-a-cluster}
...
### Add a TiDB node group to the cluster {#add-a-tidb-node-group-to-the-cluster}
...
### Update a TiDB node group of the cluster {#update-a-tidb-node-group-of-the-cluster}
...
### Delete a TiDB node group of the cluster {#delete-a-tidb-node-group-of-the-cluster}
...
## Delete a TiDB Cloud Dedicated cluster {#delete-a-tidb-cloud-dedicated-cluster}
