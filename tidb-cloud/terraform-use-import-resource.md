...
-   TiDB Serverless クラスターおよび TiDB Dedicatedクラスターのインポート タスクを作成します。
...
-   [<a href="/tidb-cloud/create-tidb-cluster.md">TiDB Serverless クラスターまたは TiDB Dedicatedクラスターを作成する</a>](/tidb-cloud/create-tidb-cluster.md) 。
