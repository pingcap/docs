...
| `server`           | 要连接的 TiDB 端点                         | 必需      | `gateway01.ap-southeast-1.prod.aws.tidbcloud.com` |
| `port`             | 要使用的端口                                                         | 必需      | `4000`                                            |
