...
2. Use your AWS account ID or account alias, your IAM user name, and your IAM password to sign in to [the IAM console](https://console.aws.amazon.com/iam).
