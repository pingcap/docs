...
1. Create an IAM user with the `AmazonS3ReadOnlyAccess` privilege. It is recommended that the privilege only works for your bucket that stores the source data. For more information, see [Creating an IAM user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html#id_users_create_console).
