...
2. Use [Dumpling](/dumpling-overview.md) to export data from your TiDB Cloud Dedicated cluster, then use [Serverless Import](/tidb-cloud/import-csv-files-serverless.md) to load data to the destination TiDB Cloud Serverless cluster.
