...
创建一个示例 Data App 是快速上手 Data Service 的最佳方式。如果你的项目还没有任何 Data App，可以按照 **Data Service** 页面上的引导，创建一个示例 Data App，并用它体验 Data Service 的功能。
...
1. 在 [**Data Service**](https://tidbcloud.com/project/data-service) 页左侧，点击你的端点名称，然后点击右上角的 **...** > **Code Example**。会弹出 **Code Example** 对话框。
