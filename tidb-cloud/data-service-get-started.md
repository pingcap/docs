...
1. In the [TiDB Cloud console](https://{{{.console-url}}}), click <MDSvgIcon name="icon-left-data-service" /> **Data Service** in the left navigation pane.
...
2. On the [**Data Service**](https://{{{.console-url}}}/project/data-service) page of your project, click <MDSvgIcon name="icon-create-data-app" /> **Create DataApp** in the left pane.
...
5. Click **Create Data App**. The [**Data Service**](https://{{{.console-url}}}/project/data-service) details page is displayed.
...
1. In the left pane of the [**Data Service**](https://{{{.console-url}}}/project/data-service) page, click the name of your Data App to view its details.
...
1. In the left pane of the [**Data Service**](https://{{{.console-url}}}/project/data-service) page, click the name of your endpoint, and then click **...** > **Code Example** in the upper-right corner. The **Code Example** dialog box is displayed.
