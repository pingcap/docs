...
To ensure fast and seamless branch creation, TiDB Cloud Starter uses a copy-on-write technique for sharing data between the original cluster and its branches. This process usually completes within a few minutes and is imperceptible to users, ensuring that it does not affect the performance of your original cluster.
...
>>>>>>> d4a3a44f4e (update branch limitation (#21182))
