...
1. Navigate to the [**Clusters**](https://tidbcloud.com/project/clusters) page of your project, and then click the name of your {{{ .starter }}} or Essential instance to go to its overview page.
