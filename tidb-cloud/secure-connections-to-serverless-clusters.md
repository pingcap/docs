...
In the [TiDB Cloud console](https://console.tidb.io/signup?provider_source=alicloud), you can get examples of different connection methods and connect to your TiDB Cloud Starter cluster as follows:
