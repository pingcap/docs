...
- Changefeeds do not support the DDL that renaming multiple tables in a single `RENAME TABLE` statement (for example, `RENAME TABLE t1 TO t3, t2 TO t4`). Executing this statement permanently interrupts changefeed data synchronization.
