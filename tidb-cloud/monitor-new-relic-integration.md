...
1. 准备新仪表盘的 JSON 文件。
    ...
    3. 在 JSON 文件中所有 `"accountIds": []` 字段中添加你的 New Relic 账户 ID。
...
| tidb_cloud.dm_syncer_replication_lag_bucket | gauge | instance: `instance`<br/><br/>cluster_name: `<cluster name>` | 数据迁移的复制延迟（分桶）。 |
