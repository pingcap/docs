...
TiDB Cloud 支持 New Relic 集成（预览版）。你可以配置 TiDB Cloud，将你的 TiDB 集群的指标发送到 [New Relic](https://newrelic.com/)。之后，你可以直接在 New Relic 仪表盘中查看这些指标。

## New Relic 集成版本

自 2023 年 4 月 11 日起，TiDB Cloud 支持 New Relic 集成（Beta）。从 2025 年 7 月 31 日起，TiDB Cloud 推出了增强的预览版集成。

- **New Relic integration (Preview)**：如果在 2025 年 7 月 31 日前，你的组织内没有未删除的 Datadog 或 New Relic 集成，TiDB Cloud 将提供 New Relic 集成的预览版，以便你体验最新的增强功能。
