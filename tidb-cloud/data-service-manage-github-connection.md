...
| ---------|---------|
| `data_source/cluster.json`     | When updating this file, make sure that the linked clusters are TiDB Serverless or TiDB Dedicated clusters and that you have access to the clusters. You can get the cluster ID from the cluster URL. For example, if the cluster URL is `https://tidbcloud.com/console/clusters/1234567891234567890/overview`, the cluster ID is `1234567891234567890`. |
