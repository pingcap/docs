...
**トップN SQLリストは、**選択されたフィルタに対して最もRUを消費するSQL文を表示します。
...
リスト内のSQL文にカーソルを合わせると、トレンドチャートでそのSQL文の**RUトレンドラインが**ハイライト表示されます。このチャートは、選択した期間におけるRU消費量を1分間隔で表示し、急増がいつ始まったか、またその急増が現在も続いているかどうかを把握するのに役立ちます。
