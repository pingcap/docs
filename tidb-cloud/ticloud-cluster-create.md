...
| --encryption                 | Enables dual-layer data encryption. It is enabled by default for {{{ .essential }}} clusters, and disabled (not configurable) for {{{ .starter }}} clusters.                       | No       | Only works in non-interactive mode.                 |
