...
| --encryption                 | Enables dual-layer data encryption. It is enabled by default for the {{{ .essential }}} cluster, and disabled for the {{{ .starter }}} cluster.                       | No       | Only works in non-interactive mode.                 |
