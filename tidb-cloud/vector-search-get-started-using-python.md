...
Throughout this tutorial, you will develop this AI application using [TiDB Vector Search](/tidb-cloud/vector-search-search-overview.md), Python, [TiDB Vector SDK for Python](https://github.com/pingcap/tidb-vector-python), and AI models.
...
- [`sentence-transformers`](https://sbert.net): a Python library that provides pre-trained models for generating [vector embeddings](/tidb-cloud/vector-search-search-overview.md#vector-embedding) from text.
