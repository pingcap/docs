...
summary: 了解如何使用 TiDB Cloud Clinic 进行高级监控与诊断。
---
...
在 TiDB Cloud 控制台默认的 [**Slow Queries**](/tidb-cloud/tune-performance.md#slow-query) 页面中，定位影响性能的查询可能较为困难，尤其是在慢查询数量较多的集群中。TiDB Cloud Clinic 的 **Top 慢查询** 功能基于慢查询日志提供聚合分析。通过该功能，你可以轻松定位存在性能问题的查询，整体性能调优时间至少可缩短一半。
