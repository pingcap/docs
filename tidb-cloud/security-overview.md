...
For [cluster types that support Customer-Managed Encryption Keys (CMEK)](/tidb-cloud/features.md), TiDB Cloud provides encryption for both data at rest and backups.
