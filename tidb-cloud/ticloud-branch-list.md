...
List all branches for a {{{ .starter }}} or {{{ .essential }}} cluster:
...
List all branches for a {{{ .starter }}} or {{{ .essential }}} cluster in interactive mode:

```shell
ticloud serverless branch list
```

List all branches for a specific {{{ .starter }}} or {{{ .essential }}} cluster in non-interactive mode:

```shell
ticloud serverless branch list -c <cluster-id>
```

List all branches for a specific {{{ .starter }}} or {{{ .essential }}} cluster in the JSON format:
