...
List all branches for a {{{ .starter }}} cluster:
...
List all branches for a {{{ .starter }}} cluster in interactive mode:

```shell
ticloud serverless branch list
```

List all branches for a specific {{{ .starter }}} cluster in non-interactive mode:

```shell
ticloud serverless branch list -c <cluster-id>
```

List all branches for a specific {{{ .starter }}} cluster in the JSON format:
