...
7. 用户收到邮件后，需要点击邮件中的链接进行身份验证，页面会显示新的界面。

8. 如果被邀请邮箱尚未注册 TiDB Cloud 账户，用户会被引导到注册页面创建账户；如果邮箱已注册 TiDB Cloud 账户，用户会被引导到登录页面，登录后账户会自动加入组织。
...
8. 如果被邀请邮箱尚未注册 TiDB Cloud 账户，用户会被引导到注册页面创建账户；如果邮箱已注册 TiDB Cloud 账户，用户会被引导到登录页面。登录后账户会自动加入项目。
