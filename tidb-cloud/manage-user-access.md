...
TiDB Cloudは、TiDB クラスターの管理を容易にするために、組織とプロジェクトに基づく階層構造を提供します。 TiDB Cloudの組織には複数のプロジェクトと組織メンバーを含めることができ、プロジェクトには複数のクラスターとプロジェクト メンバーを含めることができます。
...
3.  名前を変更するプロジェクトの行で、[**名前**の変更] をクリックします。
...
3.  [**ユーザー管理**] タブをクリックし、[<strong>プロジェクト</strong>別] を選択します。
