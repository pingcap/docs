...
8. 如果被邀请的邮箱地址尚未注册 TiDB Cloud 账户，用户会被引导至注册页面创建账户；如果邮箱地址已注册 TiDB Cloud 账户，用户会被引导至登录页面，登录后账户会自动加入该组织。
...
8. 如果被邀请的邮箱地址尚未注册 TiDB Cloud 账户，用户会被引导至注册页面创建账户；如果邮箱地址已注册 TiDB Cloud 账户，用户会被引导至登录页面。登录后账户会自动加入该项目。
