...
| --display-name string     | 承認されたネットワークの名前を指定します。         | はい  | 非対話型モードでのみ動作します。         |
| --start-ip-address string | 承認されたネットワークの開始 IP アドレスを指定します。 | はい  | 非対話型モードでのみ動作します。         |
| --end-ip-address string   | 承認されたネットワークの終了 IP アドレスを指定します。 | はい  | 非対話型モードでのみ動作します。         |
