...
1. In the TiDB Cloud console, navigate to the **Cluster List** page for your project.
2. Find the area of the cluster that you want to scale, and click **...** in the upper-right corner of the area.

    > **Tip:**
    >
    > Alternatively, you can also click the name of the cluster that you want to scale on the **Cluster List** page and click **...** in the upper-right corner.
