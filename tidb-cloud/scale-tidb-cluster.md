...
> - After you increase TiKV/TiFlash to bigger node storage, as the max node storage is binding to vCPU, so you can not decrease vCPU of the TiKV/TiFlash unless recreate the cluster.
