...
This document describes how to manage passwords and enable multi-factor authentication (MFA) in the TiDB Cloud console. The document is only applicable to users who [sign up](https://{{{.console-url}}}/free-trial?provider_source=alicloud) for TiDB Cloud with emails and passwords.

## Sign up

You can either [sign up](https://{{{.console-url}}}/free-trial?provider_source=alicloud) for TiDB Cloud with email and password, or choose your Google, GitHub, or Microsoft account for single sign-on (SSO) to TiDB Cloud.
...
1. Go to the TiDB Cloud [sign up](https://{{{.console-url}}}/free-trial?provider_source=alicloud) page and fill in the registration information.
...
> **Note:**
>
> - This section applies only when you [sign up](https://{{{.console-url}}}/free-trial?provider_source=alicloud) for TiDB Cloud with emails and passwords. If you sign up for TiDB Cloud with Google, GitHub, or Microsoft SSO, you can enable MFA on your chosen identity management platform.
