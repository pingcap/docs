...
Alternatively, you can also access the [Customer Support](https://tidb.support.pingcap.com/hc/en-us) page, log in to the support portal, and then click **View my requests**.
