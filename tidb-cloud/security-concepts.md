...
### SQL プロキシ アカウント {#sql-proxy-accounts}
...
-   **<a href="/tidb-cloud/manage-user-access.md#project-roles">プロジェクト レベルのロール</a>**: クラスターや構成を含む特定のプロジェクトを管理するための権限を割り当てます。
...
-   [AWS プライベートリンク](/tidb-cloud/set-up-private-endpoint-connections.md)と[Google Cloud プライベート サービス接続](/tidb-cloud/set-up-private-endpoint-connections-on-google-cloud.md)によってサポートされています。
...
-   [サーバーレス](/tidb-cloud/secure-connections-to-serverless-clusters.md)クラスターと[ひたむきな](/tidb-cloud/tidb-cloud-tls-connect-to-dedicated.md)クラスターの両方でセットアップ ガイドが利用可能です。
