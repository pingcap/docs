...
- **Token-based:** SQL Proxy accounts use secure JWT tokens instead of passwords, ensuring seamless, restricted access through the TiDB Cloud [Data Service](/tidb-cloud/data-service-overview.md) or [SQL Editor](/tidb-cloud/explore-data-with-chat2query.md).
