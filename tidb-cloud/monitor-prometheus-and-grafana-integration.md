...
| tidbcloud_db_query_duration_seconds                         | histogram   | sql_type: `Select\|Insert\|...`<br/>クラスター名: `<cluster name>`<br/>インスタンス: `tidb-0\|tidb-1…`<br/>コンポーネント: `tidb`                 | ステートメントの期間histogram                                                                                                                                                                                                                                                                                                           |
...
| tidbcloud_changefeed_status                                 | gauge      | changefeed_id: `<changefeed-id>`<br/>クラスター名: `<cluster name>`                                                                  | 変更フィードのステータス:<br/> `-1` : 不明<br/>`0` : 通常<br/>`1` : 警告<br/>`2` : 失敗<br/>`3` : 停止しました<br/>`4` : 完了<br/>`6` : 警告<br/>`7` : その他                                                                                                                                                                                               |
