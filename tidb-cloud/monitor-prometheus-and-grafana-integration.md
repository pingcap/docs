...
1. Download the Grafana dashboard JSON of TiDB Cloud [here](https://github.com/pingcap/docs/release-6.1/tidb-cloud/monitor-prometheus-and-grafana-integration-grafana-dashboard-UI.json).
