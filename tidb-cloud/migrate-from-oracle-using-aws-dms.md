...
This document describes a step-by-step example of how to migrate data from Amazon RDS for Oracle to [TiDB Cloud Serverless](https://tidbcloud.com/project/clusters/create-cluster) using AWS Database Migration Service (AWS DMS).
...
Connect to the [TiDB Cloud Serverless cluster](https://tidbcloud.com/project/clusters/create-cluster) and check the `admin.github_event` table data. As shown in the following screenshot, DMS successfully migrated table `github_events` and 10000 rows of data.
