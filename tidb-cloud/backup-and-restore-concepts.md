...
-   [TiDB Cloud Premiumインスタンスの自動バックアップ](/tidb-cloud/premium/backup-and-restore-premium.md#automatic-backups)
...
TiDB Cloud Dedicatedのデュアルリージョンバックアップ機能は、クラスターリージョンから別のリージョンへバックアップを複製できる機能です。この機能を有効にすると、すべてのバックアップが指定されたリージョンに自動的に複製されます。これにより、リージョンをまたいだデータ保護とディザスタリカバリ機能が実現します。データの約99%は1時間以内にセカンダリリージョンに複製できると推定されています。
