...
aliases: ['/tidbcloud/ticloud-import-start-local','/tidbcloud/ticloud-import-start-gcs','/tidbcloud/ticloud-import-start-s3','/tidbcloud/ticloud-import-start-azure-blob']
---
...
| --file-type string               | The import file type, one of ["CSV" "SQL" "AURORA_SNAPSHOT" "PARQUET"].                                                    | Yes      | Only works in non-interactive mode.                  |
...
| -h, --help                       | Shows help information for this command.                                                                                   | No       | Works in both non-interactive and interactive modes. |tion for this command.                                                                            | No       | Works in both non-interactive and interactive modes. |
