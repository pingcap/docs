---
title: Connect to TiDB Cloud via AWS PrivateLink
summary: Learn how to connect to your TiDB Cloud cluster via AWS PrivateLink.
---

# Connect to TiDB Cloud via AWS PrivateLink

This document describes how to connect to your TiDB Cloud cluster via [AWS PrivateLink](https://aws.amazon.com/privatelink).
...
To connect to your TiDB Cloud cluster via a private endpoint, follow these steps:
...
4. Take a note of **Service Name**, **Availability Zone ID**, and **Region ID**.
    ...
    > **Note:**
    >
    > You only need to create one private endpoint per AWS region, which can be shared by all TiDB Cloud clusters located in the same region.
