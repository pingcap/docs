...
This document provides the TPC-C performance test steps and results for a TiDB Dedicated cluster with the TiDB version of v6.5.3. This report can also be used as a reference for the performance of TiDB Self-Hosted v6.5.3 clusters.

## Test overview

This test aims at showing the TPC-C performance of TiDB v6.5.3 in the Online Transactional Processing (OLTP) scenario.
...
The TPC-C performance of v6.5.3 in the [test environment](#test-environment) is as follows:
...
![TPC-C](/media/tidb-cloud/v6.5.3-tpmC.png)
