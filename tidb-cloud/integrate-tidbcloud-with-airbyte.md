...
2. Fill in the following parameters.
    ...
    You can get the parameter values from the connection dialog of your cluster. To open the dialog, go to the [**My TiDB**](https://tidbcloud.com/tidbs) page, click the name of your target resource to go to its overview page, and then click **Connect** in the upper-right corner.
