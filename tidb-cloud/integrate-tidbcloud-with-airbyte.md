...
2. Fill in the following parameters.
    ...
    You can get the parameter values from the connection dialog of your cluster. To open the dialog, navigate to the **Overview** page of your target cluster in the [TiDB Cloud console](https://tidbcloud.com/), and then click **Connect** in the upper-right corner.
