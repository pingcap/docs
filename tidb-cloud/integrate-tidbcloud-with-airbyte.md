...
- The TiDB connector can not utilize the Change Data Capture (CDC) feature which TiCDC provides. The incremental sync it supports is cursor based underneath.
