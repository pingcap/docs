...
summary: 了解 2023 年 8 月 31 日 TiDB Cloud 控制台维护的详细信息，包括维护窗口、原因及影响。
---

# [2023-08-31] TiDB Cloud 控制台维护通知

本通知描述了你需要了解的关于 [TiDB Cloud 控制台](https://tidbcloud.com/) 于 2023 年 8 月 31 日进行维护的详细信息。
...
> **Note:**
>
> 目前，用户无法修改 TiDB Cloud 控制台的维护时间，因此你需要提前做好相应的规划。

## 维护原因

我们正在升级 TiDB Cloud 控制台的元数据库服务，以提升性能和效率。此次改进旨在为所有用户提供更优质的体验，这是我们持续致力于提供高质量服务的一部分。
...
一旦维护顺利完成，受影响的功能将会恢复，为你带来更优质的体验。

## 获取支持

如果你有任何疑问或需要帮助，请联系 [支持团队](/tidb-cloud/tidb-cloud-support.md)。我们将为你解答疑问并提供必要的指导。