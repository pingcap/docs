...
-   **TiDB Cloud Dedicated**
    ...
    -   TiProxy (ベータ版) をサポートします。
        ...
        PingCAPの公式プロキシコンポーネントであるTiProxyが、 [TiDB Cloud Dedicated](/tidb-cloud/select-cluster-tier.md#tidb-cloud-dedicated)クラスタでベータ版として利用可能になりました。強化された接続管理と負荷分散機能により、データベースの信頼性とパフォーマンスが向上します。
