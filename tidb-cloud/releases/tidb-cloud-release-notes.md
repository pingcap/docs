...
- **TiDB Cloud Dedicated**
    ...
    - TiDB Cloud Dedicated now supports inbound IPv6 connectivity over AWS PrivateLink, so you can connect to your cluster over either IPv4 or IPv6.
        ...
        Currently, this feature is available upon request. To access IPv6 connectivity, contact [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md) to request it, and then create an AWS interface endpoint with the **Dual Stack (IPv4 + IPv6)** protocol type.

        For more information, see [Use IPv6 connectivity over a private endpoint](/tidb-cloud/set-up-private-endpoint-connections.md#use-ipv6-connectivity-over-a-private-endpoint).
