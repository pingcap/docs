...
- [TiDB Cloud Serverless](/tidb-cloud/select-cluster-tier.md#starter) supports vector search (beta).
    ...
    - Ecosystem integrations with [LlamaIndex](/ai/integrations/vector-search-integrate-with-llamaindex.md) and [JinaAI](/ai/integrations/vector-search-integrate-with-jinaai-embedding.md).
