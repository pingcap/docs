...
* 修复向 TiDB Cloud 导入超过 1000 个文件时出现的导入错误
* 修复 TiDB Cloud 允许向已有数据的现有表导入数据的问题
...
* 支持 [为 TiDB Cloud 项目添加 VPC CIDR](/tidb-cloud/set-up-vpc-peering-connections.md)

改进：

* 提升 Developer Tier 的监控能力
* 支持将自动备份时间设置为 Developer Tier 集群的创建时间

Bug 修复：

* 修复 Developer Tier 中由于磁盘满导致的 TiKV 崩溃问题
* 修复 HTML 注入漏洞
...
* 支持 [查看和导出 TiDB Cloud 账单明细](/tidb-cloud/tidb-cloud-billing.md#billing-details)，包括每项服务和每个项目的费用
* 修复 TiDB Cloud 内部功能的若干问题
...
* 修复 TiDB Cloud 内部功能的若干问题。本次发布未带来任何用户行为变更。
...
* 优化添加信用卡的用户体验
* 加强信用卡的安全管理
* 修复通过备份恢复的集群无法正常计费的问题

## 2021 年 7 月 6 日

* 新部署集群的默认 TiDB 版本从 4.0.11 升级到 5.0.2。此次升级带来显著的性能和功能提升。详情请参见[此处](https://docs.pingcap.com/tidb/stable/release-5.0.0)。

## 2021 年 6 月 25 日

* 修复 [TiDB Cloud 价格](https://www.pingcap.com/pricing/) 页面 **Select Region** 不生效的问题

## 2021 年 6 月 24 日

* 修复将 Aurora 快照导入 TiDB 实例时 parquet 文件的解析错误
* 修复 PoC 用户创建集群并更改集群配置时 Estimated Hours 未更新的问题

## 2021 年 6 月 16 日

* 注册账户时，**Country/Region** 下拉列表中新增 **China**

## 2021 年 6 月 14 日

* 修复将 Aurora 快照导入 TiDB 实例时挂载 EBS 的错误
...
* 你可以在控制台填写申请表申请 [PoC](/tidb-cloud/tidb-cloud-poc.md)
