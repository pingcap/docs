...
summary: 2021年のTiDB Cloudのリリースノートについて説明します。
---

# 2021年のTiDB Cloudリリースノート {#tidb-cloud-release-notes-in-2021}

このページには、2021年の[TiDB Cloud](https://www.pingcap.com/tidb-cloud/)のリリースノートが記載されています。
...
- [TiDB Cloud プロジェクトへの VPC CIDR の追加をサポート](/tidb-cloud/set-up-vpc-peering-connections.md)

改善点:

- Developer Tierの監視能力の向上
- 自動バックアップ時間をDeveloper Tierクラスタの作成時刻と同じに設定することをサポート
...
- 新規にデプロイされたクラスタのデフォルトのTiDBバージョンを5.2.0から5.2.1にアップグレードしてください。5.2.1の詳細な変更点については、リリースノート[5.2.1](https://docs.pingcap.com/tidb/stable/release-5.2.1)をご覧ください。
...
- [TiDB Cloudの価格](https://www.pingcap.com/pricing/)ページの**リージョン選択**が機能しない問題を修正
