...
Create a [branch](/tidb-cloud/branch-overview.md) for a {{{ .starter }}} cluster:
...
Create a branch for a {{{ .starter }}} cluster in interactive mode:

```shell
ticloud serverless branch create
```

Create a branch for a {{{ .starter }}} cluster in non-interactive mode:
