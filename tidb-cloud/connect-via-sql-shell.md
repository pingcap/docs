...
> **注意：**
>
> 你无法使用 SQL Shell 连接到 [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) 或 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential)。如需连接到你的 TiDB Cloud Starter 或 TiDB Cloud Essential 实例，请参阅 [Connect to TiDB Cloud Starter or Essential Instance](/tidb-cloud/connect-to-tidb-cluster-serverless.md)。

要使用 SQL shell 连接到 TiDB，请按照以下步骤操作：
...
2. 点击目标 TiDB Cloud Dedicated 集群的名称，进入其概览页面，然后点击左侧导航栏中的 **Settings** > **Networking**。
