...
5. In the **Destination Mapping** section, use the [TiDB Dumpling file naming conventions](/tidb-cloud/naming-conventions-for-data-import.md) and select **SQL** as the data format 
