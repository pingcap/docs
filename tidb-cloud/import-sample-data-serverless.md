...
5.  **Destination Mapping**セクションで、 **Use <a href="/tidb-cloud/naming-conventions-for-data-import.md">File naming conventions</a> for automatic mapping**オプションが選択されたままになっていることを確認し、データ形式として**SQL**を選択します。
