...
TiDB Cloud ensures high availability in {{{ .starter }}}, {{{ .essential }}}, and TiDB Cloud Dedicated clusters:

- [High Availability in {{{ .starter }}}, Essential and {{{ .premium }}}](/tidb-cloud/serverless-high-availability.md)
