...
TiDB は完全な分散トランザクションを提供し、モデルには[Googleパーコレーター](https://research.google.com/pubs/pub36726.html)に基づいていくつかの最適化が施さ[トランザクションについて詳しくはこちらをご覧ください](/tidb-cloud/transaction-concepts.md)ています。
