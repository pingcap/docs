...
| tidb_cloud.db_failed_queries| gauge | type: executor:xxxx\|parser:xxxx\|...<br/>cluster_name: `<cluster name>`<br/>instance: tidb-0\|tidb-1…<br/>component: `tidb` | 每秒在每个 TiDB 实例上发生的 SQL 执行错误的错误类型统计（如语法错误、主键冲突等）。 |
