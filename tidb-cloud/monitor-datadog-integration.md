...
在 Datadog 合并待处理的 [PR](https://github.com/DataDog/integrations-extras/pull/2751) 后，将会有新的 TiDB Cloud 仪表盘可用。在此之前，你可以通过以下步骤手动导入仪表盘：
...
3. 在 **Configuration** 标签页，点击 **Install Integration**。在你的 [**Dashboard List**](https://app.datadoghq.com/dashboard/lists) 中会显示 [**TiDB Cloud Cluster Overview**](https://app.datadoghq.com/dash/integration/30586/tidbcloud-cluster-overview) 仪表盘。
