...
3. In the **Data Format** area, select either the **CSV** or **Canal-JSON** format.
    ...
    - **Binary Encode Method**: The encoding method of binary type data, optional 'base64' or 'hex', default 'base64 '. If you want to integrate with AWS DMS, please use 'hex'.
