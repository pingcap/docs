...
- The backup and restore feature is unavailable to {{{ .starter }}} clusters. To use backup resources, make sure that you have created a TiDB Cloud Dedicated cluster.
