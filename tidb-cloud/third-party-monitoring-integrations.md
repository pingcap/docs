...
You can integrate TiDB Cloud with third-party metrics services (beta) to receive TiDB Cloud alerts and view the performance metrics of your TiDB cluster using the metrics services.
