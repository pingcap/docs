...
### Parameter configuration
  ...
  We enabled the below parameter in 'oltp_insert, oltp_read_write , oltp_update_index, oltp_update_non_index' scenarios and disabled the below parameter in the 'oltp_point_select' scenario. 
