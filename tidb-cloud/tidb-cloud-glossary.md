...
For more information, see [Full-Text Search with SQL](/develop/vector-search-full-text-search-sql.md) and [Full-Text Search with Python](/develop/vector-search-full-text-search-python.md).
