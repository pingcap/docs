...
- 对于 <CustomContent plan="starter,essential,dedicated">{{{ .starter }}} 和 Essential</CustomContent><CustomContent plan="premium">{{{ .starter }}}、Essential 和 Premium</CustomContent> 实例，project 是可选的，这意味着你既可以将这些实例归入某个 project，也可以将这些实例保留在 organization 层级。
...
- **TiDB X project**：此类 project 仅用于 TiDB X 实例（<CustomContent plan="starter,essential,dedicated">{{{ .starter }}} 和 Essential</CustomContent><CustomContent plan="premium">{{{ .starter }}}、Essential 和 Premium</CustomContent>）。它帮助你按 project 管理 TiDB X 实例的 RBAC。TiDB X project 是你在 [**My TiDB**](https://tidbcloud.com/tidbs) 页面创建 project 时的默认 project 类型。
- **TiDB X virtual project**：此类 project 是虚拟的，不提供任何管理能力。它作为不属于任何 project 的 TiDB X 实例（<CustomContent plan="starter,essential,dedicated">{{{ .starter }}} 和 Essential</CustomContent><CustomContent plan="premium">{{{ .starter }}}、Essential 和 Premium</CustomContent>）的虚拟容器，使这些实例能够通过使用 project ID 的 TiDB Cloud API 进行访问。每个 organization 都有一个唯一的 virtual project ID。你可以在 [**My TiDB**](https://tidbcloud.com/tidbs) 页面的 project 视图中获取此 ID。
...
目前，只有 {{{ .dedicated }}} 集群支持 Recycle Bin 功能。
...
- TiDB X 实例（一种基于 [TiDB X architecture](/tidb-cloud/tidb-x-architecture.md) 构建的面向服务的 TiDB Cloud 产品），例如 <CustomContent plan="starter,essential,dedicated">{{{ .starter }}} 或 Essential</CustomContent><CustomContent plan="premium">{{{ .starter }}}、Essential 或 Premium</CustomContent> 实例
- {{{ .dedicated }}} 集群
...
在 TiDB Cloud 的各类套餐中，<CustomContent plan="starter,essential,dedicated">{{{ .starter }}} 和 Essential</CustomContent><CustomContent plan="premium">{{{ .starter }}}、Essential 和 Premium</CustomContent> 使用 TiDB X architecture。因此，当提到 “TiDB X instance” 时，它指的是 <CustomContent plan="starter,essential,dedicated">{{{ .starter }}} 或 Essential</CustomContent><CustomContent plan="premium">{{{ .starter }}}、Essential 或 Premium</CustomContent> 实例。
