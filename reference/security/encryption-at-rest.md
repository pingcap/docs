...
TiKV currently support encrypting data using AES128, AES192 or AES256, in CTR mode. TiKV use envolope encryption, as a result, there are two types of keys used in TiKV when encryption is enabled.
