...
For example, if the overall planned capacity of TiKV is 1 TB, with 3 replicas, and TiFlash is 2 replicas, then the recommended capacity of TiFlash will be (1024GB / 3 * 2). You can choose to replicate part of tables instead of all.
