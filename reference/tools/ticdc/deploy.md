...
To replicate all upstream database tables to the downstream MySQL, use the following command to create the replication task:
...
- `config`: The configuration of the replication task. Currently, this configuration supports the black & white lists and skipping specific the transaction of certain `commit-ts`.
