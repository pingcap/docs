...
For detailed description of query parameters and a complete list of returned result, refer to [Query status](/reference/tools/data-migration/query-status.md#query-result).
