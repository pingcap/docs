...
category: tools
aliases: ['/docs/v3.0/reference/tools/sync-diff-inspector/']
---
...
* Support [data check for tables with different schema or table names](/reference/tools/sync-diff-inspector/route-diff.md)
