...
From v7.5.0, you can use TSO to specify the poit of time.
...
- `AS OF TIMESTAMP '445494955052105728'` Tells TiDB to read the latest data stored at 445494955052105728.
