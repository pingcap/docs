...
> - In TiDB v6.0.0, adding table attributes **only** takes effect on existing partitions. To add or delete partitions after adding table attributes, you need to reset table attributes. For detailed methods, see [How to use table attributes](#usage).
