...
> - TiDB v6.0.0 **does not support** Index Region. For details of Index Region, refer to [Split Index Region](/sql-statements/sql-statement-split-region.md#split-index-region).
> - In TiDB v6.0.0, adding table attributes feature **only** takes effect for existing partitions. To add or delete partitions after adding table attributes feature, you need to reset the feature. For detailed methods, see [How to use table properties](#usage).
