...
> - In TiDB v5.3.0 and v5.3.1, adding table attributes **only** takes effect for existing partitions. To add or delete partitions after adding table attributes, you need to reset this feature. For detailed methods, see [How to use table attributes](#usage).
