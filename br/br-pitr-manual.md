...
> **Note:**
>
> - When you restore the cluster for the first time, it is necessary to specify the full snapshot data, otherwise some data in new created table may be incorrect due to rewriting Table ID rules.
