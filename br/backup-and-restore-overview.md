...
このセクションでは、TiDB v6.5.0 から v8.1.0 (v6.5.0、v7.1.0、v7.5.0、v8.1.0 を含む) までの[長期サポート（LTS）](/releases/versioning.md#long-term-support-releases)バージョンすべてに関するBR互換性情報を紹介します。
