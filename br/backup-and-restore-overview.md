...
- PITR supports only cluster-level restore and does not support database-level and table-level restore.
- PITR does not support restoring data in the user tables or the privilege tables.
