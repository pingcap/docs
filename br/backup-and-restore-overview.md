...
| Vector search | | Make sure that you are using v8.4.0 or a later version of BR to back up and restore data. Restoring tables with [vector data types](/develop/vector-search/vector-search-data-types.md) to TiDB clusters earlier than v8.4.0 is not supported. |
