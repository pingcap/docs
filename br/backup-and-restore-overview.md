...
- Data restore is performed at a scalable speed. Generally, the speed is 100 MiB/s per TiKV node. If you restore cluster snapshot backup, it is recommended to restore data to a new cluster and make maximum use of the resources of the target cluster. For more details, see [Restore performance and impact](/br/br-snapshot-guide.md#performance-and-impact-of-snapshot-restore).
