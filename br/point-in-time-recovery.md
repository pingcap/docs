...
- Reduce the Recovery Point Objective (RPO) of disaster recovery to as short as 5 minutes.
...
- With PITR, the RPO of disaster recovery can be as short as 5 minutes. Depending on the data size to be restored, the Recovery Time Objective (RTO) varies from several minutes to several hours.
