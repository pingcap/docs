...
- It is recommended that you execute multiple backup operations serially. The concurrency of different backup operations reduces backup performance and also affects online business.
- It is recommended that you execute multiple restore operations serially. The concurrency of different restore operations increases Region conflicts and also reduces recovery performance.
