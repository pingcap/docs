...
- It is recommended that you execute multiple restore operations serially. The concurrency of different restore operations increase Region conflicts and also reduces recovery performance.
