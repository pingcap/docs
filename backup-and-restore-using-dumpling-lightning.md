...
aliases: ['/docs/stable/export-or-backup-using-dumpling/','/docs/v4.0/export-or-backup-using-dumpling/','/tidb/stable/export-or-backup-using-dumpling','/tidb/v4.0/export-or-backup-using-dumpling']
---
